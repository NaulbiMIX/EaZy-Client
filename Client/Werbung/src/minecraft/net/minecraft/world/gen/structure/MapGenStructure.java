...
extends MapGenBase {
    ...
    protected final void func_180701_a(World worldIn, final int p_180701_2_, final int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) {
        ...
        if (!this.structureMap.containsKey(ChunkCoordIntPair.chunkXZ2Int(p_180701_2_, p_180701_3_))) {
            this.rand.nextInt();
            try {
                if (this.canSpawnStructureAtCoords(p_180701_2_, p_180701_3_)) {
                    ...
                    this.structureMap.put(ChunkCoordIntPair.chunkXZ2Int(p_180701_2_, p_180701_3_), var7);
    ...
    public BlockPos func_180706_b(World worldIn, BlockPos p_180706_2_) {
        ...
        for (StructureStart var15 : this.structureMap.values()) {
            StructureComponent var16;
            BlockPos var17;
            if (!var15.isSizeableStructure() || !((var18 = (var17 = (var16 = (StructureComponent)var15.getComponents().get(0)).func_180776_a()).distanceSq(p_180706_2_)) < var11)) continue;
            var11 = var18;
            var13 = var17;
        }
        if (var13 != null) {
