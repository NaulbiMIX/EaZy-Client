    ...
    protected void func_175445_a(EntityItem p_175445_1_) {
        ...
        if (var3 > -1) {
            ...
            if (var5 != null) {
                if (var3 == 0) {
                    if (var2.getItem() instanceof ItemSword && !(var5.getItem() instanceof ItemSword)) {
                        ...
                        var4 = var6.func_150931_i() == var7.func_150931_i() ? var2.getMetadata() > var5.getMetadata() || var2.hasTagCompound() && !var5.hasTagCompound() : var6.func_150931_i() > var7.func_150931_i();
                    } else {
                    ...
                    var4 = var8.damageReduceAmount == var10.damageReduceAmount ? var2.getMetadata() > var5.getMetadata() || var2.hasTagCompound() && !var5.hasTagCompound() : var8.damageReduceAmount > var10.damageReduceAmount;
                } else {
                    var4 = false;
                }
            }
            if (var4 && this.func_175448_a(var2)) {
                ...
                if (var2.getItem() == Items.diamond && p_175445_1_.getThrower() != null && (var9 = this.worldObj.getPlayerEntityByName(p_175445_1_.getThrower())) != null) {
    ...
    private void recreateLeash() {
        if (this.isLeashed && this.leashNBTTag != null) {
            if (this.leashNBTTag.hasKey("UUIDMost", 4) && this.leashNBTTag.hasKey("UUIDLeast", 4)) {
                ...
                List var6 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(10.0, 10.0, 10.0));
                for (EntityLivingBase var4 : var6) {
                    if (!var4.getUniqueID().equals(var5)) continue;
