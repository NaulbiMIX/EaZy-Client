...
implements IProgressMeter {
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var11, p_180791_2_ + 2, p_180791_3_ + 1 + GuiStats.access$2((GuiStats)GuiStats.this).FONT_HEIGHT, var9 == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var12, p_180791_2_ + 2, p_180791_3_ + 1 + GuiStats.access$2((GuiStats)GuiStats.this).FONT_HEIGHT * 2, var10 == 0 ? 6316128 : 9474192);
        }
    }
