...
implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(5, 0, 0, 98, 20, "Clipboard Login"));
        this.buttonList.add(new GuiButtonLanguage(6, this.width / 2 - 124, var3 + 72 + 12));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 5) {
            try {
                ...
                this.status = Werbung.login(text.split(":")[0], text.split(":")[1]);
            }
            catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawString(Minecraft.getMinecraft().fontRendererObj, this.status, 0, this.height - Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT, -1);
