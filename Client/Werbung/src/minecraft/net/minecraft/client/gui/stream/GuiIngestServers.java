...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, var8, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.access$0((GuiIngestServers)GuiIngestServers.this).FONT_HEIGHT + 5 + 3, 3158064);
            ...
            if (var10 != null) {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, var10, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(var10), p_180791_3_ + 5 + 3 + GuiIngestServers.access$0((GuiIngestServers)GuiIngestServers.this).FONT_HEIGHT, 8421504);
            }
        }
