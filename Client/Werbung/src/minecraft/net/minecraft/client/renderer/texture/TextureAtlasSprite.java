        ...
        if (p_180598_2_ == null) {
            ...
            if (p_180598_2_.getFrameCount() > 0) {
                ...
                while (var9.hasNext()) {
                    ...
                    this.framesTextureData.set(var10, TextureAtlasSprite.getFrameTextureData(var5, var11, var8, var10));
                }
                this.animationMetadata = p_180598_2_;
            } else {
                ArrayList var12 = Lists.newArrayList();
                for (int var10 = 0; var10 < var6; ++var10) {
                    this.framesTextureData.add(TextureAtlasSprite.getFrameTextureData(var5, var11, var8, var10));
