...
public class ClippingHelper {
    ...
    public boolean isBoxInFrustum(double p_78553_1_, double p_78553_3_, double p_78553_5_, double p_78553_7_, double p_78553_9_, double p_78553_11_) {
        for (int var13 = 0; var13 < 6; ++var13) {
            ...
            if (!(this.func_178624_a(var14, p_78553_1_, p_78553_3_, p_78553_5_) <= 0.0) || !(this.func_178624_a(var14, p_78553_7_, p_78553_3_, p_78553_5_) <= 0.0) || !(this.func_178624_a(var14, p_78553_1_, p_78553_9_, p_78553_5_) <= 0.0) || !(this.func_178624_a(var14, p_78553_7_, p_78553_9_, p_78553_5_) <= 0.0) || !(this.func_178624_a(var14, p_78553_1_, p_78553_3_, p_78553_11_) <= 0.0) || !(this.func_178624_a(var14, p_78553_7_, p_78553_3_, p_78553_11_) <= 0.0) || !(this.func_178624_a(var14, p_78553_1_, p_78553_9_, p_78553_11_) <= 0.0) || !(this.func_178624_a(var14, p_78553_7_, p_78553_9_, p_78553_11_) <= 0.0)) continue;
            return false;
        }
        return true;
    }
