...
public class TextureUtil {
    ...
    private static int func_147943_a(int p_147943_0_, int p_147943_1_, int p_147943_2_, int p_147943_3_, boolean p_147943_4_) {
        int var9;
        if (!p_147943_4_) {
            int var13 = TextureUtil.func_147944_a(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 24);
            int var14 = TextureUtil.func_147944_a(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 16);
            int var15 = TextureUtil.func_147944_a(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 8);
            int var16 = TextureUtil.func_147944_a(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 0);
        ...
        for (var9 = 0; var9 < 4; ++var9) {
            if (field_147957_g[var9] >> 24 == 0) continue;
            var5 += (float)Math.pow((float)(field_147957_g[var9] >> 24 & 255) / 255.0f, 2.2);
            var6 += (float)Math.pow((float)(field_147957_g[var9] >> 16 & 255) / 255.0f, 2.2);
            var7 += (float)Math.pow((float)(field_147957_g[var9] >> 8 & 255) / 255.0f, 2.2);
            var8 += (float)Math.pow((float)(field_147957_g[var9] >> 0 & 255) / 255.0f, 2.2);
        }
        var9 = (int)(Math.pow(var5 /= 4.0f, 0.45454545454545453) * 255.0);
        int var10 = (int)(Math.pow(var6 /= 4.0f, 0.45454545454545453) * 255.0);
        int var11 = (int)(Math.pow(var7 /= 4.0f, 0.45454545454545453) * 255.0);
        int var12 = (int)(Math.pow(var8 /= 4.0f, 0.45454545454545453) * 255.0);
        if (var9 < 96) {
            var9 = 0;
        }
    ...
    public static void func_177055_a(String p_177055_0_, int p_177055_1_, int p_177055_2_, int p_177055_3_, int p_177055_4_) {
        TextureUtil.bindTexture(p_177055_1_);
        GL11.glPixelStorei((int)3333, (int)1);
        GL11.glPixelStorei((int)3317, (int)1);
        for (int var5 = 0; var5 <= p_177055_2_; ++var5) {
            File var6 = new File(String.valueOf(p_177055_0_) + "_" + var5 + ".png");
