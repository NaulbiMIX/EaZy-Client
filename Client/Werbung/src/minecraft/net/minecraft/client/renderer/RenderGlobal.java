...
IResourceManagerReloadListener {
    ...
    private void func_174968_a(WorldRenderer p_174968_1_, float p_174968_2_, boolean p_174968_3_) {
        ...
        for (int var6 = -384; var6 <= 384; var6 += 64) {
            for (int var7 = -384; var7 <= 384; var7 += 64) {
                ...
                p_174968_1_.addVertex(var8, p_174968_2_, var7);
                p_174968_1_.addVertex(var9, p_174968_2_, var7);
                p_174968_1_.addVertex(var9, p_174968_2_, var7 + 64);
                p_174968_1_.addVertex(var8, p_174968_2_, var7 + 64);
            }
        }
    }
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.func_174985_d()) {
                ...
                for (var18 = 0; var18 < var17.size(); ++var18) {
                    ...
                    boolean bl = var21 = var19.isInRangeToRender3d(var4, var6, var8) && (var19.ignoreFrustumCheck || p_180446_2_.isBoundingBoxInFrustum(var19.getEntityBoundingBox()) || var19.riddenByEntity == this.mc.thePlayer) && var19 instanceof EntityPlayer;
                    if (var19 == this.mc.func_175606_aa() && this.mc.gameSettings.thirdPersonView == 0 && !var20 || !var21) continue;
                    this.field_175010_j.renderEntitySimple(var19, p_180446_3_);
                }
            ...
            for (ContainerLocalRenderInformation var26 : this.glRenderLists) {
                Chunk var28 = this.theWorld.getChunkFromBlockCoords(var26.field_178036_a.func_178568_j());
                for (Entity var22 : var28.getEntityLists()[var26.field_178036_a.func_178568_j().getY() / 16]) {
                    boolean var23;
                    boolean bl = var23 = this.field_175010_j.func_178635_a(var22, p_180446_2_, var4, var6, var8) || var22.riddenByEntity == this.mc.thePlayer;
                    if (var23) {
                        boolean var24;
                        boolean bl2 = var24 = this.mc.func_175606_aa() instanceof EntityLivingBase ? ((EntityLivingBase)this.mc.func_175606_aa()).isPlayerSleeping() : false;
                        if (var22 == this.mc.func_175606_aa() && this.mc.gameSettings.thirdPersonView == 0 && !var24 || var22.posY >= 0.0 && var22.posY < 256.0 && !this.theWorld.isBlockLoaded(new BlockPos(var22))) continue;
                        ++this.countEntitiesRendered;
                        this.field_175010_j.renderEntitySimple(var22, p_180446_3_);
                    }
                    if (var23 || !(var22 instanceof EntityWitherSkull)) continue;
            ...
            RenderHelper.enableStandardItemLighting();
            for (ContainerLocalRenderInformation var26 : this.glRenderLists) {
                for (TileEntity var32 : var26.field_178036_a.func_178571_g().func_178485_b()) {
                    TileEntityRendererDispatcher.instance.func_180546_a(var32, p_180446_3_, -1);
                }
            }
            this.func_180443_s();
            for (DestroyBlockProgress var27 : this.damagedBlocks.values()) {
                TileEntity var32;
                ...
                if (var32 == null || !(var34 instanceof BlockChest) && !(var34 instanceof BlockEnderChest) && !(var34 instanceof BlockSign) && !(var34 instanceof BlockSkull)) continue;
    ...
    public void func_174970_a(Entity p_174970_1_, double p_174970_2_, ICamera p_174970_4_, int p_174970_5_, boolean p_174970_6_) {
        ...
        if (this.field_174988_E != p_174970_1_.chunkCoordX || this.field_174989_F != p_174970_1_.chunkCoordY || this.field_174990_G != p_174970_1_.chunkCoordZ || var7 * var7 + var9 * var9 + var11 * var11 > 16.0) {
        ...
        this.field_175000_K = p_174970_1_.rotationPitch;
        this.field_174994_L = p_174970_1_.rotationYaw;
        boolean bl = var22 = this.field_175001_U != null;
        if (!var22 && this.displayListEntitiesDirty) {
            ...
            if (var20 == null) {
                ...
                for (int var26 = -this.renderDistanceChunks; var26 <= this.renderDistanceChunks; ++var26) {
                    for (int var27 = -this.renderDistanceChunks; var27 <= this.renderDistanceChunks; ++var27) {
                        ...
                        if (var28 == null || !p_174970_4_.isBoundingBoxInFrustum(var28.field_178591_c)) continue;
                        var28.func_178577_a(p_174970_5_);
                        var23.add(new ContainerLocalRenderInformation(var28, null, 0, null));
                    }
                }
            } else {
                boolean var38 = false;
            ...
            while (!var23.isEmpty()) {
                ContainerLocalRenderInformation var39 = (ContainerLocalRenderInformation)var23.poll();
                ...
                for (EnumFacing var32 : EnumFacing.values()) {
                    ...
                    if (var24 && var39.field_178035_c.contains(var32.getOpposite()) || var24 && var43 != null && !var41.func_178571_g().func_178495_a(var43.getOpposite(), var32) || var33 == null || !var33.func_178577_a(p_174970_5_) || !p_174970_4_.isBoundingBoxInFrustum(var33.field_178591_c)) continue;
        ...
        for (ContainerLocalRenderInformation var39 : this.glRenderLists) {
            var41 = var39.field_178036_a;
            if (!var41.func_178569_m() && !var41.func_178583_l() && !var36.contains(var41)) continue;
            this.displayListEntitiesDirty = true;
    ...
    public int func_174977_a(EnumWorldBlockLayer p_174977_1_, double p_174977_2_, int p_174977_4_, Entity p_174977_5_) {
        ...
        if (p_174977_1_ == EnumWorldBlockLayer.TRANSLUCENT) {
            ...
            if (var6 * var6 + var8 * var8 + var10 * var10 > 1.0) {
                ...
                int var12 = 0;
                for (ContainerLocalRenderInformation var14 : this.glRenderLists) {
                    if (!var14.field_178036_a.field_178590_b.func_178492_d(p_174977_1_) || var12++ >= 15) continue;
        ...
        for (int var11 = var16; var11 != var9; var11 += var17) {
            RenderChunk var18 = ((ContainerLocalRenderInformation)this.glRenderLists.get((int)var11)).field_178036_a;
            if (var18.func_178571_g().func_178491_b(p_174977_1_)) continue;
            ++var15;
            this.field_174996_N.func_178002_a(var18, p_174977_1_);
        }
        this.mc.mcProfiler.endStartSection("render_" + (Object)((Object)p_174977_1_));
        ...
        if (this.mc.theWorld.provider.getDimensionId() == 1) {
            ...
            if (var25 != null) {
                ...
                for (int var28 = 0; var28 <= 16; ++var28) {
                    ...
                    var24.addVertex(var16 * 120.0f, var17 * 120.0f, -var17 * 40.0f * var25[3]);
                }
                var23.draw();
                GlStateManager.popMatrix();
            ...
            var24.addVertexWithUV(-var14, 100.0, -var14, 0.0, 0.0);
            var24.addVertexWithUV(var14, 100.0, -var14, 1.0, 0.0);
            var24.addVertexWithUV(var14, 100.0, var14, 1.0, 1.0);
            var24.addVertexWithUV(-var14, 100.0, var14, 0.0, 1.0);
            var23.draw();
            var14 = 20.0f;
            ...
            var24.startDrawingQuads();
            var24.addVertexWithUV(-var14, -100.0, var14, var20, var21);
            var24.addVertexWithUV(var14, -100.0, var14, var18, var21);
            var24.addVertexWithUV(var14, -100.0, -var14, var18, var19);
            var24.addVertexWithUV(-var14, -100.0, -var14, var20, var19);
            var23.draw();
            GlStateManager.func_179090_x();
            ...
            double var26 = this.mc.thePlayer.func_174824_e((float)p_174976_1_).yCoord - this.theWorld.getHorizon();
            if (var26 < 0.0) {
                GlStateManager.pushMatrix();
                ...
                GlStateManager.popMatrix();
                var12 = 1.0f;
                var13 = -((float)(var26 + 65.0));
                var14 = -1.0f;
                var24.startDrawingQuads();
                var24.func_178974_a(0, 255);
                var24.addVertex(-1.0, var13, 1.0);
                var24.addVertex(1.0, var13, 1.0);
                var24.addVertex(1.0, -1.0, 1.0);
                var24.addVertex(-1.0, -1.0, 1.0);
                var24.addVertex(-1.0, -1.0, -1.0);
                var24.addVertex(1.0, -1.0, -1.0);
                var24.addVertex(1.0, var13, -1.0);
            ...
            GlStateManager.pushMatrix();
            GlStateManager.translate(0.0f, -((float)(var26 - 16.0)), 0.0f);
            GlStateManager.callList(this.glSkyList2);
            GlStateManager.popMatrix();
            GlStateManager.func_179098_w();
            GlStateManager.depthMask(true);
    ...
    public void func_180447_b(float p_180447_1_, int p_180447_2_) {
        if (this.mc.theWorld.provider.isSurfaceWorld()) {
            if (this.mc.gameSettings.fancyGraphics) {
                ...
                var12 = 4.8828125E-4f;
                double var26 = (float)this.cloudTickCounter + p_180447_1_;
                double var15 = this.mc.func_175606_aa().prevPosX + (this.mc.func_175606_aa().posX - this.mc.func_175606_aa().prevPosX) * (double)p_180447_1_ + var26 * 0.029999999329447746;
    ...
    public void func_174961_a(String p_174961_1_, BlockPos p_174961_2_) {
        ...
        if (p_174961_1_ != null) {
            ...
            PositionedSoundRecord var5 = PositionedSoundRecord.createRecordSoundAtPosition(new ResourceLocation(p_174961_1_), p_174961_2_.getX(), p_174961_2_.getY(), p_174961_2_.getZ());
    ...
    private EntityFX func_174974_b(int p_174974_1_, boolean p_174974_2_, double p_174974_3_, double p_174974_5_, double p_174974_7_, double p_174974_9_, double p_174974_11_, double p_174974_13_, int ... p_174974_15_) {
        if (this.mc != null && this.mc.func_175606_aa() != null && this.mc.effectRenderer != null) {
            ...
            double var23 = 16.0;
            return var17 * var17 + var19 * var19 + var21 * var21 > 256.0 ? null : (var16 > 1 ? null : this.mc.effectRenderer.func_178927_a(p_174974_1_, p_174974_3_, p_174974_5_, p_174974_7_, p_174974_9_, p_174974_11_, p_174974_13_, p_174974_15_));
        }
        return null;
    }
        ...
        switch (p_180439_2_) {
            ...
            case 2000: {
                ...
                for (int var33 = 0; var33 < 10; ++var33) {
                    double var34 = var5.nextDouble() * 0.2 + 0.01;
                    double var35 = var9 + (double)var31 * 0.01 + (var5.nextDouble() - 0.5) * (double)var8 * 0.5;
                    double var20 = var11 + (var5.nextDouble() - 0.5) * 0.5;
                    double var22 = var32 + (double)var8 * 0.01 + (var5.nextDouble() - 0.5) * (double)var31 * 0.5;
                    double var24 = (double)var31 * var34 + var5.nextGaussian() * 0.01;
                    double var26 = -0.03 + var5.nextGaussian() * 0.01;
                    double var28 = (double)var8 * var34 + var5.nextGaussian() * 0.01;
