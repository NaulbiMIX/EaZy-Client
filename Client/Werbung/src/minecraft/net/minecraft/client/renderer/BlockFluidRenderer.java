    ...
    public boolean func_178270_a(IBlockAccess p_178270_1_, IBlockState p_178270_2_, BlockPos p_178270_3_, WorldRenderer p_178270_4_) {
        ...
        if (var11) {
            ...
            if (var32 < -999.0f) {
                ...
                var34 = var33;
                var38 = var31.getInterpolatedV(16.0);
                ...
                float var43 = 8.0f;
                var33 = var31.getInterpolatedU(8.0f + (-var42 - var41) * 16.0f);
                var37 = var31.getInterpolatedV(8.0f + (-var42 + var41) * 16.0f);
                var34 = var31.getInterpolatedU(8.0f + (-var42 + var41) * 16.0f);
                var38 = var31.getInterpolatedV(8.0f + (var42 + var41) * 16.0f);
                var35 = var31.getInterpolatedU(8.0f + (var42 + var41) * 16.0f);
                var39 = var31.getInterpolatedV(8.0f + (var42 - var41) * 16.0f);
                var36 = var31.getInterpolatedU(8.0f + (var42 - var41) * 16.0f);
                var40 = var31.getInterpolatedV(8.0f + (-var42 - var41) * 16.0f);
            }
            ...
            p_178270_4_.addVertexWithUV(var24 + 0.0, var26 + (double)var21, var28 + 1.0, var34, var38);
            p_178270_4_.addVertexWithUV(var24 + 1.0, var26 + (double)var22, var28 + 1.0, var35, var39);
            p_178270_4_.addVertexWithUV(var24 + 1.0, var26 + (double)var23, var28 + 0.0, var36, var40);
        ...
        for (int var52 = 0; var52 < 4; ++var52) {
            ...
            float var51 = 1.0f;
            p_178270_4_.func_178986_b(var16 * (var51 *= var52 < 2 ? var17 : var18) * var8, var16 * var51 * var9, var16 * var51 * var10);
            p_178270_4_.addVertexWithUV(var56, var26 + (double)var36, var57, var46, var48);
            p_178270_4_.addVertexWithUV(var58, var26 + (double)var37, var44, var47, var49);
            p_178270_4_.addVertexWithUV(var58, var26 + 0.0, var44, var47, var50);
