...
public class RenderChunk {
    ...
    public void func_178581_b(float p_178581_1_, float p_178581_2_, float p_178581_3_, ChunkCompileTaskGenerator p_178581_4_) {
        ...
        if (!var9.extendedLevelsInChunkCache()) {
            ++field_178592_a;
            for (BlockPos.MutableBlockPos var12 : BlockPos.getAllInBoxMutable(var7, var8)) {
                TileEntity var15;
                ...
                if (var14.hasTileEntity() && (var15 = var9.getTileEntity(new BlockPos(var12))) != null && TileEntityRendererDispatcher.instance.hasSpecialRenderer(var15)) {
                    var5.func_178490_a(var15);
                }
                EnumWorldBlockLayer var24 = var14.getBlockLayer();
                int var16 = var24.ordinal();
                if (var14.getRenderType() == -1) continue;
                ...
                if (!Minecraft.getMinecraft().getBlockRendererDispatcher().func_175018_a(var13, var12, var9, var17)) continue;
                var5.func_178486_a(var24);
            }
            for (EnumWorldBlockLayer var23 : EnumWorldBlockLayer.values()) {
                if (!var5.func_178492_d(var23)) continue;
