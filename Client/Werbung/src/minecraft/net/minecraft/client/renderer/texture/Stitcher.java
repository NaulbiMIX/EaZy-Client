...
public class Stitcher {
    ...
    public void doStitch() {
        ...
        for (int var4 = 0; var4 < var3; ++var4) {
            ...
            String var6 = String.format("Unable to fit: %s - size: %dx%d - Maybe try a lowerresolution resourcepack?", ((Holder)var5).getAtlasSprite().getIconName(), ((Holder)var5).getAtlasSprite().getIconWidth(), ((Holder)var5).getAtlasSprite().getIconHeight());
    ...
    private boolean expandAndAllocateSlot(Holder p_94311_1_) {
        ...
        if (this.forcePowerOf2) {
            ...
            boolean bl4 = var14 = this.currentHeight + var2 <= this.maxHeight;
            if (!var13 && !var14) {
                return false;
            }
        ...
        public boolean addSlot(Holder p_94182_1_) {
            ...
            if (var2 <= this.width && var3 <= this.height) {
                ...
                do {
                    ...
                    return false;
                } while (!(var9 = (Slot)var8.next()).addSlot(p_94182_1_));
                return true;
            }
            return false;
        }
