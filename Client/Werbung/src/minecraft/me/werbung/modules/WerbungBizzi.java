...
extends Module {
    ...
    public WerbungBizzi() {
        super("WerbungBizzi", "\u00a77Bizzi Werbung (\u00a79U\u00a77)", 22, Category.CHAT);
    }
    ...
    public void onChat(ChatEvent ec) {
        if (ec.getMsg().contains("hat deine Anfrage angenommen")) {
            String name = ec.getMsg().replace("Freunde | ", "").replace(" hat deine Anfrage angenommen", "");
    ...
    public void onEnable() {
        ...
        this.mc.thePlayer.addChatMessage(new ChatComponentText("\u00a79\u00a7lWERBUNG \u00a77> Bizzi-Werbungs Modul aktiviert! (\u00a79" + this.players.size() + "\u00a77)"));
    ...
    public void onDisable() {
        this.players.clear();
        this.i = 0;
        this.mc.thePlayer.addChatMessage(new ChatComponentText("\u00a79\u00a7lWERBUNG \u00a77> Bizzi-Werbungs Modul deaktiviert!"));
