...
public class WerbungDurchrasten
extends Module {
    ...
    public WerbungDurchrasten() {
        super("WerbungDurchrasten", "\u00a77Durchrasten Werbung (\u00a79L\u00a77)", 38, Category.CHAT);
    }
    ...
    public void onEnable() {
        ...
        this.mc.thePlayer.addChatMessage(new ChatComponentText("\u00a79\u00a7lWERBUNG \u00a77> Durchrasten-Werbungs Modul aktiviert! (\u00a79" + this.players.size() + "\u00a77)"));
    ...
    public void onDisable() {
        this.players.clear();
        this.i = 0;
        this.mc.thePlayer.addChatMessage(new ChatComponentText("\u00a79\u00a7lWERBUNG \u00a77> Durchrasten-Werbungs Modul deaktiviert!"));
