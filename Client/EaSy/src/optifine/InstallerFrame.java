...
extends JFrame {
    ...
    private void customInit() {
        try {
            ...
            String s3 = s2.replace((CharSequence)"_", (CharSequence)" ");
            s3 = s3.replace((CharSequence)" U ", (CharSequence)" Ultra ");
            s3 = s3.replace((CharSequence)"L ", (CharSequence)"Light ");
    ...
    public static void main(String[] args) {
        try {
            ...
            Utils.centerWindow((Component)installerframe, null);
            installerframe.show();
        }
        catch (Exception exception) {
    ...
    private JPanel getPanelCenter() {
        if (this.ivjPanelCenter == null) {
            try {
                ...
                this.ivjPanelCenter.add((Component)this.getLabelOfVersion(), (Object)this.getLabelOfVersion().getName());
                this.ivjPanelCenter.add((Component)this.getLabelMcVersion(), (Object)this.getLabelMcVersion().getName());
                this.ivjPanelCenter.add((Component)this.getTextArea(), (Object)this.getTextArea().getName());
                this.ivjPanelCenter.add((Component)this.getLabelFolder(), (Object)this.getLabelFolder().getName());
                this.ivjPanelCenter.add((Component)this.getFieldFolder(), (Object)this.getFieldFolder().getName());
                this.ivjPanelCenter.add((Component)this.getButtonFolder(), (Object)this.getButtonFolder().getName());
            }
            catch (Throwable throwable) {
                this.handleException(throwable);
            }
    ...
    private JPanel getPanelBottom() {
        if (this.ivjPanelBottom == null) {
            try {
                ...
                this.ivjPanelBottom.setLayout((LayoutManager)new FlowLayout(1, 15, 10));
                this.ivjPanelBottom.setPreferredSize(new Dimension(390, 55));
                this.ivjPanelBottom.add((Component)this.getButtonInstall(), (Object)this.getButtonInstall().getName());
                this.ivjPanelBottom.add((Component)this.getButtonExtract(), (Object)this.getButtonExtract().getName());
                this.ivjPanelBottom.add((Component)this.getButtonClose(), (Object)this.getButtonClose().getName());
            }
            catch (Throwable throwable) {
                this.handleException(throwable);
            }
    ...
    private JPanel getPanelContentPane() {
        if (this.ivjPanelContentPane == null) {
            try {
                ...
                this.ivjPanelContentPane.setLayout((LayoutManager)new BorderLayout(5, 5));
                this.ivjPanelContentPane.setPreferredSize(new Dimension(394, 203));
                this.ivjPanelContentPane.add((Component)this.getPanelCenter(), (Object)"Center");
                this.ivjPanelContentPane.add((Component)this.getPanelBottom(), (Object)"South");
            }
            catch (Throwable throwable) {
                this.handleException(throwable);
            }
    ...
    private void initialize() {
        try {
            ...
            this.setContentPane((Container)this.getPanelContentPane());
    ...
    private void initConnections() throws Exception {
        this.getButtonFolder().addActionListener((ActionListener)this.ivjEventHandler);
        this.getButtonInstall().addActionListener((ActionListener)this.ivjEventHandler);
        this.getButtonExtract().addActionListener((ActionListener)this.ivjEventHandler);
        this.getButtonClose().addActionListener((ActionListener)this.ivjEventHandler);
    }
