...
public class ReflectorMethod {
            ...
            if (this.targetMethodParameterTypes == null) {
                ...
                if (amethod.length > 1) {
                    ...
                    for (int i = 0; i < amethod.length; ++i) {
                        ...
                        Config.warn("(Reflector)  - " + (Object)method);
                    }
                    return null;
                }
    ...
    public static Method getMethod(Class cls, String methodName, Class[] paramTypes) {
        ...
        for (int i = 0; i < amethod.length; ++i) {
            Class[] aclass;
            Method method = amethod[i];
            if (!method.getName().equals((Object)methodName) || !Reflector.matchesTypes(paramTypes, aclass = method.getParameterTypes())) continue;
            return method;
        }
        return null;
    }
