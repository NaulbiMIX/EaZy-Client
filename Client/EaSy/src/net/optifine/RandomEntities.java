...
public class RandomEntities {
    ...
    private static String getPathBase(String pathRandom) {
        ...
        return pathRandom.startsWith(PREFIX_MCPATCHER_MOB) ? StrUtils.replacePrefix(pathRandom, PREFIX_MCPATCHER_MOB, PREFIX_TEXTURES_ENTITY) : null;
    }
    ...
    private static void initialize() {
        ...
        for (int i = 0; i < astring2.length; ++i) {
            ...
            if (!Config.hasResource(resourcelocation) || (randomentityproperties = (RandomEntityProperties)mapProperties.get((Object)s1)) != null) continue;
