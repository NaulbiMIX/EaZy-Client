...
public class SmartLeaves {
    ...
    public static boolean isSameLeaves(IBlockState state1, IBlockState state2) {
        ...
        if (block != (block1 = state2.getBlock())) {
            return false;
        }
        if (block instanceof BlockOldLeaf) {
            return state1.getValue(BlockOldLeaf.VARIANT).equals((Object)state2.getValue(BlockOldLeaf.VARIANT));
        }
        return block instanceof BlockNewLeaf ? state1.getValue(BlockNewLeaf.VARIANT).equals((Object)state2.getValue(BlockNewLeaf.VARIANT)) : false;
    }
