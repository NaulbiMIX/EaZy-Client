...
extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.buttonList.add((Object)new GuiOptionButton(0, this.width / 2 - 74, this.height / 6 + 96, this.confirmButtonText));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiMessage.drawCenteredString(this.fontRendererObj, this.messageLine1, this.width / 2, 70, 16777215);
        int i = 90;
        for (Object o : this.listLines2) {
            String s = (String)o;
            GuiMessage.drawCenteredString(this.fontRendererObj, s, this.width / 2, i, 16777215);
