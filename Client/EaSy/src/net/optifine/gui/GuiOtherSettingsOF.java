...
implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new GuiButton(210, this.width / 2 - 100, this.height / 6 + 168 + 11 - 44, I18n.format("of.options.other.reset", new Object[0])));
    ...
    public void drawScreen(int x, int y, float f) {
        ...
        GuiOtherSettingsOF.drawCenteredString(this.fontRendererObj, this.title, this.width / 2, 15, 16777215);
