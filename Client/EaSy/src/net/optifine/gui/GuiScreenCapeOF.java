...
extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new GuiButtonOF(210, this.width / 2 - 155, this.height / 6 + 24 * ((i += 2) >> 1), 150, 20, I18n.format("of.options.capeOF.openEditor", new Object[0])));
        this.buttonList.add((Object)new GuiButtonOF(220, this.width / 2 - 155 + 160, this.height / 6 + 24 * (i >> 1), 150, 20, I18n.format("of.options.capeOF.reloadCape", new Object[0])));
        ...
        this.buttonList.add((Object)new GuiButtonOF(200, this.width / 2 - 100, this.height / 6 + 24 * ((i += 4) >> 1), I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiScreenCapeOF.drawCenteredString(this.fontRenderer, this.title, this.width / 2, 20, 16777215);
        if (this.message != null) {
            GuiScreenCapeOF.drawCenteredString(this.fontRenderer, this.message, this.width / 2, this.height / 6 + 60, 16777215);
