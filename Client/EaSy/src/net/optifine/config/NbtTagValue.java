...
public class NbtTagValue {
    ...
    public NbtTagValue(String tag, String value) {
        Object[] astring = Config.tokenize(tag, ".");
    ...
    private static String getNbtString(NBTBase nbtBase, int format) {
        ...
        if (nbtBase instanceof NBTTagInt) {
            ...
            return format == 1 ? PREFIX_HEX_COLOR + StrUtils.fillLeft(Integer.toHexString((int)nbttagint.getInt()), 6, '0') : Integer.toString((int)nbttagint.getInt());
        }
