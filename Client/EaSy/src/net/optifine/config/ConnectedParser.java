...
public class ConnectedParser {
    ...
    public MatchBlock[] parseMatchBlock(String blockStr) {
        ...
        Object[] astring = Config.tokenize(blockStr, ":");
        String s = "minecraft";
        int i = 0;
    ...
    public static Comparable parseValue(String str, Class cls) {
        ...
        return cls == Long.class ? Long.valueOf((String)str) : null;
    }
    ...
    public static int parseColor4(String str, int defVal) {
        ...
        str = str.trim();
        try {
            int i = (int)(Long.parseLong((String)str, (int)16) & -1L);
            return i;
        }
        catch (NumberFormatException var3) {
            return defVal;
    ...
    public Weather[] parseWeather(String str, String property, Weather[] errValue) {
        return this.parseObjects(str, (T[])Weather.values(), NAME_GETTER_ENUM, property, (T[])errValue);
    }
    ...
    private static int parseProfessionId(String str) {
        ...
        if (str.equals((Object)"priest")) {
            return 2;
        }
        if (str.equals((Object)"blacksmith")) {
            return 3;
        }
        if (str.equals((Object)"butcher")) {
            return 4;
        }
        return str.equals((Object)"nitwit") ? 5 : -1;
    }
