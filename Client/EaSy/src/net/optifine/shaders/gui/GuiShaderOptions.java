...
extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        if (ashaderoption != null) {
            ...
            for (int i2 = 0; i2 < ashaderoption.length; ++i2) {
                ...
                int j2 = i2 % k1;
                int k2 = i2 / k1;
                int l2 = Math.min((int)(this.width / k1), (int)200);
                ...
                this.buttonList.add((Object)guibuttonshaderoption);
            }
        }
        this.buttonList.add((Object)new GuiButton(201, this.width / 2 - i1 - 20, this.height / 6 + 168 + 11, i1, j1, I18n.format("controls.reset", new Object[0])));
        this.buttonList.add((Object)new GuiButton(200, this.width / 2 + 20, this.height / 6 + 168 + 11, i1, j1, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(int x, int y, float f) {
        ...
        if (this.screenText != null) {
            GuiShaderOptions.drawCenteredString(this.fontRendererObj, this.screenText, this.width / 2, 15, 16777215);
        } else {
            GuiShaderOptions.drawCenteredString(this.fontRendererObj, this.title, this.width / 2, 15, 16777215);
        }
