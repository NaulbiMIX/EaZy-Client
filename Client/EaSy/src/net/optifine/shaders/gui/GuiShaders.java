...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new GuiButton(201, l1, i2, k1 - 22 + 1, j, Lang.get("of.options.shaders.shadersFolder")));
        this.buttonList.add((Object)new GuiButtonDownloadShaders(210, l1 + k1 - 22 - 1, i2));
        this.buttonList.add((Object)new GuiButton(202, j1 / 4 * 3 - k1 / 2, this.height - 25, k1, j, I18n.format("gui.done", new Object[0])));
        this.buttonList.add((Object)new GuiButton(203, k, this.height - 25, i, j, Lang.get("of.options.shaders.shaderOptions")));
        this.updateButtons();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiShaders.drawCenteredString(this.fontRendererObj, this.screenTitle + " ", this.width / 2, 15, 16777215);
        ...
        if (i < this.width - 5) {
            GuiShaders.drawCenteredString(this.fontRendererObj, s, this.width / 2, this.height - 40, 8421504);
        } else {
    ...
    public static int getOSType() {
        ...
        return s.contains((CharSequence)"unix") ? 4 : 0;
    }
