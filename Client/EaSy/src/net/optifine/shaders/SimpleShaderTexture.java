...
extends AbstractTexture {
    ...
    private TextureMetadataSection loadTextureMetadataSection() {
        ...
        if (inputstream != null) {
            ...
            try {
                ...
                if (texturemetadatasection == null) {
                    TextureMetadataSection textureMetadataSection = new TextureMetadataSection(false, false, (List<Integer>)new ArrayList());
                ...
                texturemetadatasection = new TextureMetadataSection(false, false, (List<Integer>)new ArrayList());
                return texturemetadatasection;
            }
            finally {
        ...
        return new TextureMetadataSection(false, false, (List<Integer>)new ArrayList());
    }
