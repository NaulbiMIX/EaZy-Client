...
implements IParameters {
    ...
    public /* varargs */ ParametersVariable first(ExpressionType ... first) {
        return new ParametersVariable(first, this.repeat, this.last);
    }

    public /* varargs */ ParametersVariable repeat(ExpressionType ... repeat) {
        return new ParametersVariable(this.first, repeat, this.last);
    }

    public /* varargs */ ParametersVariable last(ExpressionType ... last) {
