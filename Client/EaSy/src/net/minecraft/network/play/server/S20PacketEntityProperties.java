...
implements Packet<INetHandlerPlayClient> {
    ...
    public S20PacketEntityProperties(int entityIdIn, Collection<IAttributeInstance> p_i45236_2_) {
        ...
        for (IAttributeInstance iattributeinstance : p_i45236_2_) {
            this.field_149444_b.add((Object)new Snapshot(iattributeinstance.getAttribute().getAttributeUnlocalizedName(), iattributeinstance.getBaseValue(), iattributeinstance.func_111122_c()));
        }
    }
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            for (int l = 0; l < k; ++l) {
                ...
                list.add((Object)new AttributeModifier(uuid, "Unknown synced attribute modifier", buf.readDouble(), buf.readByte()));
            }
            this.field_149444_b.add((Object)new Snapshot(s, d0, (Collection<AttributeModifier>)list));
        }
    }
