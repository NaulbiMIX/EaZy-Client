...
implements Packet<INetHandlerPlayClient> {
    ...
    public /* varargs */ S38PacketPlayerListItem(Action actionIn, EntityPlayerMP ... players) {
        this.action = actionIn;
        for (EntityPlayerMP entityplayermp : players) {
            this.players.add((Object)new AddPlayerData(entityplayermp.getGameProfile(), entityplayermp.ping, entityplayermp.theItemInWorldManager.getGameType(), entityplayermp.getTabListDisplayName()));
        }
    }
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            this.players.add((Object)new AddPlayerData(gameprofile, k, worldsettings$gametype, ichatcomponent));
        }
    }
