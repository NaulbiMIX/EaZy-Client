...
extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
        ...
        float f7 = f4 * (f5 = -MathHelper.cos(-f1 * 0.017453292f));
        Vec3 vec31 = vec3.addVector((double)f7 * (d3 = 5.0), (double)(f6 = MathHelper.sin(-f1 * 0.017453292f)) * d3, (double)(f8 = f3 * f5) * d3);
