...
public class Item {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        return ("" + StatCollector.translateToLocal(new StringBuilder().append(this.getUnlocalizedNameInefficiently(stack)).append(".name").toString())).trim();
    }
    ...
    public static void registerItems() {
        ...
        Item.registerItemBlock(Blocks.double_plant, new ItemDoublePlant(Blocks.double_plant, Blocks.double_plant, new Function<ItemStack, String>(){
