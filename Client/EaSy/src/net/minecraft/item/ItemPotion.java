...
extends Item {
    ...
    public List<PotionEffect> getEffects(ItemStack stack) {
        ...
        List<PotionEffect> list = (List<PotionEffect>)this.effectCache.get((Object)stack.getMetadata());
        if (list == null) {
            list = PotionHelper.getPotionEffects(stack.getMetadata(), false);
            this.effectCache.put((Object)stack.getMetadata(), list);
        }
        return list;
    }

    public List<PotionEffect> getEffects(int meta) {
        List<PotionEffect> list = (List<PotionEffect>)this.effectCache.get((Object)meta);
        if (list == null) {
            list = PotionHelper.getPotionEffects(meta, false);
            this.effectCache.put((Object)meta, list);
        }
        return list;
    }
            ...
            if (list != null && !list.isEmpty()) {
                for (PotionEffect potioneffect : list) {
                    ...
                    if (potioneffect.getAmplifier() > 0) {
                        s1 = s1 + " " + StatCollector.translateToLocal(new StringBuilder().append("potion.potency.").append(potioneffect.getAmplifier()).toString()).trim();
                    }
                    if (potioneffect.getDuration() > 20) {
                        s1 = s1 + " (" + Potion.getDurationString(potioneffect) + ")";
                    }
                    if (potion.isBadEffect()) {
                        tooltip.add((Object)((Object)((Object)EnumChatFormatting.RED) + s1));
                        continue;
                    }
                    tooltip.add((Object)((Object)((Object)EnumChatFormatting.GRAY) + s1));
                }
            } else {
                String s = StatCollector.translateToLocal("potion.empty").trim();
                tooltip.add((Object)((Object)((Object)EnumChatFormatting.GRAY) + s));
            }
            if (!multimap.isEmpty()) {
                tooltip.add((Object)"");
                tooltip.add((Object)((Object)((Object)EnumChatFormatting.DARK_PURPLE) + StatCollector.translateToLocal("potion.effects.whenDrank")));
                for (Map.Entry entry1 : multimap.entries()) {
                    ...
                    if (d0 > 0.0) {
                        tooltip.add((Object)((Object)((Object)EnumChatFormatting.BLUE) + StatCollector.translateToLocalFormatted(new StringBuilder().append("attribute.modifier.plus.").append(attributemodifier2.getOperation()).toString(), ItemStack.DECIMALFORMAT.format(d1), StatCollector.translateToLocal(new StringBuilder().append("attribute.name.").append((String)entry1.getKey()).toString()))));
                        continue;
                    }
                    if (!(d0 < 0.0)) continue;
                    tooltip.add((Object)((Object)((Object)EnumChatFormatting.RED) + StatCollector.translateToLocalFormatted(new StringBuilder().append("attribute.modifier.take.").append(attributemodifier2.getOperation()).toString(), ItemStack.DECIMALFORMAT.format(d1 *= -1.0), StatCollector.translateToLocal(new StringBuilder().append("attribute.name.").append((String)entry1.getKey()).toString()))));
                }
            }
        }
    }
    ...
    public void getSubItems(Item itemIn, CreativeTabs tab, List<ItemStack> subItems) {
        ...
        if (SUB_ITEMS_CACHE.isEmpty()) {
            for (int i = 0; i <= 15; ++i) {
                for (int j = 0; j <= 1; ++j) {
                    int lvt_6_1_ = j == 0 ? i | 8192 : i | 16384;
                    for (int l = 0; l <= 2; ++l) {
                        List<PotionEffect> list;
                        int i1 = lvt_6_1_;
                        if (l != 0) {
                        ...
                        SUB_ITEMS_CACHE.put(list, (Object)i1);
                    }
                }
            }
        }
        Iterator i = SUB_ITEMS_CACHE.values().iterator();
        while (i.hasNext()) {
            int j1 = (Integer)i.next();
