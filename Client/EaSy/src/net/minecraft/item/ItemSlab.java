...
extends ItemBlock {
    ...
    public boolean canPlaceBlockOnSide(World worldIn, BlockPos pos, EnumFacing side, EntityPlayer player, ItemStack stack) {
        ...
        return (iblockstate1 = worldIn.getBlockState(blockpos = pos.offset(side))).getBlock() == this.singleSlab && object == iblockstate1.getValue(iproperty) ? true : super.canPlaceBlockOnSide(worldIn, pos, side, player, stack);
    }
