...
public final class ItemStack {
    ...
    public List<String> getTooltip(EntityPlayer playerIn, boolean advanced) {
        ...
        if ((i1 & 32) == 0) {
            this.item.addInformation(this, playerIn, (List<String>)list, advanced);
        }
        if (this.hasTagCompound()) {
            ...
            if ((i1 & 1) == 0 && (nbttaglist = this.getEnchantmentTagList()) != null) {
                for (int j = 0; j < nbttaglist.tagCount(); ++j) {
                    ...
                    list.add((Object)Enchantment.getEnchantmentById(k).getTranslatedName(l));
                }
            }
            if (this.stackTagCompound.hasKey("display", 10)) {
                ...
                if (nbttagcompound.hasKey("color", 3)) {
                    if (advanced) {
                        ...
                        list.add((Object)((Object)((Object)EnumChatFormatting.ITALIC) + StatCollector.translateToLocal("item.dyed")));
                    }
                }
                if (nbttagcompound.getTagId("Lore") == 9 && (nbttaglist1 = nbttagcompound.getTagList("Lore", 8)).tagCount() > 0) {
                    for (int j1 = 0; j1 < nbttaglist1.tagCount(); ++j1) {
                        list.add((Object)((Object)((Object)EnumChatFormatting.DARK_PURPLE) + "" + (Object)((Object)EnumChatFormatting.ITALIC) + nbttaglist1.getStringTagAt(j1)));
                    }
                }
            }
        }
        if (!(multimap = this.getAttributeModifiers()).isEmpty() && (i1 & 2) == 0) {
            ...
            for (Map.Entry entry : multimap.entries()) {
                ...
                if (d0 > 0.0) {
                    list.add((Object)((Object)((Object)EnumChatFormatting.BLUE) + StatCollector.translateToLocalFormatted(new StringBuilder().append("attribute.modifier.plus.").append(attributemodifier.getOperation()).toString(), DECIMALFORMAT.format(d1), StatCollector.translateToLocal(new StringBuilder().append("attribute.name.").append((String)entry.getKey()).toString()))));
                    continue;
                }
                if (!(d0 < 0.0)) continue;
                list.add((Object)((Object)((Object)EnumChatFormatting.RED) + StatCollector.translateToLocalFormatted(new StringBuilder().append("attribute.modifier.take.").append(attributemodifier.getOperation()).toString(), DECIMALFORMAT.format(d1 *= -1.0), StatCollector.translateToLocal(new StringBuilder().append("attribute.name.").append((String)entry.getKey()).toString()))));
            }
        }
        if (this.hasTagCompound() && this.getTagCompound().getBoolean("Unbreakable") && (i1 & 4) == 0) {
            list.add((Object)((Object)((Object)EnumChatFormatting.BLUE) + StatCollector.translateToLocal("item.unbreakable")));
        }
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanDestroy", 9) && (i1 & 8) == 0 && (nbttaglist2 = this.stackTagCompound.getTagList("CanDestroy", 8)).tagCount() > 0) {
            list.add((Object)"");
            list.add((Object)((Object)((Object)EnumChatFormatting.GRAY) + StatCollector.translateToLocal("item.canBreak")));
            for (int k1 = 0; k1 < nbttaglist2.tagCount(); ++k1) {
                Block block = Block.getBlockFromName(nbttaglist2.getStringTagAt(k1));
                if (block != null) {
                    list.add((Object)((Object)((Object)EnumChatFormatting.DARK_GRAY) + block.getLocalizedName()));
                    continue;
                }
                list.add((Object)((Object)((Object)EnumChatFormatting.DARK_GRAY) + "missingno"));
            }
        }
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanPlaceOn", 9) && (i1 & 16) == 0 && (nbttaglist3 = this.stackTagCompound.getTagList("CanPlaceOn", 8)).tagCount() > 0) {
            list.add((Object)"");
            list.add((Object)((Object)((Object)EnumChatFormatting.GRAY) + StatCollector.translateToLocal("item.canPlace")));
            for (int l1 = 0; l1 < nbttaglist3.tagCount(); ++l1) {
                Block block1 = Block.getBlockFromName(nbttaglist3.getStringTagAt(l1));
                if (block1 != null) {
                    list.add((Object)((Object)((Object)EnumChatFormatting.DARK_GRAY) + block1.getLocalizedName()));
                    continue;
                }
                list.add((Object)((Object)((Object)EnumChatFormatting.DARK_GRAY) + "missingno"));
            }
        ...
        if (advanced) {
            ...
            list.add((Object)((Object)((Object)EnumChatFormatting.DARK_GRAY) + Item.itemRegistry.getNameForObject(this.item).toString()));
            if (this.hasTagCompound()) {
                list.add((Object)((Object)((Object)EnumChatFormatting.DARK_GRAY) + "NBT: " + this.getTagCompound().getKeySet().size() + " tag(s)"));
            }
        }
        return list;
    }
