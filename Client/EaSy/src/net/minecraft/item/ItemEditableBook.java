    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        if (stack.hasTagCompound()) {
            ...
            if (!StringUtils.isNullOrEmpty(s)) {
                tooltip.add((Object)((Object)((Object)EnumChatFormatting.GRAY) + StatCollector.translateToLocalFormatted("book.byAuthor", s)));
            }
            tooltip.add((Object)((Object)((Object)EnumChatFormatting.GRAY) + StatCollector.translateToLocal(new StringBuilder().append("book.generation.").append(nbttagcompound.getInteger("generation")).toString())));
        }
    }
