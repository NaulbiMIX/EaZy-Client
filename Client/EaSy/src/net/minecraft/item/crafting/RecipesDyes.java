...
public class RecipesDyes {
    public void addRecipes(CraftingManager p_77607_1_) {
        for (int i = 0; i < 16; ++i) {
            ...
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - i), new Object[]{"###", "#X#", "###", Character.valueOf((char)'#'), new ItemStack(Blocks.glass), Character.valueOf((char)'X'), new ItemStack(Items.dye, 1, i)});
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, i), new Object[]{"###", "###", Character.valueOf((char)'#'), new ItemStack(Blocks.stained_glass, 1, i)});
        }
