...
public class RealmsServerStatusPinger {
    ...
    private final List<NetworkManager> connections = Collections.synchronizedList((List)Lists.newArrayList());
    ...
    public void pingServer(final String p_pingServer_1_, final RealmsServerPing p_pingServer_2_) throws UnknownHostException {
        if (p_pingServer_1_ != null && !p_pingServer_1_.startsWith("0.0.0.0") && !p_pingServer_1_.isEmpty()) {
            ...
            final NetworkManager networkmanager = NetworkManager.createNetworkManagerAndConnect(InetAddress.getByName((String)realmsserveraddress.getHost()), realmsserveraddress.getPort(), false);
            this.connections.add((Object)networkmanager);
            networkmanager.setNetHandler(new INetHandlerStatusClient(){
                ...
                public void handleServerInfo(S00PacketServerInfo packetIn) {
                    ...
                    if (serverstatusresponse.getPlayerCountData() != null) {
                        p_pingServer_2_.nrOfPlayers = String.valueOf((int)serverstatusresponse.getPlayerCountData().getOnlinePlayerCount());
    ...
    public void tick() {
        ...
        synchronized (list) {
            ...
            while (iterator.hasNext()) {
                NetworkManager networkmanager = (NetworkManager)((Object)iterator.next());
