...
extends EntityAIBase {
    ...
    public static boolean isSuitableTarget(EntityLiving attacker, EntityLivingBase target, boolean includeInvincibles, boolean checkSight) {
        ...
        if (!attacker.canAttackClass((Class<? extends EntityLivingBase>)target.getClass())) {
            return false;
        }
        ...
        if (attacker instanceof IEntityOwnable && StringUtils.isNotEmpty((CharSequence)((IEntityOwnable)((Object)attacker)).getOwnerId())) {
            if (target instanceof IEntityOwnable && ((IEntityOwnable)((Object)attacker)).getOwnerId().equals((Object)((IEntityOwnable)((Object)target)).getOwnerId())) {
                return false;
            }
