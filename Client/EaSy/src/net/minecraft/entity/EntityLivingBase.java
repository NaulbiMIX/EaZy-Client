...
extends Entity {
    ...
    public EntityLivingBase(World worldIn) {
        ...
        this.rotationYawHead = this.rotationYaw = (float)(Math.random() * 3.1415927410125732 * 2.0);
    ...
    protected void entityInit() {
        ...
        this.dataWatcher.addObject(6, Float.valueOf((float)1.0f));
    }
    ...
    public void onEntityUpdate() {
        ...
        if (this.isEntityAlive()) {
            ...
            if (this.isEntityInsideOpaqueBlock()) {
                ...
                this.attackEntityFrom(DamageSource.inWall, Math.max((int)1, (int)MathHelper.floor_double(-d0 * this.worldObj.getWorldBorder().getDamageAmount())));
            }
        }
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTime == 20) {
            if (!this.worldObj.isRemote && (this.recentlyHit > 0 || this.isPlayer()) && this.canDropLoot() && this.worldObj.getGameRules().getBoolean("doMobLoot")) {
                int j;
                for (int i = this.getExperiencePoints((EntityPlayer)this.attackingPlayer); i > 0; i -= j) {
    ...
    protected void updatePotionMetadata() {
        if (this.activePotionsMap.isEmpty()) {
            ...
            int i = PotionHelper.calcPotionLiquidColor((Collection<PotionEffect>)this.activePotionsMap.values());
            this.dataWatcher.updateObject(8, (byte)(PotionHelper.getAreAmbient((Collection<PotionEffect>)this.activePotionsMap.values()) ? 1 : 0));
    ...
    public void setHealth(float health) {
        this.dataWatcher.updateObject(6, Float.valueOf((float)MathHelper.clamp_float(health, 0.0f, this.getMaxHealth())));
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (flag) {
            ...
            if (entity != null) {
                ...
                this.attackedAtYaw = (float)(MathHelper.atan2(d0, d1) * 180.0 / 3.1415927410125732 - (double)this.rotationYaw);
    ...
    protected void damageEntity(DamageSource damageSrc, float damageAmount) {
        if (!this.isEntityInvulnerable(damageSrc)) {
            ...
            float f1 = Math.max((float)(damageAmount - this.getAbsorptionAmount()), (float)0.0f);
    ...
    protected void collideWithNearbyEntities() {
        List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().expand(0.20000000298023224, 0.0, 0.20000000298023224), (Predicate<? super Entity>)Predicates.and(EntitySelectors.NOT_SPECTATING, (Predicate)new Predicate<Entity>(){
