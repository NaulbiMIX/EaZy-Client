    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote && this.getWatchedTargetId(0) > 0 && (entity = this.worldObj.getEntityByID(this.getWatchedTargetId(0))) != null) {
            ...
            if ((d3 = (d0 = entity.posX - this.posX) * d0 + (d1 = entity.posZ - this.posZ) * d1) > 9.0) {
                ...
                this.motionX += (d0 / d5 * 0.5 - this.motionX) * 0.6000000238418579;
                this.motionZ += (d1 / d5 * 0.5 - this.motionZ) * 0.6000000238418579;
            }
        }
        ...
        for (int j = 0; j < 2; ++j) {
            ...
            if (entity1 != null) {
                ...
                float f = (float)(MathHelper.atan2(d8, d6) * 180.0 / 3.1415927410125732) - 90.0f;
                float f1 = (float)(-(MathHelper.atan2(d7, d9) * 180.0 / 3.1415927410125732));
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            this.worldObj.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d10 + this.rand.nextGaussian() * 0.30000001192092896, d2 + this.rand.nextGaussian() * 0.30000001192092896, d4 + this.rand.nextGaussian() * 0.30000001192092896, 0.0, 0.0, 0.0, new int[0]);
            if (!flag || this.worldObj.rand.nextInt(4) != 0) continue;
            this.worldObj.spawnParticle(EnumParticleTypes.SPELL_MOB, d10 + this.rand.nextGaussian() * 0.30000001192092896, d2 + this.rand.nextGaussian() * 0.30000001192092896, d4 + this.rand.nextGaussian() * 0.30000001192092896, 0.699999988079071, 0.699999988079071, 0.5, new int[0]);
        }
