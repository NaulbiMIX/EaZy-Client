...
extends Entity {
    ...
    public void onUpdate() {
        ...
        if (d9 > 0.2975) {
            double d2 = Math.cos((double)((double)this.rotationYaw * 3.141592653589793 / 180.0));
            double d4 = Math.sin((double)((double)this.rotationYaw * 3.141592653589793 / 180.0));
            int k = 0;
        ...
        if (this.worldObj.isRemote && this.isBoatEmpty) {
            ...
            if (this.riddenByEntity instanceof EntityLivingBase) {
                ...
                this.motionX += -Math.sin((double)(f * 3.1415927f / 180.0f)) * this.speedMultiplier * (double)entitylivingbase.moveForward * 0.05000000074505806;
                this.motionZ += Math.cos((double)(f * 3.1415927f / 180.0f)) * this.speedMultiplier * (double)entitylivingbase.moveForward * 0.05000000074505806;
            }
            ...
            if (d18 * d18 + d21 * d21 > 0.001) {
                d15 = (float)(MathHelper.atan2(d21, d18) * 180.0 / 3.141592653589793);
            }
            ...
            if (!this.worldObj.isRemote) {
                List<Entity> list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().expand(0.20000000298023224, 0.0, 0.20000000298023224));
    ...
    public void updateRiderPosition() {
        if (this.riddenByEntity != null) {
            double d0 = Math.cos((double)((double)this.rotationYaw * 3.141592653589793 / 180.0)) * 0.4;
            double d1 = Math.sin((double)((double)this.rotationYaw * 3.141592653589793 / 180.0)) * 0.4;
    ...
    public void setDamageTaken(float p_70266_1_) {
        this.dataWatcher.updateObject(19, Float.valueOf((float)p_70266_1_));
    }
