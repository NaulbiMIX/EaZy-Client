...
extends EntityLivingBase {
    ...
    private void playParticles() {
        if (this.worldObj instanceof WorldServer) {
            ((WorldServer)this.worldObj).spawnParticle(EnumParticleTypes.BLOCK_DUST, this.posX, this.posY + (double)this.height / 1.5, this.posZ, 10, this.width / 4.0f, (double)(this.height / 4.0f), (double)(this.width / 4.0f), 0.05, Block.getStateId(Blocks.planks.getDefaultState()));
        }
    }
    ...
    private void setSmall(boolean p_175420_1_) {
        ...
        b0 = p_175420_1_ ? (byte)(b0 | 1) : (byte)(b0 & -2);
    ...
    private void setNoGravity(boolean p_175425_1_) {
        byte b0 = this.dataWatcher.getWatchableObjectByte(10);
        b0 = p_175425_1_ ? (byte)(b0 | 2) : (byte)(b0 & -3);
        this.dataWatcher.updateObject(10, b0);
    }
    ...
    private void setShowArms(boolean p_175413_1_) {
        byte b0 = this.dataWatcher.getWatchableObjectByte(10);
        b0 = p_175413_1_ ? (byte)(b0 | 4) : (byte)(b0 & -5);
        this.dataWatcher.updateObject(10, b0);
    }
    ...
    private void setNoBasePlate(boolean p_175426_1_) {
        byte b0 = this.dataWatcher.getWatchableObjectByte(10);
        b0 = p_175426_1_ ? (byte)(b0 | 8) : (byte)(b0 & -9);
        this.dataWatcher.updateObject(10, b0);
    }
    ...
    private void setMarker(boolean p_181027_1_) {
        byte b0 = this.dataWatcher.getWatchableObjectByte(10);
        b0 = p_181027_1_ ? (byte)(b0 | 16) : (byte)(b0 & -17);
        this.dataWatcher.updateObject(10, b0);
    }
