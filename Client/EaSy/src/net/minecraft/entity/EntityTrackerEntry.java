...
public class EntityTrackerEntry {
    ...
    private void sendMetadataToAllAssociatedPlayers() {
        ...
        if (this.trackedEntity instanceof EntityLivingBase) {
            ...
            if (!set.isEmpty()) {
                this.func_151261_b(new S20PacketEntityProperties(this.trackedEntity.getEntityId(), (Collection<IAttributeInstance>)set));
            }
            set.clear();
        }
    }
    ...
    private Packet createSpawnPacket() {
        ...
        throw new IllegalArgumentException("Don't know how to add " + (Object)this.trackedEntity.getClass() + "!");
    }
