...
extends Entity {
    ...
    public void handleHookCasting(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_) {
        ...
        this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(p_146035_1_, p_146035_5_) * 180.0 / 3.1415927410125732);
        this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(p_146035_3_, f1) * 180.0 / 3.1415927410125732);
    ...
    public void onUpdate() {
        ...
        if (this.fishPosRotationIncrements > 0) {
            ...
            if (!this.inGround) {
                ...
                this.rotationPitch = (float)(MathHelper.atan2(this.motionY, f5) * 180.0 / 3.1415927410125732);
                ...
                if (!this.worldObj.isRemote && d10 > 0.0) {
                    ...
                    if (this.ticksCatchable > 0) {
                        ...
                        if (this.ticksCatchableDelay <= 0) {
                            ...
                            worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX, (double)(f8 + 1.0f), this.posZ, (int)(1.0f + this.width * 20.0f), this.width, 0.0, (double)this.width, 0.20000000298023224, new int[0]);
                            worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, this.posX, (double)(f8 + 1.0f), this.posZ, (int)(1.0f + this.width * 20.0f), this.width, 0.0, (double)this.width, 0.20000000298023224, new int[0]);
                            ...
                            if (block1 == Blocks.water || block1 == Blocks.flowing_water) {
                                if (this.rand.nextFloat() < 0.15f) {
                                    worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, d13, d15 - 0.10000000149011612, d16, 1, f10, 0.1, (double)f11, 0.0, new int[0]);
                                }
                                float f3 = f10 * 0.04f;
                                float f4 = f11 * 0.04f;
                                worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0, f4, 0.01, (double)(-f3), 1.0, new int[0]);
                                worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0, -f4, 0.01, (double)f3, 1.0, new int[0]);
                            }
                        }
                        ...
                        if (this.rand.nextFloat() < f1) {
                            ...
                            if (block == Blocks.water || block == Blocks.flowing_water) {
                                worldserver.spawnParticle(EnumParticleTypes.WATER_SPLASH, d12, d14, d6, 2 + this.rand.nextInt(2), 0.10000000149011612, 0.0, 0.10000000149011612, 0.0, new int[0]);
                            }
                        }
