...
implements ICommandSender {
    ...
    protected void createRunningParticles() {
        ...
        int k;
        int i = MathHelper.floor_double(this.posX);
        BlockPos blockpos = new BlockPos(i, j = MathHelper.floor_double(this.posY - 0.20000000298023224), k = MathHelper.floor_double(this.posZ));
    ...
    public void applyEntityCollision(Entity entityIn) {
        ...
        double d0;
        double d1;
        if (entityIn.riddenByEntity != this && entityIn.ridingEntity != this && !entityIn.noClip && !this.noClip && (d2 = MathHelper.abs_max(d0 = entityIn.posX - this.posX, d1 = entityIn.posZ - this.posZ)) >= 0.009999999776482582) {
    ...
    public void setPortal(BlockPos pos) {
        if (this.timeUntilPortal > 0) {
            ...
            if (!this.worldObj.isRemote && !pos.equals(this.lastPortalPos)) {
                ...
                d1 = Math.abs((double)MathHelper.func_181160_c(d1 - (double)(blockpattern$patternhelper.getFinger().rotateY().getAxisDirection() == EnumFacing.AxisDirection.NEGATIVE), d0, d0 - (double)blockpattern$patternhelper.func_181118_d()));
    ...
    public void addEntityCrashInfo(CrashReportCategory category) {
        ...
        category.addCrashSection("Entity's Exact location", String.format((String)"%.2f, %.2f, %.2f", (Object[])new Object[]{this.posX, this.posY, this.posZ}));
        ...
        category.addCrashSection("Entity's Momentum", String.format((String)"%.2f, %.2f, %.2f", (Object[])new Object[]{this.motionX, this.motionY, this.motionZ}));
