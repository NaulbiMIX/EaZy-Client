...
extends EntityMob {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        IBlockState iblockstate = tagCompund.hasKey("carried", 8) ? Block.getBlockFromName(tagCompund.getString("carried")).getStateFromMeta(tagCompund.getShort("carriedData") & 65535) : Block.getBlockById(tagCompund.getShort("carried")).getStateFromMeta(tagCompund.getShort("carriedData") & 65535);
    ...
    extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            if (carriableBlocks.contains((Object)block)) {
    ...
    extends EntityAINearestAttackableTarget {
        ...
        public boolean shouldExecute() {
            ...
            Collections.sort(list, (Comparator)this.theNearestAttackableTargetSorter);
            if (list.isEmpty()) {
                return false;
            }
