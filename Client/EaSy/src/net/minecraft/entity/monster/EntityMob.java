...
implements IMob {
    ...
    public boolean attackEntityAsMob(Entity entityIn) {
        ...
        if (flag = entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), f)) {
            int j;
            if (i > 0) {
                entityIn.addVelocity(-MathHelper.sin(this.rotationYaw * 3.1415927f / 180.0f) * (float)i * 0.5f, 0.1, MathHelper.cos(this.rotationYaw * 3.1415927f / 180.0f) * (float)i * 0.5f);
                this.motionX *= 0.6;
                this.motionZ *= 0.6;
            }
