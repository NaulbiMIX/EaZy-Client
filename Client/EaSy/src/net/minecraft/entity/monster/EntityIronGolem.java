...
extends EntityGolem {
    ...
    public void onLivingUpdate() {
        ...
        if (this.motionX * this.motionX + this.motionZ * this.motionZ > 2.500000277905201E-7 && this.rand.nextInt(5) == 0 && (block = (iblockstate = this.worldObj.getBlockState(new BlockPos(i = MathHelper.floor_double(this.posX), j = MathHelper.floor_double(this.posY - 0.20000000298023224), k = MathHelper.floor_double(this.posZ)))).getBlock()).getMaterial() != Material.air) {
