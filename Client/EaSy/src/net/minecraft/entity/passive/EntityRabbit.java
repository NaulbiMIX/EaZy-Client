...
extends EntityAnimal {
    ...
    private void calculateRotationYaw(double x, double z) {
        this.rotationYaw = (float)(MathHelper.atan2(z - this.posZ, x - this.posX) * 180.0 / 3.1415927410125732) - 90.0f;
    }
    ...
    public void setRabbitType(int rabbitTypeId) {
        if (rabbitTypeId == 99) {
            ...
            this.targetTasks.addTask(2, new EntityAINearestAttackableTarget<EntityWolf>(this, EntityWolf.class, true));
