...
extends EntityAmbientCreature {
    ...
    protected void updateAITasks() {
        ...
        if (this.getIsBatHanging()) {
            ...
            this.motionX += (Math.signum((double)d0) * 0.5 - this.motionX) * 0.10000000149011612;
            this.motionY += (Math.signum((double)d1) * 0.699999988079071 - this.motionY) * 0.10000000149011612;
            this.motionZ += (Math.signum((double)d2) * 0.5 - this.motionZ) * 0.10000000149011612;
            float f = (float)(MathHelper.atan2(this.motionZ, this.motionX) * 180.0 / 3.1415927410125732) - 90.0f;
