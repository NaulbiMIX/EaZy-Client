...
implements IInvBasic {
    ...
    public EntityAgeable createChild(EntityAgeable ageable) {
        ...
        if (k == 0) {
            ...
            int l = i1 < 4 ? this.getHorseVariant() & 255 : (i1 < 8 ? entityhorse.getHorseVariant() & 255 : this.rand.nextInt(7));
            int j1 = this.rand.nextInt(5);
            l = j1 < 2 ? (l |= this.getHorseVariant() & 65280) : (j1 < 4 ? (l |= entityhorse.getHorseVariant() & 65280) : (l |= this.rand.nextInt(5) << 8 & 65280));
