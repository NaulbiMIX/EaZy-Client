...
public class SharedMonsterAttributes {
    ...
    public static final IAttribute movementSpeed = new RangedAttribute(null, "generic.movementSpeed", 0.699999988079071, 0.0, 1024.0).setDescription("Movement Speed").setShouldWatch(true);
