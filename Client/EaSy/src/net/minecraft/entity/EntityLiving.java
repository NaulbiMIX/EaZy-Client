...
extends EntityLivingBase {
    ...
    protected void despawnEntity() {
        ...
        if ((entity = this.worldObj.getClosestPlayerToEntity(this, -1.0)) == null) return;
    ...
    public void faceEntity(Entity entityIn, float p_70625_2_, float p_70625_3_) {
        ...
        float f = (float)(MathHelper.atan2(d1, d0) * 180.0 / 3.141592653589793) - 90.0f;
        float f1 = (float)(-(MathHelper.atan2(d2, d3) * 180.0 / 3.141592653589793));
