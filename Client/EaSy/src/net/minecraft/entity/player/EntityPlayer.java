...
extends EntityLivingBase {
    ...
    protected void entityInit() {
        ...
        this.dataWatcher.addObject(17, Float.valueOf((float)0.0f));
    ...
    public void onLivingUpdate() {
        ...
        float f1 = (float)(Math.atan((double)(-this.motionY * 0.20000000298023224)) * 15.0);
        if (f > 0.1f) {
            f = 0.1f;
        }
    ...
    public EntityItem dropItem(ItemStack droppedItem, boolean dropAround, boolean traceItem) {
        ...
        double d0 = this.posY - 0.30000001192092896 + (double)this.getEyeHeight();
    ...
    protected void damageEntity(DamageSource damageSrc, float damageAmount) {
        if (!this.isEntityInvulnerable(damageSrc)) {
            ...
            if (f1 != 0.0f) {
                ...
                if (f1 < 3.4028235E37f) {
                    this.addStat(StatList.damageTakenStat, Math.round((float)(f1 * 10.0f)));
                }
            }
        }
    }
        ...
        if (targetEntity.canAttackWithItem() && !targetEntity.hitByEntity(this)) {
            ...
            if (f > 0.0f || f1 > 0.0f) {
                ...
                if (flag2) {
                    ...
                    if (i > 0) {
                        targetEntity.addVelocity(-MathHelper.sin(this.rotationYaw * 3.1415927f / 180.0f) * (float)i * 0.5f, 0.1, MathHelper.cos(this.rotationYaw * 3.1415927f / 180.0f) * (float)i * 0.5f);
                        this.motionX *= 0.6;
                        this.motionZ *= 0.6;
    ...
    private void addMountedMovementStat(double p_71015_1_, double p_71015_3_, double p_71015_5_) {
        int i;
        if (this.ridingEntity != null && (i = Math.round((float)(MathHelper.sqrt_double(p_71015_1_ * p_71015_1_ + p_71015_3_ * p_71015_3_ + p_71015_5_ * p_71015_5_) * 100.0f))) > 0) {
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn) {
        ...
        if ((entitylist$entityegginfo = (EntityList.EntityEggInfo)EntityList.entityEggs.get((Object)EntityList.getEntityID(entityLivingIn))) != null) {
    ...
    public void setAbsorptionAmount(float amount) {
        ...
        this.getDataWatcher().updateObject(17, Float.valueOf((float)amount));
    }
