...
public class Config {
    ...
    public static void initGameSettings(GameSettings p_initGameSettings_0_) {
        if (gameSettings == null) {
            ...
            ReflectorForge.putLaunchBlackboard("optifine.ForgeSplashCompatible", (Object)Boolean.TRUE);
        }
    }
    ...
    public static Boolean parseBoolean(String p_parseBoolean_0_, Boolean p_parseBoolean_1_) {
        try {
            ...
            if ((p_parseBoolean_0_ = p_parseBoolean_0_.trim().toLowerCase()).equals((Object)"true")) {
                return Boolean.TRUE;
            }
            return p_parseBoolean_0_.equals((Object)"false") ? Boolean.FALSE : p_parseBoolean_1_;
        }
        catch (NumberFormatException var3) {
            return p_parseBoolean_1_;
        }
    ...
    public static Object[] collectionToArray(Collection p_collectionToArray_0_, Class p_collectionToArray_1_) {
        ...
        if (p_collectionToArray_1_.isPrimitive()) {
            throw new IllegalArgumentException("Can not make arrays with primitive elements (int, double), element class: " + (Object)p_collectionToArray_1_);
        }
    ...
    public static boolean openWebLink(URI p_openWebLink_0_) {
        try {
            ...
            Config.warn("Error opening link: " + (Object)p_openWebLink_0_);
            Config.warn(exception.getClass().getName() + ": " + exception.getMessage());
            return false;
        }
    }
