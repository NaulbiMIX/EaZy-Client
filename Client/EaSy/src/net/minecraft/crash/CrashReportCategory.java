    ...
    public static void addBlockInfo(CrashReportCategory category, final BlockPos pos, final Block blockIn, final int blockData) {
        ...
        category.addCrashSectionCallable("Block type", new Callable<String>(){
            ...
            public String call() throws Exception {
                try {
                    return String.format((String)"ID #%d (%s // %s)", (Object[])new Object[]{i, blockIn.getUnlocalizedName(), blockIn.getClass().getCanonicalName()});
                }
        ...
        category.addCrashSectionCallable("Block data value", new Callable<String>(){
            ...
            public String call() throws Exception {
                ...
                String s = String.format((String)"%4s", (Object[])new Object[]{Integer.toBinaryString((int)blockData)}).replace((CharSequence)" ", (CharSequence)"0");
                return String.format((String)"%1$d / 0x%1$X / 0b%2$s", (Object[])new Object[]{blockData, s});
            }
        });
    ...
    static class Entry {
        ...
        public Entry(String key, Object value) {
            ...
            if (value == null) {
                ...
                Throwable throwable = (Throwable)((Object)value);
