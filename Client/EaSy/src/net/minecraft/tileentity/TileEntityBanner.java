...
extends TileEntity {
    ...
    public void setItemValues(ItemStack stack) {
        ...
        if (stack.hasTagCompound() && stack.getTagCompound().hasKey("BlockEntityTag", 10)) {
            ...
            this.baseColor = nbttagcompound.hasKey("Base", 99) ? nbttagcompound.getInteger("Base") : stack.getMetadata() & 15;
        } else {
    ...
    private void initializeBannerData() {
        if (this.patternList == null || this.colorList == null || this.patternResourceLocation == null) {
            if (!this.field_175119_g) {
                ...
                this.colorList.add((Object)EnumDyeColor.byDyeDamage(this.baseColor));
                ...
                if (this.patterns != null) {
                    for (int i = 0; i < this.patterns.tagCount(); ++i) {
                        ...
                        this.colorList.add((Object)EnumDyeColor.byDyeDamage(j));
