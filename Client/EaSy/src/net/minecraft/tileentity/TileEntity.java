...
public abstract class TileEntity {
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        if (s == null) {
            throw new RuntimeException((Object)this.getClass() + " is missing a mapping! This is a bug!");
        }
    ...
    public void addInfoToCrashReport(CrashReportCategory reportCategory) {
        reportCategory.addCrashSectionCallable("Name", new Callable<String>(){
            ...
            public String call() throws Exception {
                return (String)classToNameMap.get((Object)TileEntity.this.getClass()) + " // " + TileEntity.this.getClass().getCanonicalName();
            }
        });
        if (this.worldObj != null) {
            ...
            reportCategory.addCrashSectionCallable("Actual block type", new Callable<String>(){
                ...
                public String call() throws Exception {
                    ...
                    try {
                        return String.format((String)"ID #%d (%s // %s)", (Object[])new Object[]{i, Block.getBlockById(i).getUnlocalizedName(), Block.getBlockById(i).getClass().getCanonicalName()});
                    }
