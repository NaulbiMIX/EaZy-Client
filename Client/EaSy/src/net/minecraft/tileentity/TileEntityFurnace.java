...
ISidedInventory {
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_) {
        ...
        if (item instanceof ItemTool && ((ItemTool)item).getToolMaterialName().equals((Object)"WOOD")) {
            return 200;
        }
        if (item instanceof ItemSword && ((ItemSword)item).getToolMaterialName().equals((Object)"WOOD")) {
            return 200;
        }
        if (item instanceof ItemHoe && ((ItemHoe)item).getMaterialName().equals((Object)"WOOD")) {
            return 200;
        }
        if (item == Items.stick) {
            return 100;
