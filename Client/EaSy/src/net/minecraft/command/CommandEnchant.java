...
extends CommandBase {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        if (args.length == 1) {
            return CommandEnchant.getListOfStringsMatchingLastWord(args, this.getListOfPlayers());
        }
        return args.length == 2 ? CommandEnchant.getListOfStringsMatchingLastWord(args, Enchantment.func_181077_c()) : null;
    }
