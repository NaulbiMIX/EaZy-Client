...
extends CommandBase {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        if (args.length > 0 && args.length <= 3) {
            return CommandTestForBlock.func_175771_a(args, 0, pos);
        }
        return args.length == 4 ? CommandTestForBlock.getListOfStringsMatchingLastWord(args, Block.blockRegistry.getKeys()) : null;
    }
}
