            ...
            if (statbase == null) {
                ...
                if (statbase instanceof Achievement) {
                    ...
                    if (flag) {
                        ...
                        ArrayList list1 = Lists.newArrayList((Iterator)Iterators.filter((Iterator)AchievementList.achievementList.iterator(), (Predicate)new Predicate<Achievement>(){
                        ...
                        Iterator achievement1 = list1.iterator();
                        while (achievement1.hasNext()) {
                            Achievement achievement2;
                            Achievement achievement3 = achievement2 = (Achievement)achievement1.next();
                            boolean flag2 = false;
                            ...
                            if (flag2) continue;
                            Achievement achievement7 = achievement2;
                            while (achievement7 != null) {
                                list2.remove((Object)achievement2);
                                achievement7 = achievement7.parentAchievement;
                            }
                        }
