    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args.length != 1 && args.length != 2) {
            ...
            if (entity.worldObj != null) {
                ...
                CommandBase.CoordinateArg commandbase$coordinatearg1 = CommandTeleport.parseCoordinate(entity.posY, args[j++], 0, 0, false);
                CommandBase.CoordinateArg commandbase$coordinatearg2 = CommandTeleport.parseCoordinate(entity.posZ, args[j++], true);
                CommandBase.CoordinateArg commandbase$coordinatearg3 = CommandTeleport.parseCoordinate(entity.rotationYaw, args.length > j ? args[j++] : "~", false);
                CommandBase.CoordinateArg commandbase$coordinatearg4 = CommandTeleport.parseCoordinate(entity.rotationPitch, args.length > j ? args[j] : "~", false);
                if (entity instanceof EntityPlayerMP) {
                    ...
                    ((EntityPlayerMP)entity).playerNetServerHandler.setPlayerLocation(commandbase$coordinatearg.func_179629_b(), commandbase$coordinatearg1.func_179629_b(), commandbase$coordinatearg2.func_179629_b(), f, f1, (Set<S08PacketPlayerPosLook.EnumFlags>)set);
