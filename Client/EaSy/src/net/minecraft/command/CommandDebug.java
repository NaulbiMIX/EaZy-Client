...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals((Object)"start")) {
            ...
            CommandDebug.notifyOperators(sender, (ICommand)this, "commands.debug.stop", new Object[]{Float.valueOf((float)((float)k / 1000.0f)), l});
        }
    }
    ...
    private void saveProfileResults(long timeSpan, int tickSpan) {
        ...
        try {
            ...
            logger.error("Could not save profiler results to " + (Object)file1, throwable);
        }
    }
