...
extends CommandBase {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        ...
        if (args.length == 2 && args[0].equals((Object)"entity")) {
            return CommandStats.getListOfStringsMatchingLastWord(args, this.func_175776_d());
        }
        if (args.length >= 2 && args.length <= 4 && args[0].equals((Object)"block")) {
            return CommandStats.func_175771_a(args, 1, pos);
        }
        if (!(args.length == 3 && args[0].equals((Object)"entity") || args.length == 5 && args[0].equals((Object)"block"))) {
            if (!(args.length == 4 && args[0].equals((Object)"entity") || args.length == 6 && args[0].equals((Object)"block"))) {
                return !(args.length == 6 && args[0].equals((Object)"entity") || args.length == 8 && args[0].equals((Object)"block")) ? null : CommandStats.getListOfStringsMatchingLastWord(args, this.func_175777_e());
            }
