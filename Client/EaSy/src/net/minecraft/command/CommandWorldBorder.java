...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals((Object)"set")) {
            ...
            if (i > 0L) {
                ...
                if (d0 > d2) {
                    CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.setSlowly.shrink.success", String.format((String)"%.1f", (Object[])new Object[]{d2}), String.format((String)"%.1f", (Object[])new Object[]{d0}), Long.toString((long)(i / 1000L)));
                } else {
                    CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.setSlowly.grow.success", String.format((String)"%.1f", (Object[])new Object[]{d2}), String.format((String)"%.1f", (Object[])new Object[]{d0}), Long.toString((long)(i / 1000L)));
                }
            } else {
                worldborder.setTransition(d2);
                CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.set.success", String.format((String)"%.1f", (Object[])new Object[]{d2}), String.format((String)"%.1f", (Object[])new Object[]{d0}));
            }
            ...
            if (i1 > 0L) {
                ...
                if (d4 > d8) {
                    CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.setSlowly.shrink.success", String.format((String)"%.1f", (Object[])new Object[]{d8}), String.format((String)"%.1f", (Object[])new Object[]{d4}), Long.toString((long)(i1 / 1000L)));
                } else {
                    CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.setSlowly.grow.success", String.format((String)"%.1f", (Object[])new Object[]{d8}), String.format((String)"%.1f", (Object[])new Object[]{d4}), Long.toString((long)(i1 / 1000L)));
                }
            } else {
                worldborder.setTransition(d8);
                CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.set.success", String.format((String)"%.1f", (Object[])new Object[]{d8}), String.format((String)"%.1f", (Object[])new Object[]{d4}));
            }
            ...
            if (args[1].equals((Object)"buffer")) {
                ...
                CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.damage.buffer.success", String.format((String)"%.1f", (Object[])new Object[]{d5}), String.format((String)"%.1f", (Object[])new Object[]{d9}));
                ...
                CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.damage.amount.success", String.format((String)"%.2f", (Object[])new Object[]{d6}), String.format((String)"%.2f", (Object[])new Object[]{d10}));
            }
            ...
            sender.addChatMessage(new ChatComponentTranslation("commands.worldborder.get.success", String.format((String)"%.0f", (Object[])new Object[]{d7})));
        }
    }
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        ...
        if (args.length == 2 && args[0].equals((Object)"damage")) {
            return CommandWorldBorder.getListOfStringsMatchingLastWord(args, "buffer", "amount");
        }
        if (args.length >= 2 && args.length <= 3 && args[0].equals((Object)"center")) {
            return CommandWorldBorder.func_181043_b(args, 1, pos);
        }
        return args.length == 2 && args[0].equals((Object)"warning") ? CommandWorldBorder.getListOfStringsMatchingLastWord(args, "time", "distance") : null;
    }
}
