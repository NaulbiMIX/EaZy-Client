...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if ((world = sender.getEntityWorld()) instanceof WorldServer) {
            ...
            CommandParticle.notifyOperators(sender, (ICommand)this, "commands.particle.success", s, Math.max((int)i, (int)1));
        }
    }
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        ...
        if (args.length > 1 && args.length <= 4) {
            return CommandParticle.func_175771_a(args, 1, pos);
        }
        return args.length == 10 ? CommandParticle.getListOfStringsMatchingLastWord(args, "normal", "force") : null;
    }
}
