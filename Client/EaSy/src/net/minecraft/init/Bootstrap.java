    ...
    static void registerDispenserBehaviors() {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.bucket, new BehaviorDefaultDispenseItem(){
            ...
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                if (Material.water.equals((Object)material) && block instanceof BlockLiquid && iblockstate.getValue(BlockLiquid.LEVEL) == 0) {
                    item = Items.water_bucket;
                } else {
                    if (!Material.lava.equals((Object)material) || !(block instanceof BlockLiquid) || iblockstate.getValue(BlockLiquid.LEVEL) != 0) {
