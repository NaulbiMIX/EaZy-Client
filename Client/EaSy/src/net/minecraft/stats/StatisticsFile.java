...
extends StatFileWriter {
    ...
    public void readStatFile() {
        if (this.statsFile.isFile()) {
            try {
                ...
                logger.error("Couldn't read statistics file " + (Object)this.statsFile, (Throwable)ioexception);
            }
            catch (JsonParseException jsonparseexception) {
                logger.error("Couldn't parse statistics file " + (Object)this.statsFile, (Throwable)jsonparseexception);
            }
        }
    }
    ...
    public Map<StatBase, TupleIntJsonSerializable> parseJson(String p_150881_1_) {
        ...
        for (Map.Entry entry : jsonobject.entrySet()) {
                ...
                if (((JsonElement)entry.getValue()).isJsonPrimitive() && ((JsonElement)entry.getValue()).getAsJsonPrimitive().isNumber()) {
                    ...
                    if (jsonobject1.has("progress") && statbase.func_150954_l() != null) {
                        try {
                            ...
                            logger.warn("Invalid statistic progress in " + (Object)this.statsFile, throwable);
                        }
                    }
                }
            ...
            logger.warn("Invalid statistic in " + (Object)this.statsFile + ": Don't know what " + (String)entry.getKey() + " is");
        }
        return map;
    }
    ...
    public void func_150876_a(EntityPlayerMP p_150876_1_) {
        ...
        p_150876_1_.playerNetServerHandler.sendPacket(new S37PacketStatistics((Map<StatBase, Integer>)map));
    }
    ...
    public void sendAchievements(EntityPlayerMP player) {
        ...
        for (Achievement achievement : AchievementList.achievementList) {
            ...
            map.put((Object)achievement, (Object)this.readStat(achievement));
            this.field_150888_e.remove((Object)achievement);
        }
        player.playerNetServerHandler.sendPacket(new S37PacketStatistics((Map<StatBase, Integer>)map));
    }
