...
public class WorldInfo {
    ...
    public void addToCrashReport(CrashReportCategory category) {
        ...
        category.addCrashSectionCallable("Level generator", new Callable<String>(){
            ...
            public String call() throws Exception {
                return String.format((String)"ID %02d - %s, ver %d. Features enabled: %b", (Object[])new Object[]{WorldInfo.this.terrainType.getWorldTypeID(), WorldInfo.this.terrainType.getWorldTypeName(), WorldInfo.this.terrainType.getGeneratorVersion(), WorldInfo.this.mapFeaturesEnabled});
            }
        });
        ...
        category.addCrashSectionCallable("Level time", new Callable<String>(){
            ...
            public String call() throws Exception {
                return String.format((String)"%d game time, %d day time", (Object[])new Object[]{WorldInfo.this.totalTime, WorldInfo.this.worldTime});
            }
        });
        category.addCrashSectionCallable("Level dimension", new Callable<String>(){

            public String call() throws Exception {
                return String.valueOf((int)WorldInfo.this.dimension);
            }
        });
        category.addCrashSectionCallable("Level storage version", new Callable<String>(){
            ...
            public String call() throws Exception {
                ...
                return String.format((String)"0x%05X - %s", (Object[])new Object[]{WorldInfo.this.saveVersion, s});
            }
        });
        category.addCrashSectionCallable("Level weather", new Callable<String>(){

            public String call() throws Exception {
                return String.format((String)"Rain time: %d (now: %b), thunder time: %d (now: %b)", (Object[])new Object[]{WorldInfo.this.rainTime, WorldInfo.this.raining, WorldInfo.this.thunderTime, WorldInfo.this.thundering});
            }
        });
        category.addCrashSectionCallable("Level game mode", new Callable<String>(){

            public String call() throws Exception {
                return String.format((String)"Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", (Object[])new Object[]{WorldInfo.this.theGameType.getName(), WorldInfo.this.theGameType.getID(), WorldInfo.this.hardcore, WorldInfo.this.allowCommands});
            }
        });
    }
