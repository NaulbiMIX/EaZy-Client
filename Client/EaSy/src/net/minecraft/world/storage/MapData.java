    ...
    public class MapInfo {
        ...
        public Packet getPacket(ItemStack stack) {
            if (this.field_176105_d) {
                ...
                return new S34PacketMaps(stack.getMetadata(), MapData.this.scale, (Collection<Vec4b>)MapData.this.mapDecorations.values(), MapData.this.colors, this.minX, this.minY, this.maxX + 1 - this.minX, this.maxY + 1 - this.minY);
            }
            return this.field_176109_i++ % 5 == 0 ? new S34PacketMaps(stack.getMetadata(), MapData.this.scale, (Collection<Vec4b>)MapData.this.mapDecorations.values(), MapData.this.colors, 0, 0, 0, 0) : null;
        }
