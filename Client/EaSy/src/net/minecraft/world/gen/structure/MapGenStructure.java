...
extends MapGenBase {
    ...
    protected final void recursiveGenerate(World worldIn, final int chunkX, final int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
        ...
        if (!this.structureMap.containsKey((Object)ChunkCoordIntPair.chunkXZ2Int(chunkX, chunkZ))) {
            this.rand.nextInt();
            try {
                if (this.canSpawnStructureAtCoords(chunkX, chunkZ)) {
                    StructureStart structurestart = this.getStructureStart(chunkX, chunkZ);
                    this.structureMap.put((Object)ChunkCoordIntPair.chunkXZ2Int(chunkX, chunkZ), (Object)structurestart);
                ...
                crashreportcategory.addCrashSection("Chunk location", String.format((String)"%d,%d", (Object[])new Object[]{chunkX, chunkZ}));
                crashreportcategory.addCrashSectionCallable("Chunk pos hash", new Callable<String>(){

                    public String call() throws Exception {
                        return String.valueOf((long)ChunkCoordIntPair.chunkXZ2Int(chunkX, chunkZ));
                    }
                });
    ...
    public BlockPos getClosestStrongholdPos(World worldIn, BlockPos pos) {
        ...
        for (StructureStart structurestart : this.structureMap.values()) {
            ...
            double d1;
            BlockPos blockpos1;
            if (!structurestart.isSizeableStructure() || !((d1 = (blockpos1 = ((StructureComponent)(structurecomponent = (StructureComponent)structurestart.getComponents().get(0))).getBoundingBoxCenter()).distanceSq(pos)) < d0)) continue;
            d0 = d1;
            blockpos = blockpos1;
        }
        if (blockpos != null) {
        ...
        if (this.structureData == null) {
            ...
            if (this.structureData == null) {
                ...
                for (String s : nbttagcompound.getKeySet()) {
                    ...
                    this.structureMap.put((Object)ChunkCoordIntPair.chunkXZ2Int(i, j), (Object)structurestart);
                }
            }
        }
    }
