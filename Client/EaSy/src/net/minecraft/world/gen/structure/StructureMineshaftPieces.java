...
public class StructureMineshaftPieces {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            if (this.coordBaseMode != null) {
                switch (this.coordBaseMode) {
                    case NORTH: {
                        StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        break;
                    }
                    case SOUTH: {
                        StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        break;
                    }
                    case WEST: {
                        StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, i);
                        break;
                    }
                    case EAST: {
                        StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, i);
                    }
                }
            }
        }
    ...
    extends StructureComponent {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            while (k < this.boundingBox.getXSize() && (k += rand.nextInt(this.boundingBox.getXSize())) + 3 <= this.boundingBox.getXSize()) {
                StructureComponent structurecomponent = StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                if (structurecomponent != null) {
            ...
            k = 0;
            while (k < this.boundingBox.getXSize() && (k += rand.nextInt(this.boundingBox.getXSize())) + 3 <= this.boundingBox.getXSize()) {
                StructureComponent structurecomponent1 = StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
            ...
            k = 0;
            while (k < this.boundingBox.getZSize() && (k += rand.nextInt(this.boundingBox.getZSize())) + 3 <= this.boundingBox.getZSize()) {
                StructureComponent structurecomponent2 = StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.WEST, i);
            ...
            k = 0;
            while (k < this.boundingBox.getZSize() && (k += rand.nextInt(this.boundingBox.getZSize())) + 3 <= this.boundingBox.getZSize()) {
                StructureComponent structurecomponent3 = StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.EAST, i);
    ...
    extends StructureComponent {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            switch (this.corridorDirection) {
                case NORTH: {
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
                }
                case SOUTH: {
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
                }
            ...
            if (this.isMultipleFloors) {
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                }
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                }
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                }
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                }
            }
        }
    ...
    extends StructureComponent {
        ...
        public static StructureBoundingBox func_175814_a(List<StructureComponent> p_175814_0_, Random rand, int x, int y, int z, EnumFacing facing) {
            int i;
            StructureBoundingBox structureboundingbox = new StructureBoundingBox(x, y, z, x, y + 2, z);
            for (i = rand.nextInt((int)3) + 2; i > 0; --i) {
                int j = i * 5;
                switch (facing) {
                    case NORTH: {
                        structureboundingbox.maxX = x + 2;
            ...
            block25 : {
                ...
                if (this.coordBaseMode != null) {
                    switch (this.coordBaseMode) {
                        case NORTH: {
                            if (j <= 1) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, this.coordBaseMode, i);
                                break;
                            }
                            if (j == 2) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.WEST, i);
                                break;
                            }
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.EAST, i);
                            break;
                        }
                        case SOUTH: {
                            if (j <= 1) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, this.coordBaseMode, i);
                                break;
                            }
                            if (j == 2) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.WEST, i);
                                break;
                            }
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.EAST, i);
                            break;
                        }
                        case WEST: {
                            if (j <= 1) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i);
                                break;
                            }
                            if (j == 2) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                                break;
                            }
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                            break;
                        }
                        case EAST: {
                            if (j <= 1) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i);
                                break;
                            }
                            if (j == 2) {
                                StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                                break;
                            }
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        }
                    }
                }
                ...
                if (this.coordBaseMode != EnumFacing.NORTH && this.coordBaseMode != EnumFacing.SOUTH) {
                    ...
                    while (i1 + 3 <= this.boundingBox.maxX) {
                        ...
                        if (j1 == 0) {
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, i1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                        } else if (j1 == 1) {
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, i1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                        }
                        i1 += 5;
                    }
                } else {
                    ...
                    while (k + 3 <= this.boundingBox.maxZ) {
                        ...
                        if (l == 0) {
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, k, EnumFacing.WEST, i + 1);
                        } else if (l == 1) {
                            StructureMineshaftPieces.func_175890_b(componentIn, (List<StructureComponent>)listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, k, EnumFacing.EAST, i + 1);
                        }
                        k += 5;
                    }
                }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int j1 = 0; j1 < this.sectionCount; ++j1) {
                ...
                if (randomIn.nextInt(100) == 0) {
                    this.generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 2, 0, k1 - 1, WeightedRandomChestContent.func_177629_a((List<WeightedRandomChestContent>)CHEST_CONTENT_WEIGHT_LIST, Items.enchanted_book.getRandom(randomIn)), 3 + randomIn.nextInt(4));
                }
                if (randomIn.nextInt(100) == 0) {
                    this.generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 0, 0, k1 + 1, WeightedRandomChestContent.func_177629_a((List<WeightedRandomChestContent>)CHEST_CONTENT_WEIGHT_LIST, Items.enchanted_book.getRandom(randomIn)), 3 + randomIn.nextInt(4));
                }
