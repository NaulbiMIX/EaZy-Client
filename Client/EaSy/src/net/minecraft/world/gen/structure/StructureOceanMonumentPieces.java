...
public class StructureOceanMonumentPieces {
    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            this.field_175843_q.add((Object)new EntryRoom(this.coordBaseMode, this.field_175845_o));
            this.field_175843_q.add((Object)new MonumentCoreRoom(this.coordBaseMode, this.field_175844_p, p_i45599_1_));
            ArrayList list1 = Lists.newArrayList();
            list1.add((Object)new XYDoubleRoomFitHelper());
            list1.add((Object)new YZDoubleRoomFitHelper());
            list1.add((Object)new ZDoubleRoomFitHelper());
            list1.add((Object)new XDoubleRoomFitHelper());
            list1.add((Object)new YDoubleRoomFitHelper());
            list1.add((Object)new FitSimpleRoomTopHelper());
            list1.add((Object)new FitSimpleRoomHelper());
            ...
            this.field_175843_q.add((Object)new WingRoom(this.coordBaseMode, structureboundingbox1, i++));
            this.field_175843_q.add((Object)new WingRoom(this.coordBaseMode, structureboundingbox2, i++));
            this.field_175843_q.add((Object)new Penthouse(this.coordBaseMode, structureboundingbox));
        }
        ...
        private List<RoomDefinition> func_175836_a(Random p_175836_1_) {
            ...
            for (RoomDefinition structureoceanmonumentpieces$roomdefinition4 : astructureoceanmonumentpieces$roomdefinition) {
                ...
                list.add((Object)structureoceanmonumentpieces$roomdefinition4);
            }
