    ...
    public void dropChunk(int x, int z) {
        if (this.worldObj.provider.canRespawnHere()) {
            if (!this.worldObj.isSpawnChunk(x, z)) {
                this.droppedChunksSet.add((Object)ChunkCoordIntPair.chunkXZ2Int(x, z));
            }
        } else {
            this.droppedChunksSet.add((Object)ChunkCoordIntPair.chunkXZ2Int(x, z));
        }
            ...
            if (chunk == null) {
                if (this.serverChunkGenerator == null) {
                    ...
                    try {
                        ...
                        crashreportcategory.addCrashSection("Location", String.format((String)"%d,%d", (Object[])new Object[]{chunkX, chunkZ}));
    ...
    private void saveChunkData(Chunk chunkIn) {
        if (this.chunkLoader != null) {
            try {
                ...
                logger.error("Couldn't save chunk; already in use by another instance of Minecraft?", (Throwable)((Object)minecraftexception));
            }
        }
    }
