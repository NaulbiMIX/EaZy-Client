    ...
    public ChunkProviderFlat(World worldIn, long seed, boolean generateStructures, String flatGeneratorSettings) {
        ...
        if (generateStructures) {
            ...
            if (map.containsKey((Object)"village")) {
                ...
                this.structureGenerators.add((Object)new MapGenVillage((Map<String, String>)map1));
            }
            if (map.containsKey((Object)"biome_1")) {
                this.structureGenerators.add((Object)new MapGenScatteredFeature((Map<String, String>)((Map)map.get((Object)"biome_1"))));
            }
            if (map.containsKey((Object)"mineshaft")) {
                this.structureGenerators.add((Object)new MapGenMineshaft((Map<String, String>)((Map)map.get((Object)"mineshaft"))));
            }
            if (map.containsKey((Object)"stronghold")) {
                this.structureGenerators.add((Object)new MapGenStronghold((Map<String, String>)((Map)map.get((Object)"stronghold"))));
            }
            if (map.containsKey((Object)"oceanmonument")) {
                this.structureGenerators.add((Object)new StructureOceanMonument((Map<String, String>)((Map)map.get((Object)"oceanmonument"))));
            }
        }
