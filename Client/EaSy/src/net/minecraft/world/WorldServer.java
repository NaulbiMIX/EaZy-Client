...
implements IThreadListener {
    ...
    public Explosion newExplosion(Entity entityIn, double x, double y, double z, float strength, boolean isFlaming, boolean isSmoking) {
        ...
        for (EntityPlayer entityplayer : this.playerEntities) {
            ...
            ((EntityPlayerMP)entityplayer).playerNetServerHandler.sendPacket(new S27PacketExplosion(x, y, z, strength, explosion.getAffectedBlockPositions(), (Vec3)explosion.getPlayerKnockbackMap().get((Object)entityplayer)));
        }
        return explosion;
    }
    ...
    public void addBlockEvent(BlockPos pos, Block blockIn, int eventID, int eventParam) {
        ...
        this.blockEventQueue[this.blockEventCacheIndex].add((Object)blockeventdata);
    }
    ...
    public /* varargs */ void spawnParticle(EnumParticleTypes particleType, double xCoord, double yCoord, double zCoord, int numberOfParticles, double xOffset, double yOffset, double zOffset, double particleSpeed, int ... particleArguments) {
    ...
    public /* varargs */ void spawnParticle(EnumParticleTypes particleType, boolean longDistance, double xCoord, double yCoord, double zCoord, int numberOfParticles, double xOffset, double yOffset, double zOffset, double particleSpeed, int ... particleArguments) {
