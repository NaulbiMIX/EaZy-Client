...
implements IBlockAccess {
        ...
        if (!this.isRemote) {
            ...
            try {
                ...
                crashreportcategory.addCrashSectionCallable("Source block type", new Callable<String>(){
                    ...
                    public String call() throws Exception {
                        try {
                            return String.format((String)"ID #%d (%s // %s)", (Object[])new Object[]{Block.getIdFromBlock(blockIn), blockIn.getUnlocalizedName(), blockIn.getClass().getCanonicalName()});
                        }
    ...
    public BlockPos getHeight(BlockPos pos) {
        int i = pos.getX() >= -30000000 && pos.getZ() >= -30000000 && pos.getX() < 30000000 && pos.getZ() < 30000000 ? (this.isChunkLoaded(pos.getX() >> 4, pos.getZ() >> 4, true) ? this.getChunkFromChunkCoords(pos.getX() >> 4, pos.getZ() >> 4).getHeightValue(pos.getX() & 15, pos.getZ() & 15) : 0) : this.getSeaLevel() + 1;
    ...
    public /* varargs */ void spawnParticle(EnumParticleTypes particleType, double xCoord, double yCoord, double zCoord, double xOffset, double yOffset, double zOffset, int ... p_175688_14_) {
    ...
    public /* varargs */ void spawnParticle(EnumParticleTypes particleType, boolean p_175682_2_, double xCoord, double yCoord, double zCoord, double xOffset, double yOffset, double zOffset, int ... p_175682_15_) {
    ...
    private /* varargs */ void spawnParticle(int particleID, boolean p_175720_2_, double xCood, double yCoord, double zCoord, double xOffset, double yOffset, double zOffset, int ... p_175720_15_) {
        for (int i = 0; i < this.worldAccesses.size(); ++i) {
        ...
        for (int k1 = i; k1 < j; ++k1) {
            for (int l1 = i1; l1 < j1; ++l1) {
                ...
                for (int i2 = k - 1; i2 < l; ++i2) {
                    ...
                    iblockstate1.getBlock().addCollisionBoxesToList(this, blockpos$mutableblockpos, iblockstate1, bb, (List<AxisAlignedBB>)list, entityIn);
                }
            }
        }
        double d0 = 0.25;
        ...
        for (int k1 = i; k1 < j; ++k1) {
            for (int l1 = i1; l1 < j1; ++l1) {
                ...
                for (int i2 = k - 1; i2 < l; ++i2) {
                    ...
                    iblockstate.getBlock().addCollisionBoxesToList(this, blockpos$mutableblockpos, iblockstate, bb, (List<AxisAlignedBB>)list, null);
                }
            }
        }
        return list;
        ...
        if (l > k) {
            ...
            while (i < j) {
                ...
                for (EnumFacing enumfacing : EnumFacing.values()) {
                    ...
                    int l4 = Math.max((int)1, (int)this.getBlockState(blockpos$mutableblockpos).getBlock().getLightOpacity());
    ...
    public List<Entity> getEntitiesInAABBexcluding(Entity entityIn, AxisAlignedBB boundingBox, Predicate<? super Entity> predicate) {
        ...
        for (int i1 = i; i1 <= j; ++i1) {
            for (int j1 = k; j1 <= l; ++j1) {
                ...
                this.getChunkFromChunkCoords(i1, j1).getEntitiesWithinAABBForEntity(entityIn, boundingBox, (List<Entity>)list, predicate);
            }
        }
        return list;
    }
    ...
    public <T extends Entity> T findNearestEntityWithinAABB(Class<? extends T> entityType, AxisAlignedBB aabb, T closestTo) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (t1 == closestTo || !EntitySelectors.NOT_SPECTATING.apply((Object)t1) || (d1 = ((Entity)closestTo).getDistanceSqToEntity(t1)) > d0) continue;
            t = t1;
            d0 = d1;
        }
        return (T)t;
