...
extends SaveFormatOld {
    ...
    public boolean convertMapFormat(String filename, IProgressUpdate progressCallback) {
        ...
        this.convertFile(new File(file1, "region"), (Iterable<File>)list, worldchunkmanager, 0, i, progressCallback);
        this.convertFile(new File(file2, "region"), (Iterable<File>)list1, new WorldChunkManagerHell(BiomeGenBase.hell, 0.0f), list.size(), i, progressCallback);
        this.convertFile(new File(file3, "region"), (Iterable<File>)list2, new WorldChunkManagerHell(BiomeGenBase.sky, 0.0f), list.size() + list1.size(), i, progressCallback);
    ...
    private void addRegionFilesToCollection(File worldDir, Collection<File> collection) {
        ...
        Object[] afile = file1.listFiles(new FilenameFilter(){
