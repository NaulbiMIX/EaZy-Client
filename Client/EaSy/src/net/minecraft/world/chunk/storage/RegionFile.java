...
public class RegionFile {
    ...
    public RegionFile(File fileNameIn) {
        ...
        try {
            ...
            if ((this.dataFile.length() & 4095L) != 0L) {
                int j1 = 0;
                while ((long)j1 < (this.dataFile.length() & 4095L)) {
            ...
            for (int l1 = 0; l1 < 1024; ++l1) {
                ...
                if (k == 0 || (k >> 8) + (k & 255) > this.sectorFree.size()) continue;
    ...
    public DataOutputStream getChunkDataOutputStream(int x, int z) {
        return this.outOfBounds(x, z) ? null : new DataOutputStream((OutputStream)new DeflaterOutputStream((OutputStream)new ChunkBuffer(x, z)));
    }
