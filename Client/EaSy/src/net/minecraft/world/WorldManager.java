...
implements IWorldAccess {
    ...
    @Override
    public /* varargs */ void spawnParticle(int particleID, boolean ignoreRange, double xCoord, double yCoord, double zCoord, double xOffset, double yOffset, double zOffset, int ... parameters) {
    }
