...
IPlayerUsage {
    ...
    public void run() {
        ...
        try {
            ...
            this.freeMemory();
            logger.fatal("Reported exception thrown!", (Throwable)((Object)reportedexception));
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        AchievementList.openInventory.setStatStringFormatter(new IStatStringFormat(){
            ...
            public String formatString(String str) {
                try {
                    return String.format((String)str, (Object[])new Object[]{GameSettings.getKeyDisplayString(Minecraft.this.gameSettings.keyBindInventory.getKeyCode())});
                }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle((String)EaSyClient.INSTANCE.getDisplayTitle());
        try {
    ...
    public void displayCrashReport(CrashReport crashReportIn) {
        ...
        if (crashReportIn.getFile() != null) {
            Bootstrap.printToSYSOUT("#@!@# Game crashed! Crash report saved to: #@!@# " + (Object)crashReportIn.getFile());
            System.exit((int)-1);
    ...
    public void refreshResources() {
        ...
        try {
            this.mcResourceManager.reloadResources((List<IResourcePack>)list);
        }
        catch (RuntimeException runtimeexception) {
            logger.info("Caught error stitching, removing all assigned resourcepacks", (Throwable)runtimeexception);
            list.clear();
            list.addAll(this.defaultResourcePacks);
            this.mcResourcePackRepository.setRepositories((List<ResourcePackRepository.Entry>)Collections.emptyList());
            this.mcResourceManager.reloadResources((List<IResourcePack>)list);
            this.gameSettings.resourcePacks.clear();
            this.gameSettings.incompatibleResourcePacks.clear();
            this.gameSettings.saveOptions();
        }
        this.mcLanguageManager.parseLanguageMetadata((List<IResourcePack>)list);
    ...
    private void runGameLoop() throws IOException {
        ...
        while (Minecraft.getSystemTime() >= this.debugUpdateTime + 1000L) {
            ...
            arrobject[3] = (float)this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf" : Integer.valueOf((int)this.gameSettings.limitFramerate);
            ...
            this.debug = String.format((String)"%d fps (%d chunk update%s) T: %s%s%s%s%s", (Object[])arrobject);
        ...
        if (this.mcProfiler.profilingEnabled) {
            ...
            for (int l = 0; l < list.size(); ++l) {
                ...
                for (int j2 = i1; j2 >= 0; --j2) {
                    float f = (float)((d0 + profiler$result1.field_76332_a * (double)j2 / (double)i1) * 3.1415927410125732 * 2.0 / 100.0);
                ...
                for (int i3 = i1; i3 >= 0; --i3) {
                    float f3 = (float)((d0 + profiler$result1.field_76332_a * (double)i3 / (double)i1) * 3.1415927410125732 * 2.0 / 100.0);
        ...
        theCrash.getCategory().addCrashSectionCallable("Resource Packs", new Callable<String>(){
            ...
            public String call() throws Exception {
                ...
                for (String s : Minecraft.this.gameSettings.resourcePacks) {
                    ...
                    if (!Minecraft.this.gameSettings.incompatibleResourcePacks.contains((Object)s)) continue;
    ...
    public void dispatchKeypresses() {
        ...
        if (!(i == 0 || Keyboard.isRepeatEvent() || this.currentScreen instanceof GuiControls && ((GuiControls)this.currentScreen).time > Minecraft.getSystemTime() - 20L)) {
            if (Keyboard.getEventKeyState()) {
                if (i != this.gameSettings.keyBindStreamStartStop.getKeyCode() && i != this.gameSettings.keyBindStreamPauseUnpause.getKeyCode() && i != this.gameSettings.keyBindStreamCommercials.getKeyCode() && i != this.gameSettings.keyBindStreamToggleMic.getKeyCode()) {
