...
public class EffectRenderer {
    ...
    public /* varargs */ EntityFX spawnEffectParticle(int particleId, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int ... parameters) {
        EntityFX entityfx;
    ...
    public void addBlockDestroyEffects(BlockPos pos, IBlockState state) {
        ...
        if (Reflector.ForgeBlock_addDestroyEffects.exists() && Reflector.ForgeBlock_isAir.exists()) {
            ...
            if (Reflector.callBoolean(block, Reflector.ForgeBlock_isAir, this.worldObj, pos)) return;
