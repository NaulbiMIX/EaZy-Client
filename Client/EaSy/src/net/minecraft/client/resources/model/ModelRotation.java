...
ITransformation
{
    ...
    private ModelRotation(int p_i46087_3_, int p_i46087_4_) {
        ...
        org.lwjgl.util.vector.Matrix4f.rotate((float)((float)(-p_i46087_3_) * 0.017453292f), (Vector3f)new Vector3f(1.0f, 0.0f, 0.0f), (org.lwjgl.util.vector.Matrix4f)matrix4f, (org.lwjgl.util.vector.Matrix4f)matrix4f);
        ...
        org.lwjgl.util.vector.Matrix4f.rotate((float)((float)(-p_i46087_4_) * 0.017453292f), (Vector3f)new Vector3f(0.0f, 1.0f, 0.0f), (org.lwjgl.util.vector.Matrix4f)matrix4f1, (org.lwjgl.util.vector.Matrix4f)matrix4f1);
    ...
    public static ModelRotation getModelRotation(int p_177524_0_, int p_177524_1_) {
        return (ModelRotation)mapRotations.get((Object)ModelRotation.combineXY(MathHelper.normalizeAngle(p_177524_0_, 360), MathHelper.normalizeAngle(p_177524_1_, 360)));
    }
