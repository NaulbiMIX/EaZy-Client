...
public class ModelBakery {
    ...
    private void loadVariantItemModels() {
        ...
        this.variants.put((Object)MODEL_MISSING, (Object)new ModelBlockDefinition.Variants(MODEL_MISSING.getVariant(), (List<ModelBlockDefinition.Variant>)Lists.newArrayList((Object[])new ModelBlockDefinition.Variant[]{new ModelBlockDefinition.Variant(new ResourceLocation(MODEL_MISSING.getResourcePath()), ModelRotation.X0_Y0, false, 1)})));
            ...
            try {
                for (IResource iresource : this.resourceManager.getAllResources(resourcelocation)) {
                    ...
                    try {
                        ...
                        throw new RuntimeException("Encountered an exception when loading model definition of '" + p_177586_1_ + "' from: '" + iresource.getResourceLocation() + "' in resourcepack: '" + iresource.getResourcePackName() + "'", (Throwable)exception1);
                    }
                    finally {
    ...
    private void registerVariantNames() {
        ...
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.stone), (Object)Lists.newArrayList((Object[])new String[]{"stone", "granite", "granite_smooth", "diorite", "diorite_smooth", "andesite", "andesite_smooth"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.dirt), (Object)Lists.newArrayList((Object[])new String[]{"dirt", "coarse_dirt", "podzol"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.planks), (Object)Lists.newArrayList((Object[])new String[]{"oak_planks", "spruce_planks", "birch_planks", "jungle_planks", "acacia_planks", "dark_oak_planks"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.sapling), (Object)Lists.newArrayList((Object[])new String[]{"oak_sapling", "spruce_sapling", "birch_sapling", "jungle_sapling", "acacia_sapling", "dark_oak_sapling"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.sand), (Object)Lists.newArrayList((Object[])new String[]{"sand", "red_sand"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.log), (Object)Lists.newArrayList((Object[])new String[]{"oak_log", "spruce_log", "birch_log", "jungle_log"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.leaves), (Object)Lists.newArrayList((Object[])new String[]{"oak_leaves", "spruce_leaves", "birch_leaves", "jungle_leaves"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.sponge), (Object)Lists.newArrayList((Object[])new String[]{"sponge", "sponge_wet"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.sandstone), (Object)Lists.newArrayList((Object[])new String[]{"sandstone", "chiseled_sandstone", "smooth_sandstone"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.red_sandstone), (Object)Lists.newArrayList((Object[])new String[]{"red_sandstone", "chiseled_red_sandstone", "smooth_red_sandstone"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.tallgrass), (Object)Lists.newArrayList((Object[])new String[]{"dead_bush", "tall_grass", "fern"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.deadbush), (Object)Lists.newArrayList((Object[])new String[]{"dead_bush"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.wool), (Object)Lists.newArrayList((Object[])new String[]{"black_wool", "red_wool", "green_wool", "brown_wool", "blue_wool", "purple_wool", "cyan_wool", "silver_wool", "gray_wool", "pink_wool", "lime_wool", "yellow_wool", "light_blue_wool", "magenta_wool", "orange_wool", "white_wool"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.yellow_flower), (Object)Lists.newArrayList((Object[])new String[]{"dandelion"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.red_flower), (Object)Lists.newArrayList((Object[])new String[]{"poppy", "blue_orchid", "allium", "houstonia", "red_tulip", "orange_tulip", "white_tulip", "pink_tulip", "oxeye_daisy"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.stone_slab), (Object)Lists.newArrayList((Object[])new String[]{"stone_slab", "sandstone_slab", "cobblestone_slab", "brick_slab", "stone_brick_slab", "nether_brick_slab", "quartz_slab"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.stone_slab2), (Object)Lists.newArrayList((Object[])new String[]{"red_sandstone_slab"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.stained_glass), (Object)Lists.newArrayList((Object[])new String[]{"black_stained_glass", "red_stained_glass", "green_stained_glass", "brown_stained_glass", "blue_stained_glass", "purple_stained_glass", "cyan_stained_glass", "silver_stained_glass", "gray_stained_glass", "pink_stained_glass", "lime_stained_glass", "yellow_stained_glass", "light_blue_stained_glass", "magenta_stained_glass", "orange_stained_glass", "white_stained_glass"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.monster_egg), (Object)Lists.newArrayList((Object[])new String[]{"stone_monster_egg", "cobblestone_monster_egg", "stone_brick_monster_egg", "mossy_brick_monster_egg", "cracked_brick_monster_egg", "chiseled_brick_monster_egg"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.stonebrick), (Object)Lists.newArrayList((Object[])new String[]{"stonebrick", "mossy_stonebrick", "cracked_stonebrick", "chiseled_stonebrick"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.wooden_slab), (Object)Lists.newArrayList((Object[])new String[]{"oak_slab", "spruce_slab", "birch_slab", "jungle_slab", "acacia_slab", "dark_oak_slab"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.cobblestone_wall), (Object)Lists.newArrayList((Object[])new String[]{"cobblestone_wall", "mossy_cobblestone_wall"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.anvil), (Object)Lists.newArrayList((Object[])new String[]{"anvil_intact", "anvil_slightly_damaged", "anvil_very_damaged"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.quartz_block), (Object)Lists.newArrayList((Object[])new String[]{"quartz_block", "chiseled_quartz_block", "quartz_column"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.stained_hardened_clay), (Object)Lists.newArrayList((Object[])new String[]{"black_stained_hardened_clay", "red_stained_hardened_clay", "green_stained_hardened_clay", "brown_stained_hardened_clay", "blue_stained_hardened_clay", "purple_stained_hardened_clay", "cyan_stained_hardened_clay", "silver_stained_hardened_clay", "gray_stained_hardened_clay", "pink_stained_hardened_clay", "lime_stained_hardened_clay", "yellow_stained_hardened_clay", "light_blue_stained_hardened_clay", "magenta_stained_hardened_clay", "orange_stained_hardened_clay", "white_stained_hardened_clay"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.stained_glass_pane), (Object)Lists.newArrayList((Object[])new String[]{"black_stained_glass_pane", "red_stained_glass_pane", "green_stained_glass_pane", "brown_stained_glass_pane", "blue_stained_glass_pane", "purple_stained_glass_pane", "cyan_stained_glass_pane", "silver_stained_glass_pane", "gray_stained_glass_pane", "pink_stained_glass_pane", "lime_stained_glass_pane", "yellow_stained_glass_pane", "light_blue_stained_glass_pane", "magenta_stained_glass_pane", "orange_stained_glass_pane", "white_stained_glass_pane"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.leaves2), (Object)Lists.newArrayList((Object[])new String[]{"acacia_leaves", "dark_oak_leaves"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.log2), (Object)Lists.newArrayList((Object[])new String[]{"acacia_log", "dark_oak_log"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.prismarine), (Object)Lists.newArrayList((Object[])new String[]{"prismarine", "prismarine_bricks", "dark_prismarine"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.carpet), (Object)Lists.newArrayList((Object[])new String[]{"black_carpet", "red_carpet", "green_carpet", "brown_carpet", "blue_carpet", "purple_carpet", "cyan_carpet", "silver_carpet", "gray_carpet", "pink_carpet", "lime_carpet", "yellow_carpet", "light_blue_carpet", "magenta_carpet", "orange_carpet", "white_carpet"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.double_plant), (Object)Lists.newArrayList((Object[])new String[]{"sunflower", "syringa", "double_grass", "double_fern", "double_rose", "paeonia"}));
        ...
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.oak_fence_gate), (Object)Lists.newArrayList((Object[])new String[]{"oak_fence_gate"}));
        this.variantNames.put((Object)Item.getItemFromBlock(Blocks.oak_fence), (Object)Lists.newArrayList((Object[])new String[]{"oak_fence"}));
    ...
    private List<String> getVariantNames(Item p_177596_1_) {
        ...
        if (list == null) {
            list = Collections.singletonList((Object)Item.itemRegistry.getNameForObject(p_177596_1_).toString());
        }
        return list;
    }
    ...
    private Set<ResourceLocation> getVariantsTextureLocations() {
        ...
        Collections.sort((List)list, (Comparator)new Comparator<ModelResourceLocation>(){
        ...
        IIconCreator iiconcreator = new IIconCreator(){
            ...
            public void registerSprites(TextureMap iconRegistry) {
                for (ResourceLocation resourcelocation : set) {
                    ...
                    ModelBakery.this.sprites.put((Object)resourcelocation, (Object)textureatlassprite);
                }
            }
        };
    ...
    @Deprecated
    public static /* varargs */ void addVariantName(Item p_addVariantName_0_, String ... p_addVariantName_1_) {
    ...
    public static /* varargs */ <T extends ResourceLocation> void registerItemVariants(Item p_registerItemVariants_0_, T ... p_registerItemVariants_1_) {
        ...
        for (T resourcelocation : p_registerItemVariants_1_) {
            ((Set)customVariantNames.get((Object)registrydelegate)).add((Object)((ResourceLocation)resourcelocation).toString());
        }
    }
