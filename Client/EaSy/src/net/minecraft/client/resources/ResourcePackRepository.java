...
public class ResourcePackRepository {
    ...
    public ListenableFuture<Object> downloadResourcePack(String url, String hash) {
        ...
        try {
            ...
            if (file1.exists() && hash.length() == 40) {
                ...
                try {
                    logger.warn("File " + (Object)file1 + " had wrong hash (expected " + hash + ", found " + s1 + "). Deleting it.");
                    FileUtils.deleteQuietly((File)file1);
                }
                catch (IOException ioexception) {
                    logger.warn("File " + (Object)file1 + " couldn't be hashed. Deleting it.", (Throwable)ioexception);
                    FileUtils.deleteQuietly((File)file1);
                }
            }
    ...
    public class Entry {
        ...
        public boolean equals(Object p_equals_1_) {
            return this == p_equals_1_ ? true : (p_equals_1_ instanceof Entry ? this.toString().equals((Object)p_equals_1_.toString()) : false);
        }
