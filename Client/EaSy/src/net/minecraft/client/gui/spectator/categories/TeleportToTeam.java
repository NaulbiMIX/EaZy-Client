...
ISpectatorMenuObject {
    ...
    public TeleportToTeam() {
        ...
        for (ScorePlayerTeam scoreplayerteam : minecraft.theWorld.getScoreboard().getTeams()) {
            this.field_178672_a.add((Object)new TeamSelectionObject(scoreplayerteam));
        }
    }
    ...
    implements ISpectatorMenuObject {
        ...
        @Override
        public void func_178661_a(SpectatorMenu menu) {
            menu.func_178647_a(new TeleportToPlayer((Collection<NetworkPlayerInfo>)this.field_178675_d));
        }
