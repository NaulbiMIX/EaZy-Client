...
import de.flori2007.easyclient.gui.elements.ProtocolSelector;
...
implements GuiYesNoCallback {
    ...
    @Override
    public void initGui() {
        this.protocolSelector = new ProtocolSelector(5, 6);
    ...
    public void createButtons() {
        ...
        this.buttonList.add((Object)new GuiButton(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("selectServer.direct", new Object[0])));
        this.buttonList.add((Object)new GuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.add", new Object[0])));
        this.buttonList.add((Object)new GuiButton(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add((Object)new GuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiMultiplayer.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20, 16777215);
        this.protocolSelector.render();
        super.drawScreen(mouseX, mouseY, partialTicks);
        if (this.hoveringText != null) {
            this.drawHoveringText((List<String>)Lists.newArrayList((Iterable)Splitter.on((String)"\n").split((CharSequence)this.hoveringText)), mouseX, mouseY);
        }
    }
