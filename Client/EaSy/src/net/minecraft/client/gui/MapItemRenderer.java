...
public class MapItemRenderer {
    ...
    class Instance {
        ...
        private void render(boolean noOverlayRendering) {
            ...
            worldrenderer.pos((float)(i + 0) + f, (float)(j + 128) - f, -0.009999999776482582).tex(0.0, 1.0).endVertex();
            worldrenderer.pos((float)(i + 128) - f, (float)(j + 128) - f, -0.009999999776482582).tex(1.0, 1.0).endVertex();
            worldrenderer.pos((float)(i + 128) - f, (float)(j + 0) + f, -0.009999999776482582).tex(1.0, 0.0).endVertex();
            worldrenderer.pos((float)(i + 0) + f, (float)(j + 0) + f, -0.009999999776482582).tex(0.0, 0.0).endVertex();
            tessellator.draw();
