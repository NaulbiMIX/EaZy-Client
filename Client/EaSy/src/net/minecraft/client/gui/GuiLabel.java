...
extends Gui {
    ...
    public void func_175202_a(String p_175202_1_) {
        this.field_146173_k.add((Object)I18n.format(p_175202_1_, new Object[0]));
    }
    ...
    public void drawLabel(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            for (int k = 0; k < this.field_146173_k.size(); ++k) {
                if (this.centered) {
                    GuiLabel.drawCenteredString(this.fontRenderer, (String)this.field_146173_k.get(k), this.field_146162_g + this.field_146167_a / 2, j + k * 10, this.field_146168_n);
                    continue;
                }
