...
extends Gui {
    ...
    protected List<String> call() {
        ...
        if (this.isReducedDebug()) {
            return Lists.newArrayList((Object[])new String[]{"Minecraft 1.8.9 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities() + s1, this.mc.theWorld.getProviderName(), "", String.format((String)"Chunk-relative: %d %d %d", (Object[])new Object[]{blockpos.getX() & 15, blockpos.getY() & 15, blockpos.getZ() & 15})});
        }
    ...
    protected List<String> getDebugInfoRight() {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
            ...
            list.add((Object)"");
            list.add((Object)String.valueOf(Block.blockRegistry.getNameForObject(iblockstate.getBlock())));
