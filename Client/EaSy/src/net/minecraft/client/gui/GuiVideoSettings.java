...
extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new GuiOptionButton(231, i1, l, Lang.get("of.options.shaders")));
        i1 = this.width / 2 - 155 + 160;
        this.buttonList.add((Object)new GuiOptionButton(202, i1, l, Lang.get("of.options.quality")));
        i1 = this.width / 2 - 155 + 0;
        this.buttonList.add((Object)new GuiOptionButton(201, i1, l += 21, Lang.get("of.options.details")));
        i1 = this.width / 2 - 155 + 160;
        this.buttonList.add((Object)new GuiOptionButton(212, i1, l, Lang.get("of.options.performance")));
        i1 = this.width / 2 - 155 + 0;
        this.buttonList.add((Object)new GuiOptionButton(211, i1, l += 21, Lang.get("of.options.animations")));
        i1 = this.width / 2 - 155 + 160;
        this.buttonList.add((Object)new GuiOptionButton(222, i1, l, Lang.get("of.options.other")));
        l += 21;
        this.buttonList.add((Object)new GuiButton(200, this.width / 2 - 100, this.height / 6 + 168 + 11, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiVideoSettings.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 15, 16777215);
