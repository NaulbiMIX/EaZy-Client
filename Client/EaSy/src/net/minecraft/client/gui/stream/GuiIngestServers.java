...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new GuiButton(1, this.width / 2 - 155, this.height - 24 - 6, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add((Object)new GuiButton(2, this.width / 2 + 5, this.height - 24 - 6, 150, 20, I18n.format("options.stream.ingest.reset", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiIngestServers.drawCenteredString(this.fontRendererObj, this.field_152310_f, this.width / 2, 20, 16777215);
        super.drawScreen(mouseX, mouseY, partialTicks);
    }

    static /* synthetic */ FontRenderer access$200(GuiIngestServers x0) {
        return x0.fontRendererObj;
    }

    static /* synthetic */ FontRenderer access$700(GuiIngestServers x0) {
        return x0.fontRendererObj;
    }
    ...
    extends GuiSlot {
        ...
        protected boolean isSelected(int slotIndex) {
            return this.mc.getTwitchStream().func_152925_v()[slotIndex].serverUrl.equals((Object)this.mc.gameSettings.streamPreferredServer);
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.access$200((GuiIngestServers)GuiIngestServers.this).FONT_HEIGHT + 5 + 3, 3158064);
            ...
            if (s2 != null) {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s2, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s2), p_180791_3_ + 5 + 3 + GuiIngestServers.access$700((GuiIngestServers)GuiIngestServers.this).FONT_HEIGHT, 8421504);
            }
        }
