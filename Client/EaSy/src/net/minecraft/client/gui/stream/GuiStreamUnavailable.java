...
extends GuiScreen {
    ...
    public void initGui() {
        if (this.field_152323_r.isEmpty()) {
            ...
            if (this.field_152327_i != null) {
                this.field_152323_r.add((Object)"");
                for (ChatComponentTranslation chatcomponenttranslation : this.field_152327_i) {
                    this.field_152323_r.add((Object)chatcomponenttranslation.getUnformattedTextForChat());
                }
            }
        }
        if (this.field_152326_h.func_152559_b() != null) {
            this.buttonList.add((Object)new GuiButton(0, this.width / 2 - 155, this.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
            this.buttonList.add((Object)new GuiButton(1, this.width / 2 - 155 + 160, this.height - 50, 150, 20, I18n.format(this.field_152326_h.func_152559_b().getFormattedText(), new Object[0])));
        } else {
            this.buttonList.add((Object)new GuiButton(0, this.width / 2 - 75, this.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = Math.max((int)((int)((double)this.height * 0.85 / 2.0 - (double)((float)(this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT) / 2.0f))), (int)50);
        GuiStreamUnavailable.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), this.width / 2, i - this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        for (String s : this.field_152323_r) {
            GuiStreamUnavailable.drawCenteredString(this.fontRendererObj, s, this.width / 2, i, 10526880);
    ...
    public static void func_152321_a(GuiScreen p_152321_0_) {
        ...
        if (!OpenGlHelper.framebufferSupported) {
            ...
            list.add((Object)new ChatComponentTranslation("stream.unavailable.no_fbo.version", GL11.glGetString((int)7938)));
            list.add((Object)new ChatComponentTranslation("stream.unavailable.no_fbo.blend", GLContext.getCapabilities().GL_EXT_blend_func_separate));
            list.add((Object)new ChatComponentTranslation("stream.unavailable.no_fbo.arb", GLContext.getCapabilities().GL_ARB_framebuffer_object));
            list.add((Object)new ChatComponentTranslation("stream.unavailable.no_fbo.ext", GLContext.getCapabilities().GL_EXT_framebuffer_object));
            minecraft.displayGuiScreen(new GuiStreamUnavailable(p_152321_0_, Reason.NO_FBO, (List<ChatComponentTranslation>)list));
        } else if (istream instanceof NullStream) {
            if (((NullStream)istream).func_152937_a().getMessage().contains((CharSequence)"Can't load AMD 64-bit .dll on a IA 32-bit platform")) {
            ...
            List list1 = Arrays.asList((Object[])new ChatComponentTranslation[]{new ChatComponentTranslation("stream.unavailable.initialization_failure.extra", ErrorCode.getString((ErrorCode)istream.func_152912_E()))});
            minecraft.displayGuiScreen(new GuiStreamUnavailable(p_152321_0_, Reason.INITIALIZATION_FAILURE, (List<ChatComponentTranslation>)list1));
        } else {
