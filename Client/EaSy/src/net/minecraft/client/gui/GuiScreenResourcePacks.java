...
extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.buttonList.add((Object)new GuiOptionButton(2, this.width / 2 - 154, this.height - 48, I18n.format("resourcePack.openFolder", new Object[0])));
        this.buttonList.add((Object)new GuiOptionButton(1, this.width / 2 + 4, this.height - 48, I18n.format("gui.done", new Object[0])));
        if (!this.changed) {
        ...
        if (button.enabled) {
            if (button.id == 2) {
                ...
                if (this.changed) {
                    ...
                    this.mc.getResourcePackRepository().setRepositories((List<ResourcePackRepository.Entry>)list);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiScreenResourcePacks.drawCenteredString(this.fontRendererObj, I18n.format("resourcePack.title", new Object[0]), this.width / 2, 16, 16777215);
        GuiScreenResourcePacks.drawCenteredString(this.fontRendererObj, I18n.format("resourcePack.folderInfo", new Object[0]), this.width / 2 - 77, this.height - 26, 8421504);
