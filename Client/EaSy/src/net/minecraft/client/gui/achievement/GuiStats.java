...
implements IProgressMeter {
    ...
    public void createButtons() {
        this.buttonList.add((Object)new GuiButton(0, this.width / 2 + 4, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add((Object)new GuiButton(1, this.width / 2 - 160, this.height - 52, 80, 20, I18n.format("stat.generalButton", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            GuiStats.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, this.height / 2, 16777215);
            GuiStats.drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % (long)lanSearchStates.length)], this.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        } else {
            this.displaySlot.drawScreen(mouseX, mouseY, partialTicks);
            GuiStats.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 20, 16777215);
    ...
    extends GuiSlot {
        ...
        public StatsMobsList(Minecraft mcIn) {
            super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, GuiStats.access$1400((GuiStats)GuiStats.this).FONT_HEIGHT * 4);
        ...
        protected int getContentHeight() {
            return this.getSize() * GuiStats.access$1500((GuiStats)GuiStats.this).FONT_HEIGHT * 4;
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, p_180791_2_ + 2, p_180791_3_ + 1 + GuiStats.access$1800((GuiStats)GuiStats.this).FONT_HEIGHT, i == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 1 + GuiStats.access$2000((GuiStats)GuiStats.this).FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192);
        }
    }
    ...
    extends GuiSlot {
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            if (p_148213_1_ != null) {
                ...
                String s1 = ("" + I18n.format(new StringBuilder().append(s).append(".name").toString(), new Object[0])).trim();
                if (s1.length() > 0) {
