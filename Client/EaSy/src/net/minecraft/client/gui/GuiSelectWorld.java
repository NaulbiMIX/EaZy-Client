...
implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        try {
            ...
            logger.error("Couldn't load level list", (Throwable)((Object)anvilconverterexception));
    ...
    public void addWorldSelectionButtons() {
        ...
        this.buttonList.add((Object)new GuiButton(3, this.width / 2 + 4, this.height - 52, 150, 20, I18n.format("selectWorld.create", new Object[0])));
        ...
        this.buttonList.add((Object)new GuiButton(0, this.width / 2 + 82, this.height - 28, 72, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiSelectWorld.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 20, 16777215);
    ...
    extends GuiSlot {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            GuiSelectWorld.access$200((GuiSelectWorld)GuiSelectWorld.this).enabled = flag = GuiSelectWorld.this.selectedIndex >= 0 && GuiSelectWorld.this.selectedIndex < this.getSize();
