    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (l >= 0 && Enchantment.getEnchantmentById(l & 255) != null) {
                ...
                list.add((Object)(EnumChatFormatting.WHITE.toString() + EnumChatFormatting.ITALIC.toString() + I18n.format("container.enchant.clue", s)));
            }
            if (!flag) {
                if (l >= 0) {
                    list.add((Object)"");
            ...
            this.drawHoveringText((List<String>)list, mouseX, mouseY);
            break;
        }
    }
