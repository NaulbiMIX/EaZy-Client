...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new GuiButton(2, this.width / 2 + 2, this.height - 30, 150, 20, I18n.format("gui.done", new Object[0])));
        ...
        for (Map.Entry entry : new TreeMap(this.mc.getPlayerUsageSnooper().getCurrentStats()).entrySet()) {
            ...
            this.field_146609_h.add((Object)this.fontRendererObj.trimStringToWidth((String)entry.getValue(), this.width - 220));
        }
        if (flag) {
            for (Map.Entry entry1 : new TreeMap(this.mc.getIntegratedServer().getPlayerUsageSnooper().getCurrentStats()).entrySet()) {
                ...
                this.field_146609_h.add((Object)this.fontRendererObj.trimStringToWidth((String)entry1.getValue(), this.width - 220));
            }
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiSnooper.drawCenteredString(this.fontRendererObj, this.field_146610_i, this.width / 2, 8, 16777215);
        int i = 22;
        for (String s : this.field_146607_r) {
            GuiSnooper.drawCenteredString(this.fontRendererObj, s, this.width / 2, i, 8421504);
