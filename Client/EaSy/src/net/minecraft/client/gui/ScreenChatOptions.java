...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (GameSettings.Options gamesettings$options : field_146399_a) {
            if (gamesettings$options.getEnumFloat()) {
                ...
                this.buttonList.add((Object)new GuiOptionButton(gamesettings$options.returnEnumOrdinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options, this.game_settings.getKeyBinding(gamesettings$options)));
            }
            ++i;
        }
        this.buttonList.add((Object)new GuiButton(200, this.width / 2 - 100, this.height / 6 + 120, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        ScreenChatOptions.drawCenteredString(this.fontRendererObj, this.field_146401_i, this.width / 2, 20, 16777215);
