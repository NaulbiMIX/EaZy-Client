...
extends InventoryEffectRenderer {
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            ...
            if (slotIn == this.field_147064_C) {
                ...
                this.mc.thePlayer.inventoryContainer.slotClick(slotIn == null ? slotId : CreativeSlot.access$000((CreativeSlot)((CreativeSlot)slotIn)).slotNumber, clickedButton, clickType, this.mc.thePlayer);
    ...
    private void updateCreativeSearch() {
        ...
        while (iterator.hasNext()) {
            ...
            for (String s : itemstack.getTooltip(this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips)) {
                if (!EnumChatFormatting.getTextWithoutFormattingCodes(s).toLowerCase().contains((CharSequence)s1)) continue;
                flag = true;
                break;
            }
            if (flag) continue;
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_) {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory) {
            ...
            for (int j = 0; j < container.inventorySlots.size(); ++j) {
                CreativeSlot slot = new CreativeSlot((Slot)container.inventorySlots.get(j), j);
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            ...
            if (creativetabs != null) {
                list.add(1, (Object)("" + (Object)((Object)EnumChatFormatting.BOLD) + (Object)((Object)EnumChatFormatting.BLUE) + I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0])));
            }
            for (int i = 0; i < list.size(); ++i) {
                if (i == 0) {
                    list.set(i, (Object)((Object)((Object)stack.getRarity().rarityColor) + (String)list.get(i)));
                    continue;
                }
                list.set(i, (Object)((Object)((Object)EnumChatFormatting.GRAY) + (String)list.get(i)));
            }
    ...
    extends Slot {
        ...
        static /* synthetic */ Slot access$000(CreativeSlot x0) {
            return x0.slot;
        }
    }
