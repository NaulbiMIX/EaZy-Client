...
extends GuiContainer {
    ...
    public void initGui() {
        ...
        this.buttonList.add((Object)new CancelButton(-2, this.guiLeft + 190, this.guiTop + 107));
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        GuiBeacon.drawCenteredString(this.fontRendererObj, I18n.format("tile.beacon.primary", new Object[0]), 62, 10, 14737632);
        GuiBeacon.drawCenteredString(this.fontRendererObj, I18n.format("tile.beacon.secondary", new Object[0]), 169, 10, 14737632);
