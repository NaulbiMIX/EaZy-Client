...
extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.buttonList.add((Object)new GuiOptionButton(0, this.width / 2 - 155, this.height / 6 + 96, this.confirmButtonText));
        this.buttonList.add((Object)new GuiOptionButton(1, this.width / 2 - 155 + 160, this.height / 6 + 96, this.cancelButtonText));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiYesNo.drawCenteredString(this.fontRendererObj, this.messageLine1, this.width / 2, 70, 16777215);
        int i = 90;
        for (String s : this.field_175298_s) {
            GuiYesNo.drawCenteredString(this.fontRendererObj, s, this.width / 2, i, 16777215);
