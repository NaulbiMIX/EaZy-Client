...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.field_175386_A == null) {
                ...
                int k1 = Math.min((int)(128 / this.fontRendererObj.FONT_HEIGHT), (int)this.field_175386_A.size());
    ...
    public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_) {
        ...
        if (i >= 0 && j >= 0) {
            int k = Math.min((int)(128 / this.fontRendererObj.FONT_HEIGHT), (int)this.field_175386_A.size());
