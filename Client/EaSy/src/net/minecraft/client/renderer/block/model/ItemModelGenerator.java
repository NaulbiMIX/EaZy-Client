...
public class ItemModelGenerator {
    ...
    public ModelBlock makeItemModel(TextureMap textureMapIn, ModelBlock blockModel) {
        ...
        return new ModelBlock((List<BlockPart>)list, (Map<String, String>)map, false, false, blockModel.getAllTransforms());
    }

    private List<BlockPart> func_178394_a(int p_178394_1_, String p_178394_2_, TextureAtlasSprite p_178394_3_) {
        HashMap map = Maps.newHashMap();
        map.put((Object)EnumFacing.SOUTH, (Object)new BlockPartFace(null, p_178394_1_, p_178394_2_, new BlockFaceUV(new float[]{0.0f, 0.0f, 16.0f, 16.0f}, 0)));
        map.put((Object)EnumFacing.NORTH, (Object)new BlockPartFace(null, p_178394_1_, p_178394_2_, new BlockFaceUV(new float[]{16.0f, 0.0f, 0.0f, 16.0f}, 0)));
        ArrayList list = Lists.newArrayList();
        list.add((Object)new BlockPart(new Vector3f(0.0f, 0.0f, 7.5f), new Vector3f(16.0f, 16.0f, 8.5f), (Map<EnumFacing, BlockPartFace>)map, null, true));
    ...
    private List<BlockPart> func_178397_a(TextureAtlasSprite p_178397_1_, String p_178397_2_, int p_178397_3_) {
        ...
        for (Span itemmodelgenerator$span : this.func_178393_a(p_178397_1_)) {
            ...
            f5 = 16.0f - f5;
            HashMap map = Maps.newHashMap();
            map.put((Object)itemmodelgenerator$spanfacing.getFacing(), (Object)new BlockPartFace(null, p_178397_3_, p_178397_2_, new BlockFaceUV(new float[]{f6 *= f10, f8 *= f11, f7 *= f10, f9 *= f11}, 0)));
            switch (itemmodelgenerator$spanfacing) {
                case UP: {
                    list.add((Object)new BlockPart(new Vector3f(f2, f3, 7.5f), new Vector3f(f4, f3, 8.5f), (Map<EnumFacing, BlockPartFace>)map, null, true));
                    break;
                }
                case DOWN: {
                    list.add((Object)new BlockPart(new Vector3f(f2, f5, 7.5f), new Vector3f(f4, f5, 8.5f), (Map<EnumFacing, BlockPartFace>)map, null, true));
                    break;
                }
                case LEFT: {
                    list.add((Object)new BlockPart(new Vector3f(f2, f3, 7.5f), new Vector3f(f2, f5, 8.5f), (Map<EnumFacing, BlockPartFace>)map, null, true));
                    break;
                }
                case RIGHT: {
                    list.add((Object)new BlockPart(new Vector3f(f4, f3, 7.5f), new Vector3f(f4, f5, 8.5f), (Map<EnumFacing, BlockPartFace>)map, null, true));
                }
            }
        }
        return list;
