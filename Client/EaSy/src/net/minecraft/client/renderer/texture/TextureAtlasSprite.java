...
public class TextureAtlasSprite {
    ...
    public void initSprite(int inX, int inY, int originInX, int originInY, boolean rotatedIn) {
        ...
        float f = (float)(0.009999999776482582 / (double)inX);
        float f1 = (float)(0.009999999776482582 / (double)inY);
        ...
        if (i != (k = this.animationMetadata.getFrameIndex((this.frameCounter + 1) % (j = this.animationMetadata.getFrameCount() == 0 ? this.framesTextureData.size() : this.animationMetadata.getFrameCount()))) && k >= 0 && k < this.framesTextureData.size()) {
            ...
            for (int l = 0; l < aint.length; ++l) {
                ...
                for (int i1 = 0; i1 < aint[l].length; ++i1) {
                    int j1 = aint[l][i1];
                    int k1 = aint1[l][i1];
                    int l1 = (int)((double)((j1 & 16711680) >> 16) * d0 + (double)((k1 & 16711680) >> 16) * (1.0 - d0));
                    int i2 = (int)((double)((j1 & 65280) >> 8) * d0 + (double)((k1 & 65280) >> 8) * (1.0 - d0));
                    int j2 = (int)((double)(j1 & 255) * d0 + (double)(k1 & 255) * (1.0 - d0));
    ...
    public void loadSprite(BufferedImage[] images, AnimationMetadataSection meta) throws IOException {
        ...
        if (meta == null) {
            ...
            if (meta.getFrameCount() > 0) {
                ...
                this.animationMetadata = new AnimationMetadataSection((List<AnimationFrame>)list, this.width, this.height, meta.getFrameTime(), meta.isInterpolate());
            }
        }
    ...
    public void generateMipmaps(int level) {
        ...
        for (int i = 0; i < this.framesTextureData.size(); ++i) {
            ...
            try {
                list.add((Object)TextureUtil.generateMipmapData(level, this.width, aint));
                continue;
            }
