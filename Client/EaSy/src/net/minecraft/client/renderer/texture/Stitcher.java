...
public class Stitcher {
    ...
    public void doStitch() {
        Object[] astitcher$holder = (Holder[])this.setStitchHolders.toArray((Object[])new Holder[this.setStitchHolders.size()]);
    ...
    public List<TextureAtlasSprite> getStichSlots() {
        ...
        for (Slot stitcher$slot : this.stitchSlots) {
            stitcher$slot.getAllStitchSlots((List<Slot>)list);
        }
        ...
        public boolean addSlot(Holder holderIn) {
            ...
            if (i <= this.width && j <= this.height) {
                ...
                if (this.subSlots == null) {
                    ...
                    this.subSlots.add((Object)new Slot(this.originX, this.originY, i, j));
                    int k = this.width - i;
                    int l = this.height - j;
                    if (l > 0 && k > 0) {
                        int j1;
                        ...
                        if (i1 >= (j1 = Math.max((int)this.width, (int)l))) {
                            this.subSlots.add((Object)new Slot(this.originX, this.originY + j, i, l));
                            this.subSlots.add((Object)new Slot(this.originX + i, this.originY, k, this.height));
                        } else {
                            this.subSlots.add((Object)new Slot(this.originX + i, this.originY, k, j));
                            this.subSlots.add((Object)new Slot(this.originX, this.originY + j, this.width, l));
                        }
                    } else if (k == 0) {
                        this.subSlots.add((Object)new Slot(this.originX, this.originY + j, i, l));
                    } else if (l == 0) {
