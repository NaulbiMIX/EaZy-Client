    ...
    public void updateCompass(World worldIn, double p_94241_2_, double p_94241_4_, double p_94241_6_, boolean p_94241_8_, boolean p_94241_9_) {
        if (!this.framesTextureData.isEmpty()) {
            ...
            if (worldIn != null && !p_94241_8_) {
                ...
                d0 = -(((p_94241_6_ %= 360.0) - 90.0) * 3.141592653589793 / 180.0 - Math.atan2((double)d2, (double)d1));
                if (!worldIn.provider.isSurfaceWorld()) {
                    d0 = Math.random() * 3.1415927410125732 * 2.0;
                }
            }
            if (p_94241_9_) {
            ...
            int i = (int)((this.currentAngle / 6.283185307179586 + 1.0) * (double)this.framesTextureData.size()) % this.framesTextureData.size();
            while (i < 0) {
