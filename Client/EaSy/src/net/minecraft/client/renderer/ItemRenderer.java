    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
            ...
            if (iblockstate.getBlock().getRenderType() != -1) {
                ...
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay, new Object[]{this.mc.thePlayer, Float.valueOf((float)partialTicks), object, iblockstate, blockpos})) {
        ...
        if (!this.mc.thePlayer.isSpectator()) {
            if (this.mc.thePlayer.isInsideOfMaterial(Material.water)) {
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay, new Object[]{this.mc.thePlayer, Float.valueOf((float)partialTicks)})) {
                    this.renderWaterOverlayTexture(partialTicks);
                }
            }
            if (this.mc.thePlayer.isBurning()) {
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, new Object[]{this.mc.thePlayer, Float.valueOf((float)partialTicks)})) {
