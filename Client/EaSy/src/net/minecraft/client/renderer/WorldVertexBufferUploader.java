    ...
    public void draw(WorldRenderer p_181679_1_) {
        if (p_181679_1_.getVertexCount() > 0) {
            ...
            block12 : for (int j = 0; j < list.size(); ++j) {
                ...
                if (flag) {
                    Reflector.callVoid((Object)vertexformatelement$enumusage, Reflector.ForgeVertexFormatElementEnumUseage_preDraw, new Object[]{vertexformat, j, i, bytebuffer});
                    continue;
                }
            ...
            block13 : for (int j1 = 0; j1 < k1; ++j1) {
                ...
                if (flag1) {
                    Reflector.callVoid((Object)vertexformatelement$enumusage1, Reflector.ForgeVertexFormatElementEnumUseage_postDraw, new Object[]{vertexformat, j1, i, bytebuffer});
                    continue;
                }
