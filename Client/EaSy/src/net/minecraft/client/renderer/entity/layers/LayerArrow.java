    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        ...
        if (i > 0) {
            ...
            for (int j = 0; j < i; ++j) {
                ...
                entity.prevRotationYaw = entity.rotationYaw = (float)(Math.atan2((double)f, (double)f2) * 180.0 / 3.1415927410125732);
                entity.prevRotationPitch = entity.rotationPitch = (float)(Math.atan2((double)(f1 *= -1.0f), (double)f6) * 180.0 / 3.1415927410125732);
                double d0 = 0.0;
                double d1 = 0.0;
                double d2 = 0.0;
