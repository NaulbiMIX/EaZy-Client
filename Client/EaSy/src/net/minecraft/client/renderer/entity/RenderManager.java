...
public class RenderManager {
    ...
    public RenderManager(TextureManager renderEngineIn, RenderItem itemRendererIn) {
        ...
        this.entityRenderMap.put(EntityPig.class, (Object)new RenderPig(this, new ModelPig(), 0.7f));
        this.entityRenderMap.put(EntitySheep.class, (Object)new RenderSheep(this, new ModelSheep2(), 0.7f));
        this.entityRenderMap.put(EntityCow.class, (Object)new RenderCow(this, new ModelCow(), 0.7f));
        this.entityRenderMap.put(EntityMooshroom.class, (Object)new RenderMooshroom(this, new ModelCow(), 0.7f));
        this.entityRenderMap.put(EntityWolf.class, (Object)new RenderWolf(this, new ModelWolf(), 0.5f));
        this.entityRenderMap.put(EntityChicken.class, (Object)new RenderChicken(this, new ModelChicken(), 0.3f));
        this.entityRenderMap.put(EntityOcelot.class, (Object)new RenderOcelot(this, new ModelOcelot(), 0.4f));
        this.entityRenderMap.put(EntityRabbit.class, (Object)new RenderRabbit(this, new ModelRabbit(), 0.3f));
        ...
        this.entityRenderMap.put(EntitySlime.class, (Object)new RenderSlime(this, new ModelSlime(16), 0.25f));
        this.entityRenderMap.put(EntityMagmaCube.class, (Object)new RenderMagmaCube(this));
        this.entityRenderMap.put(EntityGiantZombie.class, (Object)new RenderGiantZombie(this, new ModelZombie(), 0.5f, 6.0f));
        this.entityRenderMap.put(EntityGhast.class, (Object)new RenderGhast(this));
        this.entityRenderMap.put(EntitySquid.class, (Object)new RenderSquid(this, new ModelSquid(), 0.7f));
    ...
    private void renderDebugBoundingBox(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (entityIn instanceof EntityLivingBase) {
            float f1 = 0.01f;
            RenderGlobal.drawOutlinedBoundingBox(new AxisAlignedBB(x - (double)f, y + (double)entityIn.getEyeHeight() - 0.009999999776482582, z - (double)f, x + (double)f, y + (double)entityIn.getEyeHeight() + 0.009999999776482582, z + (double)f), 255, 0, 0, 255);
        }
