...
implements LayerRenderer<EntityLivingBase> {
    ...
    private ResourceLocation getArmorResource(ItemArmor p_177178_1_, boolean p_177178_2_, String p_177178_3_) {
        ...
        arrobject[2] = p_177178_3_ == null ? "" : String.format((String)"_%s", (Object[])new Object[]{p_177178_3_});
        String s = String.format((String)"textures/models/armor/%s_layer_%d%s.png", (Object[])arrobject);
    ...
    public ResourceLocation getArmorResource(Entity p_getArmorResource_1_, ItemStack p_getArmorResource_2_, int p_getArmorResource_3_, String p_getArmorResource_4_) {
        ...
        arrobject[0] = s1;
        arrobject[1] = s;
        arrobject[2] = this.isSlotForLeggings(p_getArmorResource_3_) ? 2 : 1;
        arrobject[3] = p_getArmorResource_4_ == null ? "" : String.format((String)"_%s", (Object[])new Object[]{p_getArmorResource_4_});
        String s2 = String.format((String)"%s:textures/models/armor/%s_layer_%d%s.png", (Object[])arrobject);
        ...
        ResourceLocation resourcelocation = (ResourceLocation)ARMOR_TEXTURE_RES_MAP.get((Object)s2);
        if (resourcelocation == null) {
