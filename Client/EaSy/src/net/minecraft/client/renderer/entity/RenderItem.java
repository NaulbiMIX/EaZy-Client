...
implements IResourceManagerReloadListener {
        ...
        if (stack != null && stack.getItem() != null) {
            ...
            try {
                ...
                crashreportcategory.addCrashSectionCallable("Item Aux", new Callable<String>(){
                    ...
                    public String call() throws Exception {
                        return String.valueOf((int)stack.getMetadata());
                    }
                });
                ...
                crashreportcategory.addCrashSectionCallable("Item Foil", new Callable<String>(){
                    ...
                    public String call() throws Exception {
                        return String.valueOf((boolean)stack.hasEffect());
                    }
                });
        ...
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                if (text == null && stack.stackSize < 1) {
                    s = (Object)((Object)EnumChatFormatting.RED) + String.valueOf((int)stack.stackSize);
                }
                GlStateManager.disableLighting();
    ...
    public static void forgeHooksClient_putQuadColor(WorldRenderer p_forgeHooksClient_putQuadColor_0_, BakedQuad p_forgeHooksClient_putQuadColor_1_, int p_forgeHooksClient_putQuadColor_2_) {
        float f = p_forgeHooksClient_putQuadColor_2_ & 255;
        float f1 = p_forgeHooksClient_putQuadColor_2_ >>> 8 & 255;
        float f2 = p_forgeHooksClient_putQuadColor_2_ >>> 16 & 255;
        float f3 = p_forgeHooksClient_putQuadColor_2_ >>> 24 & 255;
