...
extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        block26 : {
            block25 : {
                if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()) break block25;
                if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, x, y, z)) break block26;
            }
    ...
    public void renderName(T entity, double x, double y, double z) {
        block9 : {
            block8 : {
                if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists()) break block8;
                if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, entity, this, x, y, z)) break block9;
            }
