...
public class BlockModelRenderer {
    ...
    static enum VertexTranslations {
        ...
        static /* synthetic */ int access$200(VertexTranslations x0) {
            return x0.field_178191_g;
        }

        static /* synthetic */ int access$300(VertexTranslations x0) {
            return x0.field_178200_h;
        }

        static /* synthetic */ int access$400(VertexTranslations x0) {
            return x0.field_178201_i;
        }

        static /* synthetic */ int access$500(VertexTranslations x0) {
    ...
    public static class AmbientOcclusionFace {
        ...
        public void setMaxBlockLight() {
            int i = 240;
            int[] arrn = this.vertexBrightness;
            arrn[0] = arrn[0] | i;
            int[] arrn2 = this.vertexBrightness;
            arrn2[1] = arrn2[1] | i;
            int[] arrn3 = this.vertexBrightness;
            arrn3[2] = arrn3[2] | i;
            int[] arrn4 = this.vertexBrightness;
            arrn4[3] = arrn4[3] | i;
        ...
        public void updateVertexBrightness(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags) {
            ...
            if (boundsFlags.get(1) && blockmodelrenderer$enumneighborinfo.field_178289_i) {
                ...
                this.vertexColorMultiplier[VertexTranslations.access$200((VertexTranslations)blockmodelrenderer$vertextranslations)] = f29 * f10 + f30 * f11 + f31 * f12 + f32 * f13;
                this.vertexColorMultiplier[VertexTranslations.access$300((VertexTranslations)blockmodelrenderer$vertextranslations)] = f29 * f14 + f30 * f15 + f31 * f16 + f32 * f17;
                this.vertexColorMultiplier[VertexTranslations.access$400((VertexTranslations)blockmodelrenderer$vertextranslations)] = f29 * f18 + f30 * f19 + f31 * f20 + f32 * f21;
                this.vertexColorMultiplier[VertexTranslations.access$500((VertexTranslations)blockmodelrenderer$vertextranslations)] = f29 * f22 + f30 * f23 + f31 * f24 + f32 * f25;
                ...
                this.vertexBrightness[VertexTranslations.access$200((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getVertexBrightness(i2, j2, k2, l2, f10, f11, f12, f13);
                this.vertexBrightness[VertexTranslations.access$300((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getVertexBrightness(i2, j2, k2, l2, f14, f15, f16, f17);
                this.vertexBrightness[VertexTranslations.access$400((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getVertexBrightness(i2, j2, k2, l2, f18, f19, f20, f21);
                this.vertexBrightness[VertexTranslations.access$500((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getVertexBrightness(i2, j2, k2, l2, f22, f23, f24, f25);
            } else {
                float f6 = (f3 + f + f26 + f5) * 0.25f;
                float f7 = (f2 + f + f4 + f5) * 0.25f;
                float f8 = (f2 + f1 + f27 + f5) * 0.25f;
                float f9 = (f3 + f1 + f28 + f5) * 0.25f;
                this.vertexBrightness[VertexTranslations.access$200((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getAoBrightness(l, i, j1, i3);
                this.vertexBrightness[VertexTranslations.access$300((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getAoBrightness(k, i, i1, i3);
                this.vertexBrightness[VertexTranslations.access$400((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getAoBrightness(k, j, k1, i3);
                this.vertexBrightness[VertexTranslations.access$500((VertexTranslations)blockmodelrenderer$vertextranslations)] = this.getAoBrightness(l, j, l1, i3);
                this.vertexColorMultiplier[VertexTranslations.access$200((VertexTranslations)blockmodelrenderer$vertextranslations)] = f6;
                this.vertexColorMultiplier[VertexTranslations.access$300((VertexTranslations)blockmodelrenderer$vertextranslations)] = f7;
                this.vertexColorMultiplier[VertexTranslations.access$400((VertexTranslations)blockmodelrenderer$vertextranslations)] = f8;
                this.vertexColorMultiplier[VertexTranslations.access$500((VertexTranslations)blockmodelrenderer$vertextranslations)] = f9;
            }
        }
