...
public class BlockModelShapes {
    ...
    public /* varargs */ void registerBuiltInBlocks(Block ... builtIns) {
    ...
    private void registerAllBlocks() {
        ...
        this.registerBlockWithStateMapper(Blocks.pumpkin_stem, new StateMapperBase(){
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
                ...
                return new ModelResourceLocation((ResourceLocation)Block.blockRegistry.getNameForObject(state.getBlock()), this.getPropertyString((Map<IProperty, Comparable>)map));
            }
        });
        ...
        this.registerBlockWithStateMapper(Blocks.dirt, new StateMapperBase(){
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
                ...
                return new ModelResourceLocation(s, this.getPropertyString((Map<IProperty, Comparable>)map));
            }
        });
