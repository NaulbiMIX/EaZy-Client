        ...
        if (tileentitybannerrenderer$timedbannertexture == null) {
            if (DESIGNS.size() >= 256) {
                ...
                while (iterator.hasNext()) {
                    Object s1 = (String)iterator.next();
            ...
            Minecraft.getMinecraft().getTextureManager().loadTexture(tileentitybannerrenderer$timedbannertexture.bannerTexture, new LayeredColorMaskTexture(BANNERTEXTURES, (List<String>)list2, list));
