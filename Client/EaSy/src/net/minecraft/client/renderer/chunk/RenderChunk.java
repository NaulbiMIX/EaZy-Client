...
public class RenderChunk {
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        boolean i = true;
        blockpos = new BlockPos(this.position);
        ...
        if (!this.isChunkRegionEmpty(blockpos)) {
            ...
            for (Object ff_Object : BlockPosM.getAllInBoxMutable(blockpos, blockpos1)) {
                ...
                for (int j = 0; j < aenumworldblocklayer.length; ++j) {
                    ...
                    boolean[] arrbl = aboolean;
                    int n = k;
                    arrbl[n] = arrbl[n] | blockrendererdispatcher.renderBlock(iblockstate, blockposm, chunkcacheof, worldrenderer);
        ...
        try {
            ...
            this.renderGlobal.updateTileEntities((Collection<TileEntity>)set1, (Collection<TileEntity>)set);
        }
        finally {
