...
public class BroadcastController {
    ...
    protected Core streamCore = Core.getInstance();
    ...
    protected IStreamCallbacks streamCallback = new IStreamCallbacks(){
        ...
        public void requestAuthTokenCallback(ErrorCode p_requestAuthTokenCallback_1_, AuthToken p_requestAuthTokenCallback_2_) {
            if (ErrorCode.succeeded((ErrorCode)p_requestAuthTokenCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"RequestAuthTokenDoneCallback got failure: %s", (Object[])new Object[]{s}));
            }
            try {
        ...
        public void loginCallback(ErrorCode p_loginCallback_1_, ChannelInfo p_loginCallback_2_) {
            if (ErrorCode.succeeded((ErrorCode)p_loginCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"LoginCallback got failure: %s", (Object[])new Object[]{s}));
            }
            try {
                if (BroadcastController.this.broadcastListener != null) {
        ...
        public void getIngestServersCallback(ErrorCode p_getIngestServersCallback_1_, IngestList p_getIngestServersCallback_2_) {
            if (ErrorCode.succeeded((ErrorCode)p_getIngestServersCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"IngestListCallback got failure: %s", (Object[])new Object[]{s}));
        ...
        public void getUserInfoCallback(ErrorCode p_getUserInfoCallback_1_, UserInfo p_getUserInfoCallback_2_) {
            ...
            if (ErrorCode.failed((ErrorCode)p_getUserInfoCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"UserInfoDoneCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void getStreamInfoCallback(ErrorCode p_getStreamInfoCallback_1_, StreamInfo p_getStreamInfoCallback_2_) {
            if (ErrorCode.succeeded((ErrorCode)p_getStreamInfoCallback_1_)) {
                ...
                BroadcastController.this.logWarning(String.format((String)"StreamInfoDoneCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void runCommercialCallback(ErrorCode p_runCommercialCallback_1_) {
            if (ErrorCode.failed((ErrorCode)p_runCommercialCallback_1_)) {
                ...
                BroadcastController.this.logWarning(String.format((String)"RunCommercialCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void setStreamInfoCallback(ErrorCode p_setStreamInfoCallback_1_) {
            if (ErrorCode.failed((ErrorCode)p_setStreamInfoCallback_1_)) {
                ...
                BroadcastController.this.logWarning(String.format((String)"SetStreamInfoCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void getGameNameListCallback(ErrorCode p_getGameNameListCallback_1_, GameInfoList p_getGameNameListCallback_2_) {
            if (ErrorCode.failed((ErrorCode)p_getGameNameListCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"GameNameListCallback got failure: %s", (Object[])new Object[]{s}));
            }
            try {
                if (BroadcastController.this.broadcastListener != null) {
        ...
        public void bufferUnlockCallback(long p_bufferUnlockCallback_1_) {
            ...
            BroadcastController.this.field_152875_k.add((Object)framebuffer);
        }
        ...
        public void startCallback(ErrorCode p_startCallback_1_) {
            if (ErrorCode.succeeded((ErrorCode)p_startCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"startCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void stopCallback(ErrorCode p_stopCallback_1_) {
            if (ErrorCode.succeeded((ErrorCode)p_stopCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"stopCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void sendActionMetaDataCallback(ErrorCode p_sendActionMetaDataCallback_1_) {
            if (ErrorCode.failed((ErrorCode)p_sendActionMetaDataCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"sendActionMetaDataCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void sendStartSpanMetaDataCallback(ErrorCode p_sendStartSpanMetaDataCallback_1_) {
            if (ErrorCode.failed((ErrorCode)p_sendStartSpanMetaDataCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"sendStartSpanMetaDataCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void sendEndSpanMetaDataCallback(ErrorCode p_sendEndSpanMetaDataCallback_1_) {
            if (ErrorCode.failed((ErrorCode)p_sendEndSpanMetaDataCallback_1_)) {
                ...
                BroadcastController.this.logError(String.format((String)"sendEndSpanMetaDataCallback got failure: %s", (Object[])new Object[]{s}));
            }
        }
    };
    ...
    public boolean func_152817_A() {
        ...
        ErrorCode errorcode = this.streamCore.initialize(this.field_152868_d, System.getProperty((String)"java.library.path"));
    ...
    public boolean func_152828_a(String p_152828_1_, String p_152828_2_, String p_152828_3_) {
        ...
        if (p_152828_1_ == null || p_152828_1_.equals((Object)"")) {
    ...
    public boolean func_152836_a(VideoParams p_152836_1_) {
        if (p_152836_1_ != null && this.isReadyToBroadcast()) {
            ...
            if (ErrorCode.failed((ErrorCode)errorcode)) {
                ...
                this.logError(String.format((String)"Error while starting to broadcast: %s", (Object[])new Object[]{s}));
                this.videoParamaters = null;
                this.audioParamaters = null;
                return false;
            }
    ...
    public boolean stopBroadcasting() {
        ...
        if (ErrorCode.failed((ErrorCode)errorcode)) {
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.logError(String.format((String)"Error while stopping the broadcast: %s", (Object[])new Object[]{s}));
            return false;
        }
    ...
    public boolean func_152847_F() {
        ...
        if (ErrorCode.failed((ErrorCode)errorcode)) {
            ...
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.logError(String.format((String)"Error pausing stream: %s\n", (Object[])new Object[]{s}));
        } else {
    ...
    public boolean func_152840_a(String p_152840_1_, long p_152840_2_, String p_152840_4_, String p_152840_5_) {
        ...
        if (ErrorCode.failed((ErrorCode)errorcode)) {
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.logError(String.format((String)"Error while sending meta data: %s\n", (Object[])new Object[]{s}));
            return false;
        }
        return true;
    }
    ...
    public long func_177946_b(String p_177946_1_, long p_177946_2_, String p_177946_4_, String p_177946_5_) {
        ...
        if (i == -1L) {
            this.logError(String.format((String)"Error in SendStartSpanMetaData\n", (Object[])new Object[0]));
        }
        return i;
    }
    ...
    public boolean func_177947_a(String p_177947_1_, long p_177947_2_, long p_177947_4_, String p_177947_6_, String p_177947_7_) {
        if (p_177947_4_ == -1L) {
            this.logError(String.format((String)"Invalid sequence id: %d\n", (Object[])new Object[]{p_177947_4_}));
            return false;
        }
        ...
        if (ErrorCode.failed((ErrorCode)errorcode)) {
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.logError(String.format((String)"Error in SendStopSpanMetaData: %s\n", (Object[])new Object[]{s}));
            return false;
        }
        return true;
    }
        ...
        if (this.theStream != null && this.field_152876_l) {
            ...
            switch (this.broadcastState) {
                case Authenticated: {
                    ...
                    this.logError(String.format((String)"Error in TTV_Login: %s\n", (Object[])new Object[]{s3}));
                    break;
                }
                case LoggedIn: {
                    ...
                    this.logError(String.format((String)"Error in TTV_GetIngestServers: %s\n", (Object[])new Object[]{s2}));
                    break;
                }
    ...
    protected void func_152835_I() {
        ...
        if (j >= 30L) {
            ...
            if (ErrorCode.failed((ErrorCode)errorcode)) {
                String s = ErrorCode.getString((ErrorCode)errorcode);
                this.logError(String.format((String)"Error in TTV_GetStreamInfo: %s", (Object[])new Object[]{s}));
            }
        }
    }
    ...
    protected boolean func_152823_L() {
        for (int i = 0; i < 3; ++i) {
            ...
            if (!framebuffer.getIsValid()) {
                this.logError(String.format((String)"Error while allocating frame buffer", (Object[])new Object[0]));
                return false;
            }
            this.field_152874_j.add((Object)framebuffer);
            this.field_152875_k.add((Object)framebuffer);
        }
        return true;
    }
    ...
    public FrameBuffer func_152822_N() {
        if (this.field_152875_k.size() == 0) {
            this.logError(String.format((String)"Out of free buffers, this should never happen", (Object[])new Object[0]));
            return null;
        }
    ...
    public void captureFramebuffer(FrameBuffer p_152846_1_) {
        try {
            ...
            crashreportcategory.addCrashSection("Last reported errors", Arrays.toString((Object[])field_152862_C.func_152756_c()));
    ...
    public ErrorCode submitStreamFrame(FrameBuffer frame) {
        ...
        if (errorcode != ErrorCode.TTV_EC_SUCCESS) {
            String s = ErrorCode.getString((ErrorCode)errorcode);
            if (ErrorCode.succeeded((ErrorCode)errorcode)) {
                this.logWarning(String.format((String)"Warning in SubmitTexturePointer: %s\n", (Object[])new Object[]{s}));
            } else {
                this.logError(String.format((String)"Error in SubmitTexturePointer: %s\n", (Object[])new Object[]{s}));
                this.stopBroadcasting();
            }
            if (this.broadcastListener != null) {
