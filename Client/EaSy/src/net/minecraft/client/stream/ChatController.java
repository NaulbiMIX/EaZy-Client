...
public class ChatController {
        ...
        public void chatShutdownCallback(ErrorCode p_chatShutdownCallback_1_) {
            if (ErrorCode.succeeded((ErrorCode)p_chatShutdownCallback_1_)) {
                ...
                if (ErrorCode.failed((ErrorCode)errorcode)) {
                    ...
                    ChatController.this.func_152995_h(String.format((String)"Error shutting down the Twitch sdk: %s", (Object[])new Object[]{s}));
                }
                ChatController.this.func_175985_a(ChatState.Uninitialized);
            } else {
                ChatController.this.func_175985_a(ChatState.Initialized);
                ChatController.this.func_152995_h(String.format((String)"Error shutting down Twith chat: %s", (Object[])new Object[]{p_chatShutdownCallback_1_}));
            }
            try {
                if (ChatController.this.field_153003_a != null) {
    ...
    public boolean func_175990_d(String p_175990_1_) {
        if (!this.field_175998_i.containsKey((Object)p_175990_1_)) {
            return false;
        }
        ChatChannelListener chatcontroller$chatchannellistener = (ChatChannelListener)this.field_175998_i.get((Object)p_175990_1_);
    ...
    public EnumChannelState func_175989_e(String p_175989_1_) {
        if (!this.field_175998_i.containsKey((Object)p_175989_1_)) {
            return EnumChannelState.Disconnected;
        }
        ChatChannelListener chatcontroller$chatchannellistener = (ChatChannelListener)this.field_175998_i.get((Object)p_175989_1_);
    ...
    public boolean func_175984_n() {
        ...
        if (ErrorCode.failed((ErrorCode)errorcode)) {
            ...
            this.func_152995_h(String.format((String)"Error initializing Twitch sdk: %s", (Object[])new Object[]{s1}));
            return false;
        }
        ...
        switch (this.field_175997_k) {
            case None: {
                hashset.add((Object)ChatTokenizationOption.TTV_CHAT_TOKENIZATION_OPTION_NONE);
                break;
            }
            case Url: {
                hashset.add((Object)ChatTokenizationOption.TTV_CHAT_TOKENIZATION_OPTION_EMOTICON_URLS);
                break;
            }
            case TextureAtlas: {
                hashset.add((Object)ChatTokenizationOption.TTV_CHAT_TOKENIZATION_OPTION_EMOTICON_TEXTURES);
            }
        }
        ...
        if (ErrorCode.failed((ErrorCode)errorcode)) {
            ...
            this.func_175985_a(ChatState.Uninitialized);
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.func_152995_h(String.format((String)"Error initializing Twitch chat: %s", (Object[])new Object[]{s}));
            return false;
        }
    ...
    protected boolean func_175987_a(String p_175987_1_, boolean p_175987_2_) {
        ...
        if (this.field_175998_i.containsKey((Object)p_175987_1_)) {
            this.func_152995_h("Already in channel: " + p_175987_1_);
            return false;
        }
        if (p_175987_1_ != null && !p_175987_1_.equals((Object)"")) {
            ChatChannelListener chatcontroller$chatchannellistener = new ChatChannelListener(p_175987_1_);
            this.field_175998_i.put((Object)p_175987_1_, (Object)chatcontroller$chatchannellistener);
            boolean flag = chatcontroller$chatchannellistener.func_176038_a(p_175987_2_);
            if (!flag) {
                this.field_175998_i.remove((Object)p_175987_1_);
            }
            return flag;
        }
        return false;
    ...
    public boolean func_175991_l(String p_175991_1_) {
        ...
        if (!this.field_175998_i.containsKey((Object)p_175991_1_)) {
            this.func_152995_h("Not in channel: " + p_175991_1_);
            return false;
        }
        ChatChannelListener chatcontroller$chatchannellistener = (ChatChannelListener)this.field_175998_i.get((Object)p_175991_1_);
    ...
    public boolean func_152993_m() {
        ...
        if (ErrorCode.failed((ErrorCode)errorcode)) {
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.func_152995_h(String.format((String)"Error shutting down chat: %s", (Object[])new Object[]{s}));
            return false;
        }
        this.func_152996_t();
    ...
    public void func_152997_n() {
        ...
        if (this.field_153011_i != ChatState.Uninitialized && ErrorCode.failed((ErrorCode)(errorcode = this.field_153008_f.flushEvents()))) {
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.func_152995_h(String.format((String)"Error flushing chat events: %s", (Object[])new Object[]{s}));
        }
    }
    ...
    public boolean func_175986_a(String p_175986_1_, String p_175986_2_) {
        ...
        if (!this.field_175998_i.containsKey((Object)p_175986_1_)) {
            this.func_152995_h("Not in channel: " + p_175986_1_);
            return false;
        }
        ChatChannelListener chatcontroller$chatchannellistener = (ChatChannelListener)this.field_175998_i.get((Object)p_175986_1_);
    ...
    protected void func_153001_r() {
        ...
        if (this.field_175995_l != EnumEmoticonMode.None && this.field_175996_m == null && ErrorCode.failed((ErrorCode)(errorcode = this.field_153008_f.downloadEmoticonData()))) {
            String s = ErrorCode.getString((ErrorCode)errorcode);
            this.func_152995_h(String.format((String)"Error trying to download emoticon data: %s", (Object[])new Object[]{s}));
        }
    }
    ...
    implements IChatChannelListener {
        ...
        public boolean func_176038_a(boolean p_176038_1_) {
            ...
            if (ErrorCode.failed((ErrorCode)errorcode)) {
                String s = ErrorCode.getString((ErrorCode)errorcode);
                ChatController.this.func_152995_h(String.format((String)"Error connecting: %s", (Object[])new Object[]{s}));
        ...
        public boolean func_176034_g() {
            switch (this.field_176047_c) {
                ...
                case Connecting: {
                    ...
                    if (ErrorCode.failed((ErrorCode)errorcode)) {
                        String s = ErrorCode.getString((ErrorCode)errorcode);
                        ChatController.this.func_152995_h(String.format((String)"Error disconnecting: %s", (Object[])new Object[]{s}));
                        return false;
                    }
            ...
            if (ChatController.this.field_175995_l == EnumEmoticonMode.None) {
                ...
                if (this.field_176045_e.size() > 0) {
                    ...
                    while (listiterator.hasNext()) {
                        ...
                        if (!chatrawmessage.userName.equals((Object)p_176032_1_)) continue;
                        listiterator.remove();
                    }
                }
                if (this.field_176042_f.size() > 0) {
                    ...
                    while (listiterator1.hasNext()) {
                        ...
                        if (!chattokenizedmessage.displayName.equals((Object)p_176032_1_)) continue;
        ...
        public boolean func_176037_b(String p_176037_1_) {
            ...
            if (ErrorCode.failed((ErrorCode)errorcode)) {
                String s = ErrorCode.getString((ErrorCode)errorcode);
                ChatController.this.func_152995_h(String.format((String)"Error sending chat message: %s", (Object[])new Object[]{s}));
                return false;
            }
            return true;
        }
        ...
        protected void func_176041_h() {
            ...
            if (ChatController.this.field_175995_l != EnumEmoticonMode.None && this.field_176043_g == null && ErrorCode.failed((ErrorCode)(errorcode = ChatController.this.field_153008_f.downloadBadgeData(this.field_176048_a)))) {
                String s = ErrorCode.getString((ErrorCode)errorcode);
                ChatController.this.func_152995_h(String.format((String)"Error trying to download badge data: %s", (Object[])new Object[]{s}));
            }
        }
        ...
        public void chatStatusCallback(String p_chatStatusCallback_1_, ErrorCode p_chatStatusCallback_2_) {
            if (!ErrorCode.succeeded((ErrorCode)p_chatStatusCallback_2_)) {
                ChatController.this.field_175998_i.remove((Object)p_chatStatusCallback_1_);
                this.func_176030_k();
            }
        }
        ...
        public void chatChannelUserChangeCallback(String p_chatChannelUserChangeCallback_1_, ChatUserInfo[] p_chatChannelUserChangeCallback_2_, ChatUserInfo[] p_chatChannelUserChangeCallback_3_, ChatUserInfo[] p_chatChannelUserChangeCallback_4_) {
            ...
            for (int k = 0; k < p_chatChannelUserChangeCallback_4_.length; ++k) {
                ...
                this.field_176044_d.add((Object)p_chatChannelUserChangeCallback_4_[k]);
            }
            for (int l = 0; l < p_chatChannelUserChangeCallback_2_.length; ++l) {
                this.field_176044_d.add((Object)p_chatChannelUserChangeCallback_2_[l]);
            }
            try {
                if (ChatController.this.field_153003_a != null) {
        ...
        public void chatChannelRawMessageCallback(String p_chatChannelRawMessageCallback_1_, ChatRawMessage[] p_chatChannelRawMessageCallback_2_) {
            for (int i = 0; i < p_chatChannelRawMessageCallback_2_.length; ++i) {
                this.field_176045_e.addLast((Object)p_chatChannelRawMessageCallback_2_[i]);
            }
            try {
                if (ChatController.this.field_153003_a != null) {
        ...
        public void chatChannelTokenizedMessageCallback(String p_chatChannelTokenizedMessageCallback_1_, ChatTokenizedMessage[] p_chatChannelTokenizedMessageCallback_2_) {
            for (int i = 0; i < p_chatChannelTokenizedMessageCallback_2_.length; ++i) {
                this.field_176042_f.addLast((Object)p_chatChannelTokenizedMessageCallback_2_[i]);
            }
            try {
                if (ChatController.this.field_153003_a != null) {
