...
IStream {
    ...
    public TwitchStream(Minecraft mcIn, final Property streamProperty) {
        ...
        if (streamProperty != null && !Strings.isNullOrEmpty((String)streamProperty.getValue()) && OpenGlHelper.framebufferSupported) {
            Thread thread = new Thread("Twitch authenticator"){
                ...
                public void run() {
                    try {
                        URL url = new URL("https://api.twitch.tv/kraken?oauth_token=" + URLEncoder.encode((String)streamProperty.getValue(), (String)"UTF-8"));
                        ...
                        if (JsonUtils.getBoolean(jsonobject1, "valid")) {
                            ...
                            LOGGER.debug(TwitchStream.STREAM_MARKER, "Authenticated with twitch; username is {}", new Object[]{s1});
                            ...
                            LOGGER.error(TwitchStream.STREAM_MARKER, "Given twitch access token is invalid");
                        }
                    }
                    catch (IOException ioexception) {
                        TwitchStream.this.authFailureReason = IStream.AuthFailureReason.ERROR;
                        LOGGER.error(TwitchStream.STREAM_MARKER, "Could not authenticate with twitch", (Throwable)ioexception);
                    }
                }
    ...
    public void func_152930_t() {
        ...
        if (gamesettings.streamPreferredServer != null && gamesettings.streamPreferredServer.length() > 0) {
            for (IngestServer ingestserver : this.func_152925_v()) {
                if (!ingestserver.serverUrl.equals((Object)gamesettings.streamPreferredServer)) continue;
    ...
    public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_) {
        for (ChatRawMessage chatrawmessage : p_180605_2_) {
            ...
            if (!this.func_176028_a((Set<ChatUserMode>)chatrawmessage.modes, (Set<ChatUserSubscription>)chatrawmessage.subscriptions, this.mc.gameSettings.streamChatUserFilter)) continue;
            ...
            for (IChatComponent ichatcomponent3 : GuiTwitchUserMode.func_152328_a((Set<ChatUserMode>)chatrawmessage.modes, (Set<ChatUserSubscription>)chatrawmessage.subscriptions, null)) {
    ...
    private void func_176027_a(String p_176027_1_, ChatRawMessage p_176027_2_) {
        ChatUserInfo chatuserinfo = (ChatUserInfo)this.field_152955_g.get((Object)p_176027_1_);
        if (chatuserinfo == null) {
            chatuserinfo = new ChatUserInfo();
            chatuserinfo.displayName = p_176027_1_;
            this.field_152955_g.put((Object)p_176027_1_, (Object)chatuserinfo);
        }
    ...
    private boolean func_176028_a(Set<ChatUserMode> p_176028_1_, Set<ChatUserSubscription> p_176028_2_, int p_176028_3_) {
        if (p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_BANNED)) {
            return false;
        }
        if (p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_ADMINSTRATOR)) {
            return true;
        }
        if (p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_MODERATOR)) {
            return true;
        }
        if (p_176028_1_.contains((Object)ChatUserMode.TTV_CHAT_USERMODE_STAFF)) {
            return true;
        }
        if (p_176028_3_ == 0) {
            return true;
        }
        return p_176028_3_ == 1 ? p_176028_2_.contains((Object)ChatUserSubscription.TTV_CHAT_USERSUB_SUBSCRIBER) : false;
    }
    ...
    public void func_176018_a(String p_176018_1_, ChatUserInfo[] p_176018_2_, ChatUserInfo[] p_176018_3_, ChatUserInfo[] p_176018_4_) {
        for (ChatUserInfo chatuserinfo : p_176018_3_) {
            this.field_152955_g.remove((Object)chatuserinfo.displayName);
        }
        for (ChatUserInfo chatuserinfo1 : p_176018_4_) {
            this.field_152955_g.put((Object)chatuserinfo1.displayName, (Object)chatuserinfo1);
        }
        for (ChatUserInfo chatuserinfo2 : p_176018_2_) {
            this.field_152955_g.put((Object)chatuserinfo2.displayName, (Object)chatuserinfo2);
        }
    }
    ...
    public boolean func_152927_B() {
        return this.field_176029_e != null && this.field_176029_e.equals((Object)this.broadcastController.getChannelInfo().name);
    }
    ...
    public ChatUserInfo func_152926_a(String p_152926_1_) {
        return (ChatUserInfo)this.field_152955_g.get((Object)p_152926_1_);
    }
    ...
    static {
        try {
            if (Util.getOSType() == Util.EnumOS.WINDOWS) {
                System.loadLibrary((String)"avutil-ttv-51");
                System.loadLibrary((String)"swresample-ttv-0");
                System.loadLibrary((String)"libmp3lame-ttv");
                if (System.getProperty((String)"os.arch").contains((CharSequence)"64")) {
                    System.loadLibrary((String)"libmfxsw64");
                } else {
                    System.loadLibrary((String)"libmfxsw32");
                }
            }
            field_152965_q = true;
        }
