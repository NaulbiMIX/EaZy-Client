    ...
    public void update() {
        ...
        if (this.currentMusic != null) {
            ...
            if (!this.mc.getSoundHandler().isSoundPlaying(this.currentMusic)) {
                ...
                this.timeUntilNextMusic = Math.min((int)MathHelper.getRandomIntegerInRange(this.rand, musicticker$musictype.getMinDelay(), musicticker$musictype.getMaxDelay()), (int)this.timeUntilNextMusic);
            }
        }
