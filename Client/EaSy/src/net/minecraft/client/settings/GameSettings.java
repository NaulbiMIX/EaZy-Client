...
public class GameSettings {
    ...
    public static String getKeyDisplayString(int key) {
        return key < 0 ? I18n.format("key.mouseButton", key + 101) : (key < 256 ? Keyboard.getKeyName((int)key) : String.format((String)"%c", (Object[])new Object[]{Character.valueOf((char)((char)(key - 256)))}).toUpperCase());
    }
    ...
    public String getKeyBinding(Options settingOption) {
        ...
        if (settingOption.getEnumFloat()) {
            ...
            if (settingOption == Options.MIPMAP_LEVELS && (double)f1 >= 4.0) {
                return s1 + Lang.get("of.general.max");
            }
            return settingOption == Options.SENSITIVITY ? (f == 0.0f ? s1 + I18n.format("options.sensitivity.min", new Object[0]) : (f == 1.0f ? s1 + I18n.format("options.sensitivity.max", new Object[0]) : s1 + (int)(f * 200.0f) + "%")) : (settingOption == Options.FOV ? (f1 == 70.0f ? s1 + I18n.format("options.fov.min", new Object[0]) : (f1 == 110.0f ? s1 + I18n.format("options.fov.max", new Object[0]) : s1 + (int)f1)) : (settingOption == Options.FRAMERATE_LIMIT ? (f1 == settingOption.valueMax ? s1 + I18n.format("options.framerateLimit.max", new Object[0]) : s1 + (int)f1 + " fps") : (settingOption == Options.RENDER_CLOUDS ? (f1 == settingOption.valueMin ? s1 + I18n.format("options.cloudHeight.min", new Object[0]) : s1 + ((int)f1 + 128)) : (settingOption == Options.GAMMA ? (f == 0.0f ? s1 + I18n.format("options.gamma.min", new Object[0]) : (f == 1.0f ? s1 + I18n.format("options.gamma.max", new Object[0]) : s1 + "+" + (int)(f * 100.0f) + "%")) : (settingOption == Options.SATURATION ? s1 + (int)(f * 400.0f) + "%" : (settingOption == Options.CHAT_OPACITY ? s1 + (int)(f * 90.0f + 10.0f) + "%" : (settingOption == Options.CHAT_HEIGHT_UNFOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (settingOption == Options.CHAT_HEIGHT_FOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (settingOption == Options.CHAT_WIDTH ? s1 + GuiNewChat.calculateChatboxWidth(f) + "px" : (settingOption == Options.RENDER_DISTANCE ? s1 + (int)f1 + " chunks" : (settingOption == Options.MIPMAP_LEVELS ? (f1 == 0.0f ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)f1) : (settingOption == Options.STREAM_FPS ? s1 + TwitchStream.formatStreamFps(f) + " fps" : (settingOption == Options.STREAM_KBPS ? s1 + TwitchStream.formatStreamKbps(f) + " Kbps" : (settingOption == Options.STREAM_BYTES_PER_PIXEL ? s1 + String.format((String)"%.3f bpp", (Object[])new Object[]{Float.valueOf((float)TwitchStream.formatStreamBps(f))}) : (f == 0.0f ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)(f * 100.0f) + "%")))))))))))))));
        }
    ...
    public void loadOptions() {
        block81 : {
            ...
            block80 : {
                ...
                try {
                    if (!this.optionsFile.exists()) break block80;
                    ...
                    while ((s = bufferedreader.readLine()) != null) {
                        try {
                            ...
                            if (astring[0].equals((Object)"difficulty")) {
                                this.difficulty = EnumDifficulty.getDifficultyEnum(Integer.parseInt((String)astring[1]));
                            }
                            ...
                            if (astring[0].equals((Object)"chatVisibility")) {
                                this.chatVisibility = EntityPlayer.EnumChatVisibility.getEnumChatVisibility(Integer.parseInt((String)astring[1]));
                            }
                            ...
                            for (KeyBinding soundcategory : SoundCategory.values()) {
                                if (!astring[0].equals((Object)("soundCategory_" + ((SoundCategory)((Object)soundcategory)).getCategoryName()))) continue;
                                this.mapSoundLevels.put((Object)soundcategory, (Object)Float.valueOf((float)this.parseFloat(astring[1])));
                            }
                            for (KeyBinding enumplayermodelparts : EnumPlayerModelParts.values()) {
                                if (!astring[0].equals((Object)("modelPart_" + ((EnumPlayerModelParts)((Object)enumplayermodelparts)).getPartName()))) continue;
                                this.setModelPartEnabled((EnumPlayerModelParts)((Object)enumplayermodelparts), astring[1].equals((Object)"true"));
                            }
                        }
    ...
    public void saveOptions() {
        ...
        try {
            ...
            for (KeyBinding enumplayermodelparts : EnumPlayerModelParts.values()) {
                printwriter.println("modelPart_" + ((EnumPlayerModelParts)((Object)enumplayermodelparts)).getPartName() + ":" + this.setModelParts.contains((Object)enumplayermodelparts));
            }
            printwriter.close();
        }
        catch (Exception exception1) {
    ...
    private float getOptionFloatValueOF(Options p_getOptionFloatValueOF_1_) {
        ...
        if (p_getOptionFloatValueOF_1_ == Options.FULLSCREEN_MODE) {
            if (this.ofFullscreenMode.equals((Object)DEFAULT_STR)) {
                return 0.0f;
            }
    ...
    private String getKeyBindingOF(Options p_getKeyBindingOF_1_) {
        ...
        if (p_getKeyBindingOF_1_ == Options.FULLSCREEN_MODE) {
            return this.ofFullscreenMode.equals((Object)DEFAULT_STR) ? s + Lang.getDefault() : s + this.ofFullscreenMode;
        }
