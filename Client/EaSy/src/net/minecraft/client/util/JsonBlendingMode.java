...
public class JsonBlendingMode {
    ...
    private static int func_148108_a(String p_148108_0_) {
        ...
        if (s.equals((Object)"add")) {
            return 32774;
        }
        if (s.equals((Object)"subtract")) {
            return 32778;
        }
        if (s.equals((Object)"reversesubtract")) {
            return 32779;
        }
        if (s.equals((Object)"reverse_subtract")) {
            return 32779;
        }
        if (s.equals((Object)"min")) {
            return 32775;
        }
        return s.equals((Object)"max") ? 32776 : 32774;
    }
    ...
    private static int func_148107_b(String p_148107_0_) {
        ...
        if ((s = s.replaceAll("minus", "-")).equals((Object)"0")) {
            return 0;
        }
        if (s.equals((Object)"1")) {
            return 1;
        }
        if (s.equals((Object)"srccolor")) {
            return 768;
        }
        if (s.equals((Object)"1-srccolor")) {
            return 769;
        }
        if (s.equals((Object)"dstcolor")) {
            return 774;
        }
        if (s.equals((Object)"1-dstcolor")) {
            return 775;
        }
        if (s.equals((Object)"srcalpha")) {
            return 770;
        }
        if (s.equals((Object)"1-srcalpha")) {
            return 771;
        }
        if (s.equals((Object)"dstalpha")) {
            return 772;
        }
        return s.equals((Object)"1-dstalpha") ? 773 : -1;
    }
}
