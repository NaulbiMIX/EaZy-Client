...
implements INetHandlerPlayClient {
    ...
    public void handleTeams(S3EPacketTeams packetIn) {
        ...
        if (packetIn.getAction() == 0 || packetIn.getAction() == 2) {
            ...
            Object team$enumvisible = Team.EnumVisible.func_178824_a(packetIn.getNameTagVisibility());
            if (team$enumvisible != null) {
                scoreplayerteam.setNameTagVisibility((Team.EnumVisible)((Object)team$enumvisible));
            }
        }
