...
extends ModelBase {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        ...
        this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + 3.1415927f * Math.max((float)0.0f, (float)(0.2f + f16 * 0.2f))) * f6 + (f11 + Math.max((float)0.0f, (float)(f10 * 0.5f * p_78086_3_))) * f7;
        this.frontRightLeg.rotateAngleX = f18;
        this.frontRightHoof.rotateAngleX = this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + 3.1415927f * Math.max((float)0.0f, (float)(0.2f - f16 * 0.2f))) * f6 + (-f11 + Math.max((float)0.0f, (float)(-f10 * 0.5f * p_78086_3_))) * f7;
