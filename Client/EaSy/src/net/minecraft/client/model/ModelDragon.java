...
extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        this.jaw.rotateAngleX = (float)(Math.sin((double)(f * 3.1415927f * 2.0f)) + 1.0) * 0.2f;
        float f1 = (float)(Math.sin((double)(f * 3.1415927f * 2.0f - 1.0f)) + 1.0);
        ...
        for (int k = 0; k < 12; ++k) {
            ...
            f10 = (float)((double)f10 + Math.sin((double)((float)k * 0.45f + f8)) * 0.05000000074505806);
