...
extends ModelBase {
    ...
    public ModelSquid() {
        ...
        for (int j = 0; j < this.squidTentacles.length; ++j) {
            ...
            double d0 = (double)j * 3.141592653589793 * 2.0 / (double)this.squidTentacles.length;
            ...
            d0 = (double)j * 3.141592653589793 * -2.0 / (double)this.squidTentacles.length + 1.5707963267948966;
