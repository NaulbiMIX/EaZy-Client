...
extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        float f7 = Math.abs((float)(MathHelper.sin(limbSwing * 0.6662f + 0.0f) * 0.4f)) * limbSwingAmount;
        float f8 = Math.abs((float)(MathHelper.sin(limbSwing * 0.6662f + 3.1415927f) * 0.4f)) * limbSwingAmount;
        float f9 = Math.abs((float)(MathHelper.sin(limbSwing * 0.6662f + 1.5707964f) * 0.4f)) * limbSwingAmount;
        float f10 = Math.abs((float)(MathHelper.sin(limbSwing * 0.6662f + 4.712389f) * 0.4f)) * limbSwingAmount;
