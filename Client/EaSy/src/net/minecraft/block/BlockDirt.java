...
extends Block {
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
        list.add((Object)new ItemStack(this, 1, DirtType.DIRT.getMetadata()));
        list.add((Object)new ItemStack(this, 1, DirtType.COARSE_DIRT.getMetadata()));
        list.add((Object)new ItemStack(this, 1, DirtType.PODZOL.getMetadata()));
    }
