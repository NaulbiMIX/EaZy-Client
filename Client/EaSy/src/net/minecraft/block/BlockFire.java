        ...
        block12 : {
            block11 : {
                ...
                if (Blocks.fire.canCatchFire(worldIn, pos.west())) {
                    for (int j = 0; j < 2; ++j) {
                        double d3 = (double)pos.getX() + rand.nextDouble() * 0.10000000149011612;
                ...
                if (Blocks.fire.canCatchFire(worldIn, pos.east())) {
                    for (int k = 0; k < 2; ++k) {
                        double d4 = (double)(pos.getX() + 1) - rand.nextDouble() * 0.10000000149011612;
                ...
                if (Blocks.fire.canCatchFire(worldIn, pos.north())) {
                    for (int l = 0; l < 2; ++l) {
                        ...
                        double d15 = (double)pos.getZ() + rand.nextDouble() * 0.10000000149011612;
                ...
                if (Blocks.fire.canCatchFire(worldIn, pos.south())) {
                    for (int i1 = 0; i1 < 2; ++i1) {
                        ...
                        double d16 = (double)(pos.getZ() + 1) - rand.nextDouble() * 0.10000000149011612;
                ...
                for (int j1 = 0; j1 < 2; ++j1) {
                    ...
                    double d12 = (double)(pos.getY() + 1) - rand.nextDouble() * 0.10000000149011612;
