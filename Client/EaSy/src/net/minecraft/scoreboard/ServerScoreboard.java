...
extends Scoreboard {
    ...
    public boolean addPlayerToTeam(String player, String newTeam) {
        if (super.addPlayerToTeam(player, newTeam)) {
            ...
            this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers(new S3EPacketTeams(scoreplayerteam, (Collection<String>)Arrays.asList((Object[])new String[]{player}), 3));
            this.markSaveDataDirty();
            return true;
        }
        return false;
    ...
    public void removePlayerFromTeam(String p_96512_1_, ScorePlayerTeam p_96512_2_) {
        ...
        this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers(new S3EPacketTeams(p_96512_2_, (Collection<String>)Arrays.asList((Object[])new String[]{p_96512_1_}), 4));
        this.markSaveDataDirty();
    }
