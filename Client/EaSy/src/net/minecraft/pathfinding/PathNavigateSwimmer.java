...
extends PathNavigate {
    ...
    protected void pathFollow() {
        ...
        for (int j = java.lang.Math.min((int)(this.currentPath.getCurrentPathIndex() + i), (int)(this.currentPath.getCurrentPathLength() - 1)); j > this.currentPath.getCurrentPathIndex(); --j) {
