...
public class PlayerManager {
    ...
    public boolean isPlayerWatchingChunk(EntityPlayerMP player, int chunkX, int chunkZ) {
        ...
        return playermanager$playerinstance != null && playermanager$playerinstance.playersWatchingChunk.contains((Object)player) && !player.loadedChunks.contains((Object)playermanager$playerinstance.chunkCoords);
    }
                ...
                if (i > 0) {
                    for (int j1 = j - radius; j1 <= j + radius; ++j1) {
                        for (int k1 = k - radius; k1 <= k + radius; ++k1) {
                            ...
                            if (playermanager$playerinstance1.playersWatchingChunk.contains((Object)entityplayermp)) continue;
    ...
    class PlayerInstance {
        ...
        public void removePlayer(EntityPlayerMP player) {
            if (this.playersWatchingChunk.contains((Object)player)) {
                ...
                if (this.playersWatchingChunk.isEmpty()) {
                    ...
                    PlayerManager.this.playerInstanceList.remove((Object)this);
                    if (this.numBlocksToUpdate > 0) {
                        PlayerManager.this.playerInstancesToUpdate.remove((Object)this);
                    }
        ...
        public void flagChunkForUpdate(int x, int y, int z) {
            if (this.numBlocksToUpdate == 0) {
                PlayerManager.this.playerInstancesToUpdate.add((Object)this);
            }
