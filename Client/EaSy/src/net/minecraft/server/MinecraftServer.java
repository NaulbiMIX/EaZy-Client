...
IPlayerUsage {
    ...
    public void run() {
        try {
            ...
            crashreport = throwable1 instanceof ReportedException ? this.addServerInfoToCrashReport(((ReportedException)((Object)throwable1)).getCrashReport()) : this.addServerInfoToCrashReport(new CrashReport("Exception in server tick loop", throwable1));
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper playerSnooper) {
        ...
        if (this.worldServers != null) {
            for (int j = 0; j < this.worldServers.length; ++j) {
                ...
                playerSnooper.addClientStat("world[" + i + "][mode]", (Object)((Object)worldinfo.getGameType()));
                playerSnooper.addClientStat("world[" + i + "][difficulty]", (Object)((Object)worldserver.getDifficulty()));
