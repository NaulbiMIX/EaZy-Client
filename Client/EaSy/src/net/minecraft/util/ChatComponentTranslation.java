...
extends ChatComponentStyle {
    ...
    public Iterator<IChatComponent> iterator() {
        ...
        return Iterators.concat(ChatComponentTranslation.createDeepCopyIterator(this.children), ChatComponentTranslation.createDeepCopyIterator((Iterable<IChatComponent>)this.siblings));
    }
    ...
    public String toString() {
        return "TranslatableComponent{key='" + this.key + '\'' + ", args=" + Arrays.toString((Object[])this.formatArgs) + ", siblings=" + (Object)this.siblings + ", style=" + this.getChatStyle() + '}';
    }
