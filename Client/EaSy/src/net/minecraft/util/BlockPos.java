...
extends Vec3i {
    ...
    public static Iterable<BlockPos> getAllInBox(BlockPos from, BlockPos to) {
        final BlockPos blockpos = new BlockPos(Math.min((int)from.getX(), (int)to.getX()), Math.min((int)from.getY(), (int)to.getY()), Math.min((int)from.getZ(), (int)to.getZ()));
        final BlockPos blockpos1 = new BlockPos(Math.max((int)from.getX(), (int)to.getX()), Math.max((int)from.getY(), (int)to.getY()), Math.max((int)from.getZ(), (int)to.getZ()));
