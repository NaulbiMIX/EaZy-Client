...
implements IChatComponent {
    ...
    public static Iterator<IChatComponent> createDeepCopyIterator(Iterable<IChatComponent> components) {
        Iterator iterator = Iterators.concat((Iterator)Iterators.transform((Iterator)components.iterator(), (Function)new Function<IChatComponent, Iterator<IChatComponent>>(){
