...
public class MathHelper {
    ...
    public static final float PI = MathUtils.roundToFloat(3.141592653589793);
    ...
    static {
        for (int i = 0; i < 65536; ++i) {
            MathHelper.SIN_TABLE[i] = (float)Math.sin((double)((double)i * 3.141592653589793 * 2.0 / 65536.0));
        }
        for (int j = 0; j < SIN_TABLE_FAST.length; ++j) {
            MathHelper.SIN_TABLE_FAST[j] = MathUtils.roundToFloat(Math.sin((double)((double)j * 3.141592653589793 * 2.0 / 4096.0)));
        }
