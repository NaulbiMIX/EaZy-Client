...
public class ChatStyle {
    ...
    public String toString() {
        return "Style{hasParent=" + (this.parentStyle != null) + ", color=" + (Object)((Object)this.color) + ", bold=" + (Object)this.bold + ", italic=" + (Object)this.italic + ", underlined=" + (Object)this.underlined + ", obfuscated=" + (Object)this.obfuscated + ", clickEvent=" + this.getChatClickEvent() + ", hoverEvent=" + this.getChatHoverEvent() + ", insertion=" + this.getInsertion() + '}';
    }
    ...
    public boolean equals(Object p_equals_1_) {
        ...
        if (this.getBold() == chatstyle.getBold() && this.getColor() == chatstyle.getColor() && this.getItalic() == chatstyle.getItalic() && this.getObfuscated() == chatstyle.getObfuscated() && this.getStrikethrough() == chatstyle.getStrikethrough() && this.getUnderlined() == chatstyle.getUnderlined()) {
            if (this.getChatClickEvent() != null ? !this.getChatClickEvent().equals(chatstyle.getChatClickEvent()) : chatstyle.getChatClickEvent() != null) {
                return false;
            }
            if (this.getChatHoverEvent() != null ? !this.getChatHoverEvent().equals(chatstyle.getChatHoverEvent()) : chatstyle.getChatHoverEvent() != null) {
                return false;
            }
            if (this.getInsertion() != null ? this.getInsertion().equals((Object)chatstyle.getInsertion()) : chatstyle.getInsertion() == null) {
                return true;
            }
        }
        return false;
