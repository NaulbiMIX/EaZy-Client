...
public class ClassReader {
    ...
    public ClassReader(String className) throws IOException {
        this(ClassReader.readStream(ClassLoader.getSystemResourceAsStream((String)(className.replace('.', '/') + ".class")), true));
    }
    ...
    private static byte[] readStream(InputStream inputStream, boolean close) throws IOException {
        ...
        try {
            ...
            outputStream.flush();
            byte[] arrby = var5 = outputStream.toByteArray();
            return arrby;
        }
        finally {
            if (close) {
    ...
    public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
        ...
        for (fieldsCount = this.readUnsignedShort((int)(currentAttributeOffset - 2)); fieldsCount > 0; --fieldsCount) {
            ...
            if ("SourceFile".equals((Object)methodsCount)) {
                sourceFile = this.readUTF8(currentAttributeOffset, charBuffer);
            } else if ("InnerClasses".equals((Object)methodsCount)) {
                innerClassesOffset = currentAttributeOffset;
            } else if ("EnclosingMethod".equals((Object)methodsCount)) {
                enclosingMethodOffset = currentAttributeOffset;
            } else if ("NestHost".equals((Object)methodsCount)) {
                nestHostClass = this.readClass(currentAttributeOffset, charBuffer);
            } else if ("NestMembers".equals((Object)methodsCount)) {
                nestMembersOffset = currentAttributeOffset;
            } else if ("Signature".equals((Object)methodsCount)) {
                signature = this.readUTF8(currentAttributeOffset, charBuffer);
            } else if ("RuntimeVisibleAnnotations".equals((Object)methodsCount)) {
                runtimeVisibleAnnotationsOffset = currentAttributeOffset;
            } else if ("RuntimeVisibleTypeAnnotations".equals((Object)methodsCount)) {
                runtimeVisibleTypeAnnotationsOffset = currentAttributeOffset;
            } else if ("Deprecated".equals((Object)methodsCount)) {
                accessFlags |= 131072;
            } else if ("Synthetic".equals((Object)methodsCount)) {
                accessFlags |= 4096;
            } else if ("SourceDebugExtension".equals((Object)methodsCount)) {
                sourceDebugExtension = this.readUtf(currentAttributeOffset, annotationDescriptor, new char[annotationDescriptor]);
            } else if ("RuntimeInvisibleAnnotations".equals((Object)methodsCount)) {
                runtimeInvisibleAnnotationsOffset = currentAttributeOffset;
            } else if ("RuntimeInvisibleTypeAnnotations".equals((Object)methodsCount)) {
                runtimeInvisibleTypeAnnotationsOffset = currentAttributeOffset;
            } else if ("Module".equals((Object)methodsCount)) {
                moduleOffset = currentAttributeOffset;
            } else if ("ModuleMainClass".equals((Object)methodsCount)) {
                moduleMainClass = this.readClass(currentAttributeOffset, charBuffer);
            } else if ("ModulePackages".equals((Object)methodsCount)) {
                modulePackagesOffset = currentAttributeOffset;
            } else if (!"BootstrapMethods".equals((Object)methodsCount)) {
        ...
        if (enclosingMethodOffset != 0) {
            ...
            int var322 = this.readUnsignedShort(enclosingMethodOffset + 2);
            String var332 = var322 == 0 ? null : this.readUTF8(this.cpInfoOffsets[var322], charBuffer);
            String var34 = var322 == 0 ? null : this.readUTF8(this.cpInfoOffsets[var322] + 2, charBuffer);
            classVisitor.visitOuterClass(var31, var332, var34);
        }
        if (runtimeVisibleAnnotationsOffset != 0) {
            fieldsCount = this.readUnsignedShort(runtimeVisibleAnnotationsOffset);
            var32 = runtimeVisibleAnnotationsOffset + 2;
            while (fieldsCount-- > 0) {
        ...
        if (runtimeInvisibleAnnotationsOffset != 0) {
            ...
            var32 = runtimeInvisibleAnnotationsOffset + 2;
            while (fieldsCount-- > 0) {
                var33 = this.readUTF8(var32, charBuffer);
                var32 += 2;
        ...
        if (runtimeVisibleTypeAnnotationsOffset != 0) {
            ...
            var32 = runtimeVisibleTypeAnnotationsOffset + 2;
            while (fieldsCount-- > 0) {
        ...
        if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            ...
            var32 = runtimeInvisibleTypeAnnotationsOffset + 2;
            while (fieldsCount-- > 0) {
                var32 = this.readTypeAnnotationTarget(context, var32);
                var33 = this.readUTF8(var32, charBuffer);
                var32 += 2;
    ...
    private int readField(ClassVisitor classVisitor, Context context, int fieldInfoOffset) {
        ...
        while (attributesCount-- > 0) {
            ...
            currentOffset += 6;
            if ("ConstantValue".equals((Object)fieldVisitor)) {
            ...
            } else if ("Signature".equals((Object)fieldVisitor)) {
                signature = this.readUTF8(currentOffset, charBuffer);
            } else if ("Deprecated".equals((Object)fieldVisitor)) {
                accessFlags |= 131072;
            } else if ("Synthetic".equals((Object)fieldVisitor)) {
                accessFlags |= 4096;
            } else if ("RuntimeVisibleAnnotations".equals((Object)fieldVisitor)) {
                runtimeVisibleAnnotationsOffset = currentOffset;
            } else if ("RuntimeVisibleTypeAnnotations".equals((Object)fieldVisitor)) {
                runtimeVisibleTypeAnnotationsOffset = currentOffset;
            } else if ("RuntimeInvisibleAnnotations".equals((Object)fieldVisitor)) {
                runtimeInvisibleAnnotationsOffset = currentOffset;
            } else if ("RuntimeInvisibleTypeAnnotations".equals((Object)fieldVisitor)) {
    ...
    private int readMethod(ClassVisitor classVisitor, Context context, int methodInfoOffset) {
        ...
        while (attributesCount-- > 0) {
            ...
            nextAttribute = this.readInt(currentOffset + 2);
            currentOffset += 6;
            if ("Code".equals((Object)methodVisitor)) {
                if ((context.parsingOptions & 1) == 0) {
                    codeOffset = currentOffset;
                }
            } else if ("Exceptions".equals((Object)methodVisitor)) {
            ...
            } else if ("Signature".equals((Object)methodVisitor)) {
                signatureIndex = this.readUnsignedShort(currentOffset);
            } else if ("Deprecated".equals((Object)methodVisitor)) {
                context.currentMethodAccessFlags |= 131072;
            } else if ("RuntimeVisibleAnnotations".equals((Object)methodVisitor)) {
                runtimeVisibleAnnotationsOffset = currentOffset;
            } else if ("RuntimeVisibleTypeAnnotations".equals((Object)methodVisitor)) {
                runtimeVisibleTypeAnnotationsOffset = currentOffset;
            } else if ("AnnotationDefault".equals((Object)methodVisitor)) {
                annotationDefaultOffset = currentOffset;
            } else if ("Synthetic".equals((Object)methodVisitor)) {
                synthetic = true;
                context.currentMethodAccessFlags |= 4096;
            } else if ("RuntimeInvisibleAnnotations".equals((Object)methodVisitor)) {
                runtimeInvisibleAnnotationsOffset = currentOffset;
            } else if ("RuntimeInvisibleTypeAnnotations".equals((Object)methodVisitor)) {
                runtimeInvisibleTypeAnnotationsOffset = currentOffset;
            } else if ("RuntimeVisibleParameterAnnotations".equals((Object)methodVisitor)) {
                runtimeVisibleParameterAnnotationsOffset = currentOffset;
            } else if ("RuntimeInvisibleParameterAnnotations".equals((Object)methodVisitor)) {
                runtimeInvisibleParameterAnnotationsOffset = currentOffset;
            } else if ("MethodParameters".equals((Object)methodVisitor)) {
        ...
        if (var25 instanceof MethodWriter && (var26 = (MethodWriter)var25).canCopyMethodAttributes(this, methodInfoOffset, currentOffset - methodInfoOffset, synthetic, (context.currentMethodAccessFlags & 131072) != 0, this.readUnsignedShort(methodInfoOffset + 4), signatureIndex, exceptionsOffset)) {
            return currentOffset;
        }
    ...
    private void readCode(MethodVisitor methodVisitor, Context context, int codeOffset) {
        ...
        int bytecodeStartOffset = currentOffset = codeOffset + 8;
        ...
        while (attributesCount-- > 0) {
            ...
            currentOffset += 6;
            if ("LocalVariableTable".equals((Object)expandFrames)) {
            ...
            } else if ("LocalVariableTypeTable".equals((Object)expandFrames)) {
                localVariableTypeTableOffset = currentOffset;
            } else if ("LineNumberTable".equals((Object)expandFrames)) {
                if ((context.parsingOptions & 2) == 0) {
                    currentInvisibleTypeAnnotationIndex = this.readUnsignedShort(currentOffset);
                    var47 = currentOffset + 2;
                    while (currentInvisibleTypeAnnotationIndex-- > 0) {
        ...
        boolean bl = var46 = (context.parsingOptions & 8) != 0;
        if (stackMapFrameOffset != 0) {
            ...
            for (currentVisibleTypeAnnotationIndex = stackMapFrameOffset; currentVisibleTypeAnnotationIndex < stackMapTableEndOffset - 2; ++currentVisibleTypeAnnotationIndex) {
                if (classFileBuffer[currentVisibleTypeAnnotationIndex] != 8 || (var47 = this.readUnsignedShort(currentVisibleTypeAnnotationIndex + 1)) < 0 || var47 >= codeLength || (classFileBuffer[bytecodeStartOffset + var47] & 255) != 187) continue;
        ...
        if (var45 != 0 && (context.parsingOptions & 2) == 0) {
            ...
            if (localVariableTypeTableOffset != 0) {
                var492 = new int[this.readUnsignedShort(localVariableTypeTableOffset) * 3];
                currentOffset = localVariableTypeTableOffset + 2;
                int var502 = var492.length;
                while (var502 > 0) {
                    var492[--var502] = currentOffset + 6;
                    var492[--var502] = this.readUnsignedShort(currentOffset + 8);
                    var492[--var502] = this.readUnsignedShort(currentOffset);
                    currentOffset += 10;
                }
            }
            ...
            while (var50-- > 0) {
                ...
                int var58 = this.readUnsignedShort(currentOffset + 8);
                currentOffset += 10;
                var59 = null;
                if (var492 != null) {
                    for (int var61 = 0; var61 < var492.length; var61 += 3) {
                        if (var492[var61] != startPc || var492[var61 + 1] != var58) continue;
                        var59 = this.readUTF8(var492[var61 + 2], charBuffer);
                        break;
                    }
                }
    ...
    private int readElementValue(AnnotationVisitor annotationVisitor, int elementValueOffset, String elementName, char[] charBuffer) {
        ...
        switch (this.b[elementValueOffset] & 255) {
            ...
            case 67: {
                annotationVisitor.visit(elementName, (Object)Character.valueOf((char)((char)this.readInt(this.cpInfoOffsets[this.readUnsignedShort(currentOffset)]))));
                currentOffset += 2;
                break;
            }
            case 68: 
            ...
            case 90: {
                annotationVisitor.visit(elementName, (Object)(this.readInt(this.cpInfoOffsets[this.readUnsignedShort(currentOffset)]) == 0 ? Boolean.FALSE : Boolean.TRUE));
                currentOffset += 2;
                break;
            }
            case 91: {
                ...
                switch (this.b[currentOffset] & 255) {
                    ...
                    case 68: {
                        ...
                        for (int i = 0; i < numValues; ++i) {
                            var22[i] = Double.longBitsToDouble((long)this.readLong(this.cpInfoOffsets[this.readUnsignedShort(currentOffset + 1)]));
                            currentOffset += 3;
                        }
                    ...
                    case 70: {
                        ...
                        for (int doubleValues = 0; doubleValues < numValues; ++doubleValues) {
                            var21[doubleValues] = Float.intBitsToFloat((int)this.readInt(this.cpInfoOffsets[this.readUnsignedShort(currentOffset + 1)]));
                            currentOffset += 3;
                        }
    ...
    private void computeImplicitFrame(Context context) {
        ...
        if ((context.currentMethodAccessFlags & 8) == 0) {
            locals[numLocal++] = "<init>".equals((Object)context.currentMethodName) ? Opcodes.UNINITIALIZED_THIS : this.readClass(this.header + 2, context.charBuffer);
        }
    ...
    private int[] readBootstrapMethodsAttribute(int maxStringLength) {
        ...
        for (int i = this.readUnsignedShort((int)(currentAttributeOffset - 2)); i > 0; --i) {
            ...
            currentAttributeOffset += 6;
            if ("BootstrapMethods".equals((Object)attributeName)) {
    ...
    private Attribute readAttribute(Attribute[] attributePrototypes, String type, int offset, int length, char[] charBuffer, int codeAttributeOffset, Label[] labels) {
        ...
        for (int var10 = 0; var10 < var9; ++var10) {
            ...
            if (!attributePrototype.type.equals((Object)type)) continue;
    ...
    private String readUtf(int utfOffset, int utfLength, char[] charBuffer) {
        ...
        while (currentOffset < endOffset) {
            byte currentByte;
            if (((currentByte = classFileBuffer[currentOffset++]) & 128) == 0) {
                charBuffer[strLength++] = (char)(currentByte & 127);
                continue;
            }
            if ((currentByte & 224) == 192) {
    ...
    public Object readConst(int constantPoolEntryIndex, char[] charBuffer) {
        ...
        switch (this.b[cpInfoOffset - 1]) {
            ...
            case 4: {
                return Float.valueOf((float)Float.intBitsToFloat((int)this.readInt(cpInfoOffset)));
            }
            case 5: {
                return this.readLong(cpInfoOffset);
            }
            case 6: {
                return Double.longBitsToDouble((long)this.readLong(cpInfoOffset));
            }
            case 7: {
