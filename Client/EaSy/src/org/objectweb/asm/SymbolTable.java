...
final class SymbolTable {
    ...
    SymbolTable(ClassWriter classWriter, ClassReader classReader) {
        ...
        block10 : for (int itemIndex = 1; itemIndex < this.constantPoolCount; itemIndex += itemTag != 5 && itemTag != 6 ? 1 : 2) {
    ...
    private void copyBootstrapMethods(ClassReader classReader, char[] charBuffer) {
        ...
        for (int i = classReader.readUnsignedShort((int)(currentAttributeOffset - 2)); i > 0; --i) {
    ...
    private Entry addConstantMemberReference(int tag, String owner, String name, String descriptor) {
        ...
        while (entry != null) {
            if (entry.tag == tag && entry.hashCode == hashCode && entry.owner.equals((Object)owner) && entry.name.equals((Object)name) && entry.value.equals((Object)descriptor)) {
                return entry;
            }
            entry = entry.next;
        }
    ...
    Symbol addConstantFloat(float value) {
        return this.addConstantIntegerOrFloat(4, Float.floatToRawIntBits((float)value));
    }
    ...
    Symbol addConstantDouble(double value) {
        return this.addConstantLongOrDouble(6, Double.doubleToRawLongBits((double)value));
    }
    ...
    int addConstantNameAndType(String name, String descriptor) {
        ...
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 12 && entry.hashCode == hashCode && entry.name.equals((Object)name) && entry.value.equals((Object)descriptor)) {
                return entry.index;
            }
            entry = entry.next;
        }
    ...
    int addConstantUtf8(String value) {
        ...
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 1 && entry.hashCode == hashCode && entry.value.equals((Object)value)) {
                return entry.index;
            }
            entry = entry.next;
        }
    ...
    Symbol addConstantMethodHandle(int referenceKind, String owner, String name, String descriptor, boolean isInterface) {
        ...
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 15 && entry.hashCode == hashCode && entry.data == (long)referenceKind && entry.owner.equals((Object)owner) && entry.name.equals((Object)name) && entry.value.equals((Object)descriptor)) {
                return entry;
            }
            entry = entry.next;
        }
    ...
    /* varargs */ Symbol addConstantDynamic(String name, String descriptor, Handle bootstrapMethodHandle, Object ... bootstrapMethodArguments) {
    ...
    /* varargs */ Symbol addConstantInvokeDynamic(String name, String descriptor, Handle bootstrapMethodHandle, Object ... bootstrapMethodArguments) {
        Symbol bootstrapMethod = this.addBootstrapMethod(bootstrapMethodHandle, bootstrapMethodArguments);
    ...
    private Symbol addConstantDynamicOrInvokeDynamicReference(int tag, String name, String descriptor, int bootstrapMethodIndex) {
        ...
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == tag && entry.hashCode == hashCode && entry.data == (long)bootstrapMethodIndex && entry.name.equals((Object)name) && entry.value.equals((Object)descriptor)) {
                return entry;
            }
            entry = entry.next;
        }
    ...
    private Symbol addConstantUtf8Reference(int tag, String value) {
        ...
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == tag && entry.hashCode == hashCode && entry.value.equals((Object)value)) {
                return entry;
            }
            entry = entry.next;
        }
    ...
    /* varargs */ Symbol addBootstrapMethod(Handle bootstrapMethodHandle, Object ... bootstrapMethodArguments) {
    ...
    int addType(String value) {
        ...
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 128 && entry.hashCode == hashCode && entry.value.equals((Object)value)) {
                return entry.index;
            }
            entry = entry.next;
        }
    ...
    int addUninitializedType(String value, int bytecodeOffset) {
        ...
        Entry entry = this.get(hashCode);
        while (entry != null) {
            if (entry.tag == 129 && entry.hashCode == hashCode && entry.data == (long)bytecodeOffset && entry.value.equals((Object)value)) {
                return entry.index;
            }
            entry = entry.next;
        }
    ...
    private int addTypeInternal(Entry entry) {
        ...
        if (this.typeCount == this.typeTable.length) {
            ...
            System.arraycopy((Object)this.typeTable, (int)0, (Object)arrayOfEntry, (int)0, (int)this.typeTable.length);
