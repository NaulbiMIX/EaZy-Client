...
public class ByteVector {
    ...
    public ByteVector putByteArray(byte[] byteArrayValue, int byteOffset, int byteLength) {
        ...
        if (byteArrayValue != null) {
            System.arraycopy((Object)byteArrayValue, (int)byteOffset, (Object)this.data, (int)this.length, (int)byteLength);
        }
    ...
    private void enlarge(int size) {
        ...
        System.arraycopy((Object)this.data, (int)0, (Object)newData, (int)0, (int)this.length);
        this.data = newData;
    }
}
