...
public final class Type {
    ...
    public static /* varargs */ Type getMethodType(Type returnType, Type ... argumentTypes) {
    ...
    public static /* varargs */ String getMethodDescriptor(Type returnType, Type ... argumentTypes) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append('(');
