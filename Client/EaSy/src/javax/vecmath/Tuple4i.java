...
Cloneable {
    ...
    public final void absolute(Tuple4i t) {
        this.x = Math.abs((int)t.x);
        this.y = Math.abs((int)t.y);
        this.z = Math.abs((int)t.z);
        this.w = Math.abs((int)t.w);
    }
    ...
    public final void absolute() {
        this.x = Math.abs((int)this.x);
        this.y = Math.abs((int)this.y);
        this.z = Math.abs((int)this.z);
        this.w = Math.abs((int)this.w);
    }
