...
Cloneable {
    ...
    public final void get(Quat4f q1) {
        ...
        if (!((ww < 0.0 ? -ww : ww) < 1.0E-30)) {
            q1.w = (float)Math.sqrt((double)ww);
            ww = 0.25 / (double)q1.w;
        ...
        if (!((ww < 0.0 ? -ww : ww) < 1.0E-30)) {
            q1.x = (float)Math.sqrt((double)ww);
            ww = 0.5 / (double)q1.x;
        ...
        if (!((ww < 0.0 ? -ww : ww) < 1.0E-30)) {
            q1.y = (float)Math.sqrt((double)ww);
    ...
    public final void rotY(float angle) {
        float cosAngle;
        float sinAngle = (float)Math.sin((double)angle);
        this.m00 = cosAngle = (float)Math.cos((double)angle);
        this.m01 = 0.0f;
        this.m02 = sinAngle;
        this.m03 = 0.0f;
        this.m10 = 0.0f;
    ...
    public boolean epsilonEquals(Matrix4f m1, float epsilon) {
        boolean status = true;
        if (Math.abs((float)(this.m00 - m1.m00)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m01 - m1.m01)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m02 - m1.m02)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m03 - m1.m03)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m10 - m1.m10)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m11 - m1.m11)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m12 - m1.m12)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m13 - m1.m13)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m20 - m1.m20)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m21 - m1.m21)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m22 - m1.m22)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m23 - m1.m23)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m30 - m1.m30)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m31 - m1.m31)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m32 - m1.m32)) > epsilon) {
            status = false;
        }
        if (Math.abs((float)(this.m33 - m1.m33)) > epsilon) {
            status = false;
        }
        return status;
    }
