...
Cloneable {
        ...
        for (int i = 0; i < this.nRow; ++i) {
            for (int j = 0; j < this.nCol; ++j) {
                ...
                for (int k = 0; k < this.nCol; ++k) {
                    double[] arrd = tmp[i];
                    int n = j;
                    arrd[n] = arrd[n] + this.values[i][k] * m1.values[k][j];
                }
            }
        }
        this.values = tmp;
        ...
        for (int i = 0; i < m1.nRow; ++i) {
            for (int j = 0; j < m2.nCol; ++j) {
                ...
                for (int k = 0; k < m1.nCol; ++k) {
                    double[] arrd = tmp[i];
                    int n = j;
                    arrd[n] = arrd[n] + m1.values[i][k] * m2.values[k][j];
                }
            }
        }
        this.values = tmp;
    ...
    public final void set(GMatrix m1) {
        ...
        for (i = 0; i < Math.min((int)this.nRow, (int)m1.nRow); ++i) {
            for (j = 0; j < Math.min((int)this.nCol, (int)m1.nCol); ++j) {
                this.values[i][j] = m1.values[i][j];
            }
        }
            ...
            for (int i = 0; i < this.nRow; ++i) {
                for (int j = 0; j < this.nCol; ++j) {
                    ...
                    for (int k = 0; k < m1.nRow; ++k) {
                        double[] arrd = tmp[i];
                        int n = j;
                        arrd[n] = arrd[n] + m1.values[k][i] * m2.values[j][k];
                    }
                }
            }
            this.values = tmp;
            ...
            for (int i = 0; i < this.nRow; ++i) {
                for (int j = 0; j < this.nCol; ++j) {
                    ...
                    for (int k = 0; k < m1.nCol; ++k) {
                        double[] arrd = tmp[i];
                        int n = j;
                        arrd[n] = arrd[n] + m1.values[i][k] * m2.values[j][k];
                    }
                }
            }
            this.values = tmp;
            ...
            for (int i = 0; i < this.nRow; ++i) {
                for (int j = 0; j < this.nCol; ++j) {
                    ...
                    for (int k = 0; k < m1.nRow; ++k) {
                        double[] arrd = tmp[i];
                        int n = j;
                        arrd[n] = arrd[n] + m1.values[k][i] * m2.values[k][j];
                    }
                }
            }
            this.values = tmp;
    ...
    private static void checkMatrix(GMatrix m) {
        for (int i = 0; i < m.nRow; ++i) {
            for (int j = 0; j < m.nCol; ++j) {
                if (Math.abs((double)m.values[i][j]) < 1.0E-10) {
    ...
    static boolean luDecomposition(int dim, double[] matrix0, int[] row_perm, int[] even_row_xchg) {
        ...
        for (j = 0; j < dim; ++j) {
            ...
            for (i = j; i < dim; ++i) {
                ...
                matrix0[target] = sum;
                temp = row_scale[i] * Math.abs((double)sum);
                if (!(d >= big)) continue;
                big = temp;
                imax = i;
            }
            ...
            if (nr > 1) {
                ...
                for (j = si; j < m.nRow; ++j) {
                    for (k = si + 1; k < m.nCol; ++k) {
                        tmp.values[j][k] = 0.0;
                        for (i = si; i < m.nCol; ++i) {
                            double[] arrd = tmp.values[j];
                            int n = k;
                            arrd[n] = arrd[n] + u.values[j][i] * m.values[i][k];
                        }
                    }
                }
                for (j = si; j < m.nRow; ++j) {
                ...
                for (j = si; j < m.nRow; ++j) {
                    for (k = 0; k < m.nCol; ++k) {
                        ...
                        for (i = si; i < m.nCol; ++i) {
                            double[] arrd = tmp.values[j];
                            int n = k;
                            arrd[n] = arrd[n] + u.values[j][i] * U.values[i][k];
                        }
                    }
                }
                for (j = si; j < m.nRow; ++j) {
            ...
            for (j = si + 1; j < m.nRow; ++j) {
                for (k = si + 1; k < m.nCol; ++k) {
                    ...
                    for (i = si + 1; i < m.nCol; ++i) {
                        double[] arrd = tmp.values[j];
                        int n = k;
                        arrd[n] = arrd[n] + v.values[i][k] * m.values[j][i];
                    }
                }
            }
            for (j = si + 1; j < m.nRow; ++j) {
            ...
            for (j = 0; j < m.nRow; ++j) {
                for (k = si + 1; k < m.nCol; ++k) {
                    ...
                    for (i = si + 1; i < m.nCol; ++i) {
                        double[] arrd = tmp.values[j];
                        int n = k;
                        arrd[n] = arrd[n] + v.values[i][k] * V.values[j][i];
                    }
                }
            }
            for (j = 0; j < m.nRow; ++j) {
        ...
        for (int k = 0; k < 2 && !converged; ++k) {
            ...
            for (i = start; i <= end; ++i) {
                if (i == start) {
                    ...
                    f = (Math.abs((double)s[i]) - shift) * (GMatrix.d_sign(c_b48, s[i]) + shift / s[i]);
                    g = e[i];
                }
            ...
            while (end - start > 1 && Math.abs((double)e[end]) < 4.89E-15) {
                --end;
            }
            for (int n = end - 2; n > start; --n) {
                if (!(Math.abs((double)e[n]) < 4.89E-15)) continue;
            ...
            if (end - start > 1 || !(Math.abs((double)e[start + 1]) < 4.89E-15)) continue;
            converged = true;
        }
    ...
    private static String toString(GMatrix m) {
        ...
        for (int i = 0; i < m.nRow; ++i) {
            for (int j = 0; j < m.nCol; ++j) {
                if (Math.abs((double)m.values[i][j]) < 1.0E-9) {
    ...
    static double compute_rot(double f, double g, double[] sin, double[] cos) {
        ...
        if (g == 0.0) {
            ...
            double f1 = f;
            double g1 = g;
            double scale = GMatrix.max(Math.abs((double)f1), Math.abs((double)g1));
            if (scale >= 4.9947976805055876E145) {
                int count = 0;
                while (scale >= 4.9947976805055876E145) {
                    ++count;
                    scale = GMatrix.max(Math.abs((double)(f1 *= 2.002083095183101E-146)), Math.abs((double)(g1 *= 2.002083095183101E-146)));
                }
                ...
                while (scale <= 2.002083095183101E-146) {
                    ++count;
                    scale = GMatrix.max(Math.abs((double)(f1 *= 4.9947976805055876E145)), Math.abs((double)(g1 *= 4.9947976805055876E145)));
                }
                r = Math.sqrt((double)(f1 * f1 + g1 * g1));
                cs = f1 / r;
                sn = g1 / r;
