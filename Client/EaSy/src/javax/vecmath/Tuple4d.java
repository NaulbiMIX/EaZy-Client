...
Cloneable {
    ...
    public final void absolute(Tuple4d t) {
        this.x = Math.abs((double)t.x);
        this.y = Math.abs((double)t.y);
        this.z = Math.abs((double)t.z);
        this.w = Math.abs((double)t.w);
    }
    ...
    public final void absolute() {
        this.x = Math.abs((double)this.x);
        this.y = Math.abs((double)this.y);
        this.z = Math.abs((double)this.z);
        this.w = Math.abs((double)this.w);
    }
