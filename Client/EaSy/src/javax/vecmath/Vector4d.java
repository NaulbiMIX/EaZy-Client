...
implements Serializable {
    ...
    public final double length() {
        return Math.sqrt((double)(this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w));
    }
    ...
    public final void normalize(Vector4d v1) {
        double norm = 1.0 / Math.sqrt((double)(v1.x * v1.x + v1.y * v1.y + v1.z * v1.z + v1.w * v1.w));
        this.x = v1.x * norm;
        this.y = v1.y * norm;
        this.z = v1.z * norm;
        this.w = v1.w * norm;
    ...
    public final void normalize() {
        double norm = 1.0 / Math.sqrt((double)(this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w));
        this.x *= norm;
        this.y *= norm;
        this.z *= norm;
        this.w *= norm;
