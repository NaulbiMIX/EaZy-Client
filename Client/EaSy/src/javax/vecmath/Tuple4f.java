...
Cloneable {
    ...
    public final void absolute(Tuple4f t) {
        this.x = Math.abs((float)t.x);
        this.y = Math.abs((float)t.y);
        this.z = Math.abs((float)t.z);
        this.w = Math.abs((float)t.w);
    }
    ...
    public final void absolute() {
        this.x = Math.abs((float)this.x);
        this.y = Math.abs((float)this.y);
        this.z = Math.abs((float)this.z);
        this.w = Math.abs((float)this.w);
    }
