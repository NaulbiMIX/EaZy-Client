...
implements Serializable {
    ...
    public final float distanceL1(Point4f p1) {
        return Math.abs((float)(this.x - p1.x)) + Math.abs((float)(this.y - p1.y)) + Math.abs((float)(this.z - p1.z)) + Math.abs((float)(this.w - p1.w));
    }

    public final float distanceLinf(Point4f p1) {
        float t1 = Math.max((float)Math.abs((float)(this.x - p1.x)), (float)Math.abs((float)(this.y - p1.y)));
        float t2 = Math.max((float)Math.abs((float)(this.z - p1.z)), (float)Math.abs((float)(this.w - p1.w)));
