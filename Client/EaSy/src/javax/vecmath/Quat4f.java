...
implements Serializable {
    ...
    public final void set(AxisAngle4f a) {
        ...
        if ((double)amag < 1.0E-6) {
            ...
            amag = 1.0f / amag;
            float mag = (float)Math.sin((double)((double)a.angle / 2.0));
            this.w = (float)Math.cos((double)((double)a.angle / 2.0));
            this.x = a.x * amag * mag;
            this.y = a.y * amag * mag;
            this.z = a.z * amag * mag;
        }
    ...
    public final void set(AxisAngle4d a) {
        float amag = (float)(1.0 / Math.sqrt((double)(a.x * a.x + a.y * a.y + a.z * a.z)));
        if ((double)amag < 1.0E-6) {
            this.w = 0.0f;
            this.x = 0.0f;
            this.y = 0.0f;
    ...
    public final void interpolate(Quat4f q1, float alpha) {
        ...
        if (1.0 - dot > 1.0E-6) {
            ...
            s1 = Math.sin((double)((1.0 - (double)alpha) * om)) / sinom;
            s2 = Math.sin((double)((double)alpha * om)) / sinom;
        } else {
            s1 = 1.0 - (double)alpha;
            s2 = alpha;
        }
