...
public class WinRegistry {
    ...
    public static boolean exists(int hkey, String key) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        return WinRegistry.readStringSubKeys(hkey, key) != null;
    }
